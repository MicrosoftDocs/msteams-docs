...
[!include[Padding and size](~/includes/fields-image-padding.html)]
...
[!include[Field states](~/includes/fields-image-states.html)]
...
[!include[Fields typography](~/includes/fields-image-typography.html)]
...
[!include[Flyouts](~/includes/flyouts-image.html)]

### Sizing and padding

We recommend a 16px padding to the left and right of the content.
[!include[Flyouts size and padding](~/includes/flyouts-image-sizepadding.html)]
...
[!include[Flyouts scrolling](~/includes/flyouts-image-scrolling.html)]
