...
The People Picker in Adaptive Cards help to search, select, reassign, and preselect users within chat  or channel. Universal Actions for Adaptive Cards enhances user's experience by using bot as the common backend for handling actions and introduces a new action type, `Action.Execute`.
