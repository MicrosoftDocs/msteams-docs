...
The People Picker in Adaptive Cards helps to search, select, reassign, and preselect user within chat  or channel. Universal Actions for Adaptive Cards enhances user's experience by using bot as the common backend for handling actions and introduces a new action type, `Action.Execute`.
