...
The code below is adapted from [the task module sample](~/task-modules-and-cards/task-modules/invoking-task-modules.md#code-sample). Here's what the task module looks like:
