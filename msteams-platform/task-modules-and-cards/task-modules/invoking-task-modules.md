...
While invoking from a tab, the user must use an Adaptive Card.
...
With HTML or JavaScript-based task modules, you must ensure your app's task module can be used with a keyboard. Screen reader programs also depend on the ability to navigate using the keyboard, which includes the following two things:
