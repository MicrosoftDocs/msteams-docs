...
description: Learn how to design dialogs (task modules) such as list, form, media, poll for Teams apps, its best practices and anatomy, and get the Microsoft Teams UI Kit.
