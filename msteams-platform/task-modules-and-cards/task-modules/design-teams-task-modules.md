...
|3|**Close button**: Closes the task module. Doesn't apply unsaved changes in the app content.|
...
|4|**Close button**: Closes the task module. Doesn't apply unsaved changes in the app content.|
