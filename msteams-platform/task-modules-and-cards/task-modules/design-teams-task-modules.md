...
:::image type="content" source="../../assets/images/task-module/task-module-overview.png" alt-text="Screenshot is an example that shows a task module.":::
...
:::image type="content" source="../../assets/images/task-module/mobile-task-module-anatomy.png" alt-text="Illustration shows the UI anatomy of a task module on mobile.":::
...
:::image type="content" source="../../assets/images/task-module/task-module-anatomy.png" alt-text="Illustration shows the UI anatomy of a task module.":::
...
:::image type="content" source="../../assets/images/task-module/mobile-list.png" alt-text="Screenshot is an example that shows the list in a task module on mobile.":::

#### Desktop

:::image type="content" source="../../assets/images/task-module/list.png" alt-text="Screenshot is an example that shows the list in a task module.":::
...
:::image type="content" source="../../assets/images/task-module/mobile-form.png" alt-text="Screenshot is an example that shows a form in a task module on mobile.":::

#### Desktop

:::image type="content" source="../../assets/form.png" alt-text="Screenshot is an example that shows a form in a task module.":::
...
:::image type="content" source="../../assets/images/task-module/mobile-sign-in.png" alt-text="Screenshot describes sign in experience in a task module on mobile.":::

#### Desktop

:::image type="content" source="../../assets/images/task-module/sign-in.png" alt-text="Screenshot describes sign in experience in a task module.":::
...
:::image type="content" source="../../assets/images/task-module/mobile-media.png" alt-text="Screenshot is an example that shows a media content in a task module on mobile.":::

#### Desktop

:::image type="content" source="../../assets/images/task-module/media.png" alt-text="Screenshot is an example that shows a media content in a task module.":::
...
:::image type="content" source="../../assets/images/task-module/mobile-empty-state.png" alt-text="Screenshot is an example that shows an empty state in a task module on mobile.":::

#### Desktop

:::image type="content" source="../../assets/images/task-module/empty-state.png" alt-text="Screenshot is an example that shows an empty state in a task module.":::
...
:::image type="content" source="../../assets/images/task-module/mobile-image-gallery.png" alt-text="Screenshot is an example that shows an image gallery in a task module on mobile.":::

##### Desktop

:::image type="content" source="../../assets/images/task-module/image-gallery.png" alt-text="Screenshot is an example that shows an image gallery in a task module.":::
...
:::image type="content" source="../../assets/images/task-module/mobile-poll.png" alt-text="Screenshot is an example that shows a poll in a task module on mobile.":::

#### Desktop

:::image type="content" source="../../assets/images/task-module/poll.png" alt-text="Screenshot is an example that shows a poll in a task module.":::
...
:::row:::
   :::column span="":::
:::image type="content" source="../../assets/images/task-module/usability-do.png" alt-text="Screenshot is an example that shows a task module best practice (one task module at a time).":::
...
The goal is to focus the user on completing a task after all!
   ...
   :::column-end:::
   :::column span="":::
:::image type="content" source="../../assets/images/task-module/usability-dont.png" alt-text="Screenshot is an example that shows a task module best practice (pop a dialog on top of a task module).":::
...
:::row:::
   :::column span="":::
:::image type="content" source="../../assets/images/task-module/responsive-do.png" alt-text="Screenshot is an example that shows a task module best practice (make sure the content is responsive).":::
...
While Adaptive Cards hosted in a task module render well on mobile devices, if you choose to use an iframe to host app content, make sure the UI is responsive and works well across devices.
   ...
   :::column-end:::
   :::column span="":::
:::image type="content" source="../../assets/images/task-module/responsive-dont.png" alt-text="Screenshot is an example that shows a task module best practice (don't use horizontal scroll bars).":::
...
:::row:::
   :::column span="":::
:::image type="content" source="../../assets/images/task-module/simplicity-do.png" alt-text="Screenshot is an example that shows a task module best practice (keep it short).":::
...
You can easily create a multi-step wizard, but that doesn't necessarily mean you should! A multi-screen task module can be problematic because incoming messages are distracting and tempt users to exit. If your task is really involved, pop out to a full webpage instead of a task module.
   ...
   :::column-end:::
   :::column span="":::
:::image type="content" source="../../assets/images/task-module/simplicity-dont.png" alt-text="Screenshot is an example that shows a task module best practice (don't have long interactions).":::
...
:::row:::
   :::column span="":::
:::image type="content" source="../../assets/images/task-module/error-messages-do.png" alt-text="Screenshot is an example that shows a task module best practice (use inline error messages).":::
...
See the forms UI template for guidelines on inline error handling.
   ...
   :::column-end:::
   :::column span="":::
:::image type="content" source="../../assets/images/task-module/error-messages-dont.png" alt-text="Screenshot is an example that shows a task module best practice (put error messages in dialogs).":::
