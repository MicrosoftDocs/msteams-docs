...
:::image type="content" source="~/assets/images/adaptive-cards/design-width-auto-do.png" alt-text="The screenshot shows how to set column width for Adaptive Cards." lightbox="../../assets/images/adaptive-cards/design-width-auto-do-large.png":::
...
:::image type="content" source="~/assets/images/adaptive-cards/design-width-auto-dont.png" alt-text="The screenshot shows how not to set column width in Adaptive Cards." lightbox="../../assets/images/adaptive-cards/design-width-auto-dont-large.png":::
...
:::image type="content" source="~/assets/images/adaptive-cards/design-column-amount-do.png" alt-text="The screenshot shows the right number of columns in Adaptive Cards." lightbox="../../assets/images/adaptive-cards/design-column-amount-do-large.png":::

**Don't**: Using too many columns can clutter your card content on mobile.

:::image type="content" source="~/assets/images/adaptive-cards/design-column-amount-dont.png" alt-text="The screenshot shows how to many columns can negatively affect Adaptive Card layout." lightbox="../../assets/images/adaptive-cards/design-column-amount-dont-large.png":::
...
:::image type="content" source="~/assets/images/adaptive-cards/design-width-auto-do.png" alt-text="The screenshot shows how to set column width in Adaptive Cards." lightbox="../../assets/images/adaptive-cards/design-width-auto-do-large.png":::
...
:::image type="content" source="~/assets/images/adaptive-cards/design-text-wrap-true.png" alt-text="The screenshot shows how to wrap text in Adaptive Cards." lightbox="../../assets/images/adaptive-cards/design-text-wrap-true-large.png":::

**Don't**: In this screen, the card doesn't use the `wrap` property, so the text cuts off on a mobile screen.

:::image type="content" source="~/assets/images/adaptive-cards/design-text-wrap-false.png" alt-text="The screenshot shows what can happen if you don't wrap text in Adaptive Cards." lightbox="../../assets/images/adaptive-cards/design-text-wrap-false-large.png":::
