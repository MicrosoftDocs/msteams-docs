...
> [!NOTE]
> If a card includes an image URL that is redirected before the final image, the redirect in image URL isn't supported. This occurs for images shared on the public cloud.
...
> * Positive or destructive action styling isn't supported in Adaptive Cards on the Teams platform.
