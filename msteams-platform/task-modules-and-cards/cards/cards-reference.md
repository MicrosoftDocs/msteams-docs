...
>
> * Adaptive Card supports only Incoming Webhook connectors for Microsoft 365 groups type and not any other connectors for Microsoft 365 group types. For these connectors, You can send the [Adaptive Card is sent using Incoming Webhook](../../webhooks-and-connectors/how-to/connectors-using.md#send-adaptive-cards-using-an-incoming-webhook).
