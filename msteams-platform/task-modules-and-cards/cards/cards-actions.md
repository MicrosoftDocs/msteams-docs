...
description: Learn what are card actions in Microsoft Teams, action types such as openAI, messageBack, imBack, invoke, and sign-in, and how to use card actions in bots.
