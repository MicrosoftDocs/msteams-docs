...
You can include an inline image with any Teams card. Supported image formats are PNG, JPG, or GIF. Keep the dimensions within 1024 x 1024 px and file size less than 1 MB. Animated GIF images are not supported. For more information, see [types of cards](./cards-reference.md#inline-card-images).
