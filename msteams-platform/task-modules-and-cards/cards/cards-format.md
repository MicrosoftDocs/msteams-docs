...
Adaptive Cards support adding icons from the [Fluent icon](https://www.figma.com/community/file/836835755999342788) library using the `Icon` element. You can use Fluent icons on action buttons by setting its `iconUrl` property to a value in the format of `icon:<icon name>[,regular|filled]`.
