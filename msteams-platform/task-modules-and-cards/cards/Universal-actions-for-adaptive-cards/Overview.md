...
You can update scenarios using the [quick start guide](Work-with-universal-actions-for-adaptive-cards.md) and also leverage Universal Actions to update your scenarios.
