...
description: Learn about sequential workflows for Adaptive Cards using Universal Actions with code samples, and to invoke request received and Adaptive Card response.
