...
author: Rajeshwari-v
description: Learn about typeahead searches and how to use Input.ChoiceSet to implement static and dynamic typeahead search and dependent inputs in Adaptive Cards.
ms.topic: conceptual
