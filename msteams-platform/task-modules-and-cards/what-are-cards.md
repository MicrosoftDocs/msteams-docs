...
Type ahead search added as an input control in Adaptive Cards enable dynamic search experience from a large dataset. The mobile and desktop clients support type ahead dynamic
search experience. 
