...
>
> * Only Incoming Webhook connector type are available in GCC-High environment and [Tenant admins](/microsoftteams/office-365-custom-connectors#considerations-when-using-connectors-in-teams) need to manually upload to display the app in the connectors page.
>
