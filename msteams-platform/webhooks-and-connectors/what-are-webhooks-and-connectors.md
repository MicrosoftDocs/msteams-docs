...
| Building Tools |[Quick start - Microsoft Graph](https://developer.microsoft.com/graph/quick-start) | • [Agents Toolkit Overview for Visual Studio Code](../toolkit/teams-toolkit-fundamentals.md) <br> • [Agents Toolkit Overview for Visual Studio](../toolkit/toolkit-v4/teams-toolkit-fundamentals-vs.md) <br> • [Microsoft 365 Agents Toolkit CLI](../toolkit/Teams-Toolkit-CLI.md) (previously known as Teams Toolkit CLI) <br> • [TeamsFx SDK](../toolkit/TeamsFx-SDK.md) | No tools are required. |
