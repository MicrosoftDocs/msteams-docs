...
If the connector is intended to work only in Teams, follow the instructions in [publish your app to the Microsoft Teams store](~/concepts/deploy-and-publish/appsource/publish.md) to submit your connector.
