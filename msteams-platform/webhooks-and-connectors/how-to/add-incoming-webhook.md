...
:::image type="content" source="../../assets/images/workflows-template-selection.png" alt-text="Open the Workflows option from the channel menu in Microsoft Teams.":::

1. Configure the workflow parameters.
1. Select **Create**.
1. After the workflow is created, copy the generated **Webhook URL**.
:::image type="content" source="../../assets/images/workflows-url-copy.png" alt-text="Copy the webhook URL generated by the workflow.":::
