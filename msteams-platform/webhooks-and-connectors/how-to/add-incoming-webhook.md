...
|:---------------------|:--------------|:---------|:--------|
|Incoming Webhook|This sample shows a Teams tab to type in Incoming Webhook URL and message card payload, which sends the card in team and also demonstrates the HttpPOST action in the card. |[View](https://github.com/OfficeDev/Microsoft-Teams-Samples/tree/main/samples/incoming-webhook/csharp)|[View](https://github.com/OfficeDev/Microsoft-Teams-Samples/tree/main/samples/incoming-webhook/nodejs) |
