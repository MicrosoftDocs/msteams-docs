...
> [!NOTE]
>
> * Currently, the message size limit is 28 KB. When the size exceeds 28 KB, you receives an error. For more information, see [limits and specifications for Microsoft Teams](/microsoftteams/limits-specifications-teams).
