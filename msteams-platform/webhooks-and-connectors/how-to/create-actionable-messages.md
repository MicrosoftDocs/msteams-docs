...
To ensure that your service is receiving calls only from actual Teams clients, Teams provides an HMAC code in the HTTP `authorization` header. Always include the code in your authentication protocol.
