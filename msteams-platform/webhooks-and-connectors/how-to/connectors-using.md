...
> * Adaptive Card supports only Incoming Webhook O365 Connector type and not any other O365 Connector types. You can send the adaptive cards for these connectors using below JSON format.
