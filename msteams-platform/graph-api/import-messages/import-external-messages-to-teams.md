...
> * `createdDateTime` supports timestamps with milliseconds precision. (For example, if the incoming request message has `createdDateTime` 2020-09-16T05:50:31.0025302Z it would be converted to 2020-09-16T05:50:31.002Z when it is ingested.)
