...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Allows the app to create chats without a signed-in user (application scenarios) or
    ...
    <tr>
      ...
      <td>
        Allows the app to create teams either without a signed‑in user (application)
        or on behalf of the signed‑in user (delegated).
      </td>
    </tr>
    <tr>
