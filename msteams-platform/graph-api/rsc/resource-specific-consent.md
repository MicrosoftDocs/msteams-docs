...
|ChannelMeeting.ReadBasic.Group|Read basic properties, such as name, schedule, organizer, join link, and start or end notifications, of a meeting associated with this team or channel.|
