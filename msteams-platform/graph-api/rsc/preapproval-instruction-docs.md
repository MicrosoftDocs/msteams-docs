...
If you no longer wish to pre-approve an applications RSC permission you can delete the pre-approval policy for an app.
To delete a pre-approval policy, you'll need the following information
