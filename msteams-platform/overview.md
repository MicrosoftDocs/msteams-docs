...
description: Learn about Microsoft Teams and associated organizational goals, why you should build agents and apps on the Teams platform, and how they help meet business needs.
ms.topic: overview
...
The Microsoft Teams platform empowers developers to create intelligent and collaborative experiences directly within the Teams environment. By building agents and apps, developers can achieve organizational goals, boost productivity, and foster collaboration. Additionally, the Teams platform allows for seamless integration across Microsoft 365 platforms.

## What is the Teams Platform?

Teams is evolving from a simple communication hub into a collaborative and intelligent platform where people, data, and AI converge. Developers can build agents in Teams using the Teams SDK, enabling natural, conversational, and context-aware experiences powered by large language models (LLMs). Developers can continue to create Teams apps and extend Teams capabilities for task-specific workflows, data visualization, and integration with enterprise systems.

Consider these example developer personas and agent or app scenarios:
...
These scenarios can enhance collaboration using Teams agents or apps.

## Why Build on the Teams Platform?

Whether you aim to build powerful agents or rich apps, the platform provides tools to extend Teams with seamless, secure, and contextual solutions. With over 320 million monthly active users, the Teams platform enables custom experiences, workflows, and integrations where people work. It facilitates communication and integrates agents and apps seamlessly across Microsoft 365 platforms.

Agents serve as digital workers within the organization. By building and integrating agents into Teams workspaces, organizations can efficiently connect with customers, deliver services, and share information. Key roles of an agent in Teams include:
...
Developers can build a unified experience for agents by creating them once and deploying across Teams, Outlook, and Microsoft 365 using a single codebase. This approach streamlines development, management, and user access, ensuring consistent experiences and efficient administration.
...
## What to Build on the Teams Platform?
