...
* **Personal apps with tabs and bots**
    ...
    One-to-one conversational bots are one of the more open-ended features in Teams. The conversation is just between the bot and your user. You have the flexibility of including dialogs (referred as task modules in TeamsJS v.1.0) to simplify complex sets of information.
