...
This page focuses on embedding your own experiences into Microsoft Teams. If you'd like to reverse this model and integrate Teams or other communication capabilities into your own app experience, see [Azure Communication Services](https://docs.microsoft.com/azure/communication-services/overview).
