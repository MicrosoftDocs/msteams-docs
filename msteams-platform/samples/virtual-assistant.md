...
:::image type="content" source="../assets/images/bots/virtual-assistant/book-a-room-skill.png" alt-text="The screenshot is an example that shows the Virtual Assistant with book a room skill.":::
