...
* **Triggers**
  ...
  1. When a Collaboration Session is Created.
      ...
      :::image type="content" source="../assets/images/collaboration-control/colab-session-created-preview.png" alt-text="The screenshot shows Collaboration session that is created.":::
...
* **Actions**
  ...
  1. Update Planner Task
      ...
      :::image type="content" source="../assets/images/collaboration-control/update-planner-task-preview.png" alt-text="The screenshot shows Update planner task.":::
