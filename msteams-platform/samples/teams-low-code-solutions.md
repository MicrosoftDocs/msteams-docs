...
:::image type="content" source="../assets/images/power-platform-and-teams/ms-power-platform.png" alt-text="The screenshot is an examples that shows power platform services.":::
