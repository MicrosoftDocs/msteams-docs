...
For more information, see [Define app, command, and parameter descriptions](high-quality-message-extension.md#define-app-command-and-parameter-descriptions).
