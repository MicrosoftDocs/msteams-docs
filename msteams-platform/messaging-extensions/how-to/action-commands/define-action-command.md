...
* Command box: By using / in the command box. For example, **/your-app-name**. If you are using the classic Teams the action command is invoked by @mentioning in the command box. For example, **@your-app-name**.
