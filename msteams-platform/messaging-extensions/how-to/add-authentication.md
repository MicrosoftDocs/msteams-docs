...
> * The size of the authentication pop-up can be defined by including, width and height query string parameters `Value = $"{_siteUrl}/searchSettings.html?settings={escapedSettings}",`.
