...
|`semanticDescription`|Semantic description of the command for consumption by the large language model.|No|DevPreview|
...
|`parameter.semanticDescription`|Semantic description of the parameter for consumption by the large language model.|No|DevPreview|
