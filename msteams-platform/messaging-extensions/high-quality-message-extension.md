...
# Guidelines to create or upgrade a message extension plugin for Copilot for Microsoft 365 and Office.com
...
* **Starter prompts**: When a user first installs or enables a plugin.
