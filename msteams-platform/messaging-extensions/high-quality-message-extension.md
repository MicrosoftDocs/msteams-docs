...
Microsoft Teams supports various Copilot extensions, including message extensions, API plugins, declarative Copilot, and custom engine Copilot. Besides the common guidelines, there are specific guidelines for each type of Copilot extension.
