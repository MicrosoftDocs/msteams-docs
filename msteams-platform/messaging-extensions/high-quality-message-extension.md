...
description: Guidelines and criteria to extend your message extension as a plugin for Microsoft Copilot for Microsoft 365 and Copilot for Teams chats.
ms.topic: how-to
author: v-preethah
...
| Reliability | Apps must maintain 99.9% availability. For instance, if Copilot for Microsoft 365 calls a plugin 1,000 times, it must provide a meaningful response 999 times. [*Mandatory*] |
