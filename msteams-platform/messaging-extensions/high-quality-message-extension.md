...
| [Microsoft 365 Channel](#plugin-requirements-for-microsoft-365)| For users to interact with your message extension from Outlook, you need to add Microsoft 365 channel to your bot. For more information, see [Add Microsoft 365 channel](../m365-apps/extend-m365-teams-message-extension.md#add-microsoft-365-channel-for-your-app). [*Mandatory*]|
| [Single sign-on (SSO)](#plugin-requirements-for-microsoft-365) | If applicable, update your Microsoft Entra ID app registration for SSO.  [*Recommended*] |
| [Content Security Policy](#plugin-requirements-for-microsoft-365) |If applicable, modify your Content Security Policy headers. [*Recommended*] |
...
### Plugin requirements for Microsoft 365
