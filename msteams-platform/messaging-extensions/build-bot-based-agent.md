...
1. Select the required agent from the right-rail.
   ...
   :::image type="content" source="../assets/images/messaging-extension/message-extension-agent.png" alt-text="Screenshot shows the list of agents for bot-based-ME-test-local agent." lightbox="../assets/images/messaging-extension/message-extension-agent.png":::
...
1. Select the required agent from the right-rail.
   ...
   :::image type="content" source="../assets/images/messaging-extension/message-extension-agent.png" alt-text="Screenshot shows the list of agents for bot-based-ME-test-local agent.":::
