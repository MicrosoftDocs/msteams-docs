...
1. **Microsoft 365 Agents Toolkit CLI**: You can use Microsoft 365 Agents Toolkit CLI to create and manage Microsoft Teams apps from the command line. For more information, see [Microsoft 365 Agents Toolkit CLI set up instructions](https://github.com/microsoft/teams-ai/blob/main/getting-started/OTHER/TEAMS-TOOLKIT-CLI.md).
