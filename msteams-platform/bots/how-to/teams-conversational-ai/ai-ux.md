...
- Provide feedback received from the user to the agent.
- Use feedback to improve the quality of agent's responses.

Use Teams SDK by adding the feedback button property to the AI module. This property adds a feedback button to each AI-generated message automatically.
...
Design your agent to understand and refer to conversational history and context. It helps ensure that every interaction is relevant and tailored to user's specific needs. The agent can refer to the context and offer responses that are accurate and contextually appropriate.
...
Add hovercard experience for all agents and bots. Hovercards can provide valuable and relevant information to educate users about the app and its features.
