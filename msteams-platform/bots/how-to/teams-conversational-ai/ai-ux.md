...
To achieve this, the agent must leverage the conversation context and history, ensuring prompt suggestions are timely and appropriate for the query.
...
Add a hovercard experience for all agents and bots. Hovercards provide valuable and relevant information to educate users about the app and its features.
