...
For a bot built using Teams AI library, an AI label is automatically enabled for all AI-powered bot messages in the `ai` module within the `PredictedSayCommand` action. For more information, see [Teams AI library](https://github.com/microsoft/teams-ai/blob/main/js/packages/teams-ai/src/actions/SayCommand.ts).
...
For more information, see [Teams AI library](https://github.com/microsoft/teams-ai/blob/main/js/packages/teams-ai/src/actions/SayCommand.ts).
...
For more information, see [Teams AI library](https://github.com/microsoft/teams-ai/blob/main/js/samples/04.ai-apps/h.datasource-azureOpenAI/src/app.ts).
...
For bots built using Teams AI library, sensitivity labels can be added through `PredictedSayCommand` action. For more information, see [Teams AI library](https://github.com/microsoft/teams-ai/blob/main/js/packages/teams-ai/src/actions/SayCommand.ts#L107).
