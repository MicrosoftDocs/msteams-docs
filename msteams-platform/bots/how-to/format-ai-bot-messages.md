...
> * AI label, sensitivity label, citations, and feedback buttons aren't supported in message extensions.
...
The following code snippet from Teams AI library shows the AI label added to your bot's message:
...
The following code snippet shows how to add the AI label to your bot's message:
...
The following code snippet from Teams AI library shows the sensitivity label added to your bot's message:
...
Citations to your bot message includes:

* [In-text citations](#add-in-text-citations) to cite your text using the [X] format at any point within the text.
* [Citation reference list](#add-citation-reference) to list the corresponding references of the in-text citations. You must modify the message to include citation array in the `entities` object.
...
The following code snippet shows the format of in-text citations:
...
The following code snippet from Teams AI library shows the in-text citations added to your bot's message:
...
The following code snippet from Teams AI library shows the citation reference added to your bot's message:
...
To add a citation reference list to your message, include an entity object when your bot sends a response, as shown in the following code snippet:
...
You can add sensitivity labels to citations to indicate the confidentiality of the content referenced. To enable sensitivity labels for citations, use the following code snippet
