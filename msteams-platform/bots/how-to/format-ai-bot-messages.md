...
If you're building a conversational bot, you can now leverage features like citations and feedback buttons that enable better user engagement. For AI -powered bots, you can now add AI label and sensitivity label that can help you build trust and transparency with users.
