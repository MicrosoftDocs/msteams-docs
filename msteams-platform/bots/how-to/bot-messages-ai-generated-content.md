...
:::image type="content" source="../../assets/images/bots/bot-messages/ai-bot-no-features-desktop-new.png" border="false" alt-text="Screenshot shows a bot message with no AI label, citation, feedback buttons, and sensitivity label." lightbox="../../assets/images/bots/bot-messages/ai-bot-no-features-desktop-new.png":::
...
:::image type="content" source="../../assets/images/bots/bot-messages/ai-bot-message-desktop-new.png" border="false" alt-text="Screenshot shows a bot message with AI label, citation, feedback buttons, and sensitivity label in Teams desktop client." lightbox="../../assets/images/bots/bot-messages/ai-bot-message-desktop-new.png":::
...
:::image type="content" source="../../assets/images/bots/bot-messages/ai-bot-no-features-mobile-new.png" border="false" alt-text="Screenshot shows a bot message with no AI label, citation, feedback buttons, and sensitivity label in Teams mobile client." lightbox="../../assets/images/bots/bot-messages/ai-bot-no-features-mobile-new.png":::
...
:::image type="content" source="../../assets/images/bots/bot-messages/ai-bot-message-mobile-new.png" border="false" alt-text="Screenshot shows a bot message with AI label, citation, feedback buttons, and sensitivity label in Teams mobile client." lightbox="../../assets/images/bots/bot-messages/ai-bot-message-mobile-new.png":::
...
:::image type="content" source="../../assets/images/bots/bot-messages/ai-bot-label-new.png" border="false" alt-text="Screenshot shows an AI label in a bot message in the Teams desktop client." lightbox="../../assets/images/bots/bot-messages/ai-bot-label-new.png":::

# [Mobile](#tab/mobile)

:::image type="content" source="../../assets/images/bots/bot-messages/bot-ai-label-mobile-new.png" border="false" alt-text="Screenshot shows an AI label in a bot message in the Teams mobile client." lightbox="../../assets/images/bots/bot-messages/bot-ai-label-mobile-new.png":::
...
:::image type="content" source="../../assets/images/bots/bot-messages/ai-bot-inline-citation-new.png" border="false" alt-text="Screenshot shows an AI-powered bot response with citations in the Teams desktop client." lightbox="../../assets/images/bots/bot-messages/ai-bot-inline-citation-new.png":::
...
:::image type="content" source="../../assets/images/bots/bot-messages/bot-feedback-buttons-new.png" border="false" alt-text="Screenshot shows the feedback buttons in a bot in the Teams desktop client." lightbox="../../assets/images/bots/bot-messages/bot-feedback-buttons-new.png":::

# [Mobile](#tab/mobile)

:::image type="content" source="../../assets/images/bots/feedback-buttons-mobile.png" border="false" alt-text="Screenshot shows feedback buttons in a bot in the Teams mobile client." lightbox="../../assets/images/bots/feedback-buttons-mobile.png":::
...
:::image type="content" source="../../assets/images/bots/bot-messages/ai-bot-sensitivity-label-new.png" border="false" alt-text="Screenshot shows an AI-powered bot with sensitivity label in the Teams desktop client.":::
