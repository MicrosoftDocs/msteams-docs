...
> [!NOTE]
> It's recommended that you'd create a command bot by following the step-by-step guide to [build command bot with JavaScript](../../sbs-gs-commandbot.yml) using the new generation development tool for Teams. For more information about Microsoft 365 Agents Toolkit, see [Agents Toolkit overview for Visual Studio Code](../../toolkit/teams-toolkit-fundamentals.md) and [Agents Toolkit overview for Visual Studio](../../toolkit/teams-toolkit-overview-visual-studio.md).
