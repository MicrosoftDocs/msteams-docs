...
2. In **App Studio**, select the **Manifest editor** tab. If you do not have an existing app package, you can create or import an existing app. For more information, see [update an app package](~/get-started/build-and-test-csharp-app.md#use-app-studio-to-update-the-app-package).
