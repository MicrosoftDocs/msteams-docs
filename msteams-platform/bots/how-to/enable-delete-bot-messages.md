...
Bot users can now delete bot messages in group chats. Developers can enable this feature, allowing users to remove bot messages. You can enable users to delete bot message to:
...
- **Improve user experience**: Maintaining a clean chat environment enhances user experience and helps keep the conversation contextually relevant.
