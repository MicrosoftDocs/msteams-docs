...
If a bot's response is inaccurate or compromises sensitive information, any user can delete the bot using the overflow **Delete** option. Here are some examples of user experience in personal and group chat:
