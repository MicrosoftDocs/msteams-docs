...
author: surbhigupta
description: How to add OAuth authentication to a bot in Microsoft Teams using Microsoft Azure Active Directory (Azure AD). Learn how to create, deploy, and integrate authentication-enabled bots.
ms.topic: how-to
