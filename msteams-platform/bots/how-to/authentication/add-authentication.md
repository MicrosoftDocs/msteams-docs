...
Sometimes, behalf of user you need to create bots in Microsoft Teams and access the resources such as mail service.  

This article demonstrates how to use Azure Bot Service v4 SDK authentication, based on OAuth 2.0. Further, it also helps to develop a bot to use authentication tokens based on the user's credentials. The key aspect of all this information is the use of **identity providers**, that we see in later.
...
The resource group and the service plan aren't strictly necessary, but they allow you to conveniently release the resources you create. They also help in keeping your resources organized and manageable.
...
1. You'll be asked to provide the following information:
    ...
    1. **Pricing Tier**. Make sure that *Standard S1* is selected and set the default value. 
    1. Select the **Review and create** button. You should see a banner that reads *Validation passed*.
...
1. You'll be asked to provide the following information:
   ...
   1. Select the **Supported account types** for your application. Select *Accounts in any organizational directory (Any Azure AD directory - Multitenant) and personal Microsoft accounts (for example, Skype, Xbox)*.
...
1. Complete the form as follows:
    ...
    h. For **Resource URL**, enter `https://graph.microsoft.com/`, which is not used in the current code sample.  
...
1. Complete the form as follows:
    ...
    1. **Service Provider**. Select **Azure Active Directory v2**. Once you select, the Azure AD-specific fields will be displayed.
    1. **Client id**. Enter the Application (client) ID that you recorded for your Azure identity provider app in the steps above.
    1. **Client secret**. Enter the secret that you recorded for your Azure identity provider app in the steps above.
...
To deploy the bot, follow the steps[Deploy your bot to Azure](https://aka.ms/azure-bot-deployment-cli).

In Visual Studio, you can follow these steps:

1. In the Visual Studio *Solution Explorer, select and hold (or right-click) the project name.
