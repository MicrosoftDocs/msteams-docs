...
Microsoft Entra ID provides app users access to your bot or message extension app. App users signed in to Microsoft Teams can access your app.

<a name='sso-configuration-in-azure-ad-portal'></a>

## SSO configuration in Microsoft Entra admin center

Bot and message extension apps use Bot Framework for communicating with app users and implementing authentication.
...
* **Configure SSO using bot resource and configure Microsoft Entra app**: Start by configuring SSO for your bot resource, and enable SSO for your Microsoft Entra app. You'll configure:
...
* **Configure SSO using Microsoft Entra app and then configuring bot resource**: Start by configuring your Microsoft Entra app, and then use this app ID in the bot resource when you enable SSO for it. You'll configure:
...
![Screenshot shows the bot Configuration menu.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-bots/bot-app-menu.png)
The **Configuration** page appears.

1. Enter the messaging endpoint URL where your bot receives app user's messages.
![Screenshot shows the Messaging endpoint option to add the URL where the bot interacts with the user.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-bots/message-endpoint.png)
...
![Screenshot shows the Microsoft Entra admin center Manifest.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-bots/azure-portal-manifest.png)
The Microsoft Entra app manifest appears.

1. Set the `requestedAccessTokenVersion` property to **2**.
![Screenshot shows the Value for access token version.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-bots/azure-manifest-value.png)

1. Select **Save**.
A message appears on the browser stating that the app manifest was updated successfully.
![Screenshot shows the Manifest updated message.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-tabs/update-aad-manifest-msg.png)
...
1. Select **Settings** > **Configuration**.
![Screenshot shows the bot Configuration menu under Settings.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-bots/bot-app-menu.png)
The **Configuration** page appears.

1. Select **Manage**.
![Screenshot shows the Bot resource configuration.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-bots/bot-config-manage.png)
...
![Screenshot shows the Bot app page with Application client ID highlighted.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-bots/aad-app-regd.png)
...
![Screenshot shows the Set option of Application ID URI.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-bots/expose-an-api.png)
The section for setting application ID URI appears.

1. Enter the application ID URI in the format explained here.
![Screenshot shows the Application ID URI added.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-tabs/set-app-id-uri.png)
* **Application ID URI** is prefilled with app ID (GUID) in the format `api://{AppID}`.
> [!IMPORTANT]
>
> * **Sensitive information**: Application ID URI is logged as part of the authentication process and must not contain sensitive information.
>
> * **Standalone bot**: If you're building a standalone bot, enter application ID URI as api://botid-{YourBotId}. Here, {YourBotId} is your Microsoft Entra application ID.
> * **Application ID URI for app with multiple capabilities**: If you're building an app with a bot, a messaging extension, and a tab, enter application ID URI as `api://fully-qualified-domain-name.com/botid-{YourClientId}`, where `{YourClientId}` is your bot app ID.
>
...
1. Select **Save**.
A message appears on the browser stating that application ID URI was updated.
![Screenshot shows the Application ID URI updated message.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-tabs/app-id-uri-msg.png)
Application ID URI displays on the page.
![Screenshot shows the updated Application ID URI.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-bots/app-id-uri-added.png)

1. Note and save application ID URI. You'll need it for updating the app manifest later.

Application ID URI is configured. You can now define scope and permissions for your app.
...
![Screenshot shows the Add a scope option highlighted.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-tabs/select-scope.png)
**Add a scope** page appears.

1. Enter the details for configuring scope.
![Screenshot shows how to add scope details in Azure.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-tabs/add-scope.png)
...
![Screenshot shows the Scope added message.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-tabs/scope-added-msg.png)
> [!NOTE]
...
![Screenshot shows the Add a client application option highlighted under Authorized client applications.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-tabs/auth-client-apps.png)
**Add a client application** page appears.
...
![Screenshot shows the Client ID added.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-tabs/add-client-app.png)
> [!NOTE]
>
> * Microsoft 365 client IDs for mobile, desktop, and web applications for Teams, Microsoft 365 app, and Outlook are the actual IDs that you must add.
...
>   * `botId` in the bots section refers to the Azure Bot registration used for messaging and interaction.
>   * `webApplicationInfo.id` refers to the Microsoft Entra App Registration used for authentication such as SSO, token acquisition, Graph API access.
...
![Screenshot shows the Client ID added message.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-tabs/update-app-auth-msg.png)
The authorized app's client ID displays on the page.
![Screenshot shows the newly added Client ID under Authorized client applications screen.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-tabs/client-app-added.png)
> [!NOTE]
...
![Screenshot shows the Certificates and secrets menu option.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-bots/client-secret-menu.png)
The **Certificates & secrets** page appears.

1. Select **+ New client secret**.
![Screenshot shows the New client secret option highlighted to add a new client secret.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-bots/client-secret.png)
The **Add a client secret** page appears.
![Screenshot shows the Add a client secret page to provide the required details.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-bots/add-client-secret.png)
...
![Screenshot shows the Client secret added message.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-bots/client-secret-added.png)
...
1. Open the app you registered in [Azure portal](https://ms.portal.azure.com/).

1. Select **Manage** > **Authentication** from the left pane.
![Screenshot shows the Authentication option under Manage.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-bots/azure-portal-platform.png)
The **Platform configurations** page appears.

1. Select **+ Add a platform**.
![Screenshot shows the Add a platform option under Authentication.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-bots/add-platform.png)
...
![Screenshot shows the selection of web platform.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-bots/configure-platform.png)
...
![Screenshot shows the Configure Web page to provide inputs.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-bots/config-web-platform.png)
...
With the app (client) ID and client secret provided, Bot Framework Token Store exchanges the token for a graph token with defined permissions.
...
1. Select **Settings** > **Configuration**.
![Screenshot shows the configure OAUth settings for your bot app.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-bots/bot-configuration.png)
The **Configuration** page appears.

1. Move through the **Configuration** page and select **Add OAuth Connection Settings**.
![Screenshot shows the Add OAuth Connection Settings option highlighted.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-bots/bot-oauth-connection.png)
The **New Connection Setting** page appears.

1. Enter the OAuth configuration settings for the Azure bot.
![Screenshot shows the New Connection Setting to provide the details.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-bots/new-config-setting.png)
1. Enter a name for the configuration setting.
1. Select the service provider.
The remaining configuration details appear.
![Screenshot shows the additional fields for New Connection Setting.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-bots/new-config-setting-b.png)
...
![Screenshot shows the Test OAuth connection for your bot resource option.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-bots/test-oauth.png)
...
1. Select **Settings** > **Configuration**.
![Screenshot shows the Configuration menu.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-bots/bot-app-menu.png)
The **Configuration** page appears.
...
> [!NOTE]
> For this tutorial, use openid profile User.Read User.ReadBasic.All as scope. This scope is suitable for using [Code sample](bot-sso-code.md#code-sample). You can also add more Graph scopes and permissions. For more information, see [Extend your app with Microsoft Graph permissions and scopes](bot-sso-graph-api.md).
...
The scope and permissions are now configured. Next, configure the authorized client applications for your Microsoft Entra app.
...
1. Move through **Expose an API** page to **Authorized client application** section, and select **+ Add a client application**.
![Screenshot shows the Add a client application option highlighted under Authorized client applications.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-tabs/auth-client-apps.png)
**Add a client application** page appears.
...
1. Select **+ New client secret**.
![Screenshot shows the New client secret option highlighted to add a new client secret.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-bots/client-secret.png)
**Add a client secret** page appears.
![Screenshot shows the Add a client secret page to provide the required details.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-bots/add-client-secret.png)
1. Enter the description.
1. Select the duration of validity for the secret.
...
1. Select **Manage** > **Authentication** from the left pane.
![Screenshot shows the Authentication option under Manage.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-bots/azure-portal-platform.png)
**Platform configurations** page appears.

1. Select **+ Add a platform**.
![Screenshot shows the Add a platform option under Authentication.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-bots/add-platform.png)
**Configure platforms** page appears.

1. Select the platform that you want to configure for your app. You can select the platform type from web or SPA.
![Screenshot shows the selection of web platform.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-bots/configure-platform.png)
**Configure Web** page appears.

> [!NOTE]
> Configurations differ based on the platform you select.

1. Enter configuration details for the platform.
![Screenshot shows the Configure Web page to provide inputs.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/authentication/teams-sso-bots/config-web-platform.png)
...
1. Select **Configure**.
The platform is configured and displayed in **Platform configurations** page.

Configuration for Microsoft Entra app is complete, and now configure your bot resource for enabling SSO.
...
Now, configure the OAuth connection to enable SSO for your bot resource.
...
After you've configured the OAuth connection, select **Test connection** to check if the OAuth connection is successful.
...
* Keep Microsoft Entra app registration restricted to its original purpose of service to service application.
* For better control over disabling authentication connections, rolling secrets, or reusing Microsoft Entra app with other applications, create an additional Microsoft Entra app for any user to service authentication.

If you use Microsoft Entra registration app for authentication, you might encounter the following issues:

* If you renew the certificate attached to Microsoft Entra app registration, it affects the users who have authenticated with other Microsoft Entra services using the certificate.
