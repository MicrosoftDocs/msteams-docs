...
## Configure SSO for your bot resource

The first step to enable SSO for your bot resource is to configure it in the Azure AD portal.

By the end of this configuration, you should have configured:
