...
description: Learn how to optimize bot with rate limiting. Detect transient exceptions, per bot thread limit for all bots. You can also perform an exponential backoff.
ms.topic: conceptual
