...
Tip: To get {item-id} for a given file, use [List children](https://learn.microsoft.com/graph/api/driveitem-list-children?view=graph-rest-1.0&tabs=http) or [Search](https://learn.microsoft.com/graph/api/driveitem-search?view=graph-rest-1.0&tabs=http).
