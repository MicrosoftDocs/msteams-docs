...
| Calling and meeting bot | This sample app demonstarte how an Bot can create a call, join a meeting and transfer the call. | [View](https://github.com/OfficeDev/Microsoft-Teams-Samples/tree/main/samples/bot-calling-meeting/csharp) |
