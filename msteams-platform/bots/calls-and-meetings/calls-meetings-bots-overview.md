...
* [Registering a bot that supports calls and online meetings](~/bots/calls-and-meetings/registering-calling-bot.md) and [Microsoft Graph permissions for calls and online meetings bots](~/bots/calls-and-meetings/registering-calling-bot.md#add-microsoft-graph-permissions)
* [How to develop calling and online meeting bots on your local PC](~/bots/calls-and-meetings/debugging-local-testing-calling-meeting-bots.md)
* [More information on real-time media processing](~/bots/calls-and-meetings/real-time-media-concepts.md), and [what's needed to support application-hosted media](~/bots/calls-and-meetings/requirements-considerations-application-hosted-media-bots.md)
* [Technical information on handling incoming call notifications](~/bots/calls-and-meetings/call-notifications.md)
