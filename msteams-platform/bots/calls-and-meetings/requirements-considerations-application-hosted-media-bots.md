...
This document describes important requirements and considerations for developing and running an application-hosted media bot. This document covers the following:
