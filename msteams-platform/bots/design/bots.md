...
More details on [welcome message requirements](https://docs.microsoft.com/microsoftteams/platform/concepts/deploy-and-publish/appsource/prepare/frequently-failed-cases#-personal-bots-must-always-send-a-welcome-message-on-first-launch)
