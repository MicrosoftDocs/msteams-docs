...
Let's start by building a bot. You can use Agents Toolkit or Teams SDK. After you build a conventional Teams bot app, you can add the AI layer to your bot to elevate it.
