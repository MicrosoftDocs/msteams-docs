...
When you're deciding how to develop your bot, it's crucial to understand the available options. You need to decide between an AI-enabled bot or a conventional one. This article provides a quick overview to help you get started. It guides you on how to build a basic bot app and then enhance it into a Teams agent.

## Choose the tools and platforms

If you're interested in creating your own bot, here's a list of tools and platforms to assist you in getting started:
