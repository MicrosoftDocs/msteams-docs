---
title: Build a bot
description: Learn to build a basic chatbot using Microsoft 365 Agents Toolkit, Bot Framework SDK. Additionally, learn to build an custom engine agent.
...
Let's start by building a bot. You can use Microsoft 365 Agents Toolkit, Bot Framework SDK, or Teams AI library. After you build a conventional Teams bot app, you can add the AI layer to your bot to elevate it.
...
| 2. | Conversational bot using Microsoft 365 Agents Toolkit | [Create Teams conversation bot](../sbs-teams-conversation-bot.yml) |
...
| --- | --- | --- |
| 1. | Custom engine agent with Teams AI library and Microsoft 365 Agents Toolkit | [Build a custom engine agent](../Teams-AI-library-tutorial.yml) |
