...
Here's a list of limitations when you use Azure OpenAI or OpenAI to stream bot messages:

- The `SendActivity` request is restricted to one Request Per Second (RPS). The AI SDK buffers up to 1.5 seconds.
