...
1. Use the `DefaultAugmentation` class. Update one of the following based on requirement
    * For an app built using C#: Update the `program.cs`.
    * For an app built using JavaScript: Update `index.ts`.
    * For an app built using Python: Update `bot.py`.
