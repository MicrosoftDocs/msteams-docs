...
* **Set informative message**:
  ...
  You can set up just one informative message for your AI-powered bot. This message will keep appear for the user every time the bot sends a new update.
...
* **Edit the final streamed message**:
  ...
  Using AI SDK, text messages and simple markdown while they are being streamed. However, for adaptive cards, images, or rich HTML, the formatting can only be applied once the final message is complete.

  You can send attachments only in the final streamed chunk.
...
* **Enable AI-powered features for final message**:
  ...
  * **Feedback Loop**: You can configure the feedback loop by using the AIOptions object in the app declaration and specifying a handler. This allows users to provide positive or negative feedback on the bot messages.
  * **Generated by AI**: The Teams AI library automatically includes a "Generated by AI" tag in the bot's responses. This tag helps users identify that a message was generated using AI.
...
* For Powered by AI features, Citations, Sensitivity Label, Feedback Loop and Generated by AI Label are supported in the final chunk. Citations are set per each text chunk queued.
