...
| --- | --- | --- | --- | --- |
| Teams streaming bot sample| This sample app can be used for streaming scenarios in Teams using Azure Open AI and Microsoft 365 Agents SDK (previously known as Bot Framework SDK) v4 for personal scope. | NA | [View](https://github.com/OfficeDev/Microsoft-Teams-Samples/tree/main/samples/bot-streaming/csharp) | NA |
