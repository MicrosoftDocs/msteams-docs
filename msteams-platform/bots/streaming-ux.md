...
- `SendActivity` requests are restricted to one Request Per Second (RPS). The AI SDK buffers up to 1.5 seconds.
...
- You can set only one informative message. This message is reused for each update. Examples include:
  - **Scanning through documents**
  - **Summarizing content**
  - **Finding relevant work items**
