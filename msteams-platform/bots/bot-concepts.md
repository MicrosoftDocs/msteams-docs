...
> [!NOTE]
> Teams platform supports Transport Layer Security (TLS) versions 1.0, 1.1, and 1.2, but not TLS version 1.3. Ensure you configure your bot environment accordingly.
