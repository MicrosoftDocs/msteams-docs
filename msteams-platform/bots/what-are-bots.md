...
:::image type="content" source="../assets/images/invokebotwithcard.png" alt-text="Web service using interactive cards."lightbox="../assets/images/invokebotwithcard.png":::

:::image type="content" source="../assets/images/task-module-example.png" alt-text="Web service using task module."lightbox="../assets/images/task-module-example.png":::
