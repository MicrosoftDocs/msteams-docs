...
* Bot name in your Teams chat list and the bot name appears with each message in the chat pane are managed within the Azure portal. You can update bot name in the **Bot profile** page in Azure portal.
