...
:::image type="content" source="../assets/images/invokebotwithtext.png" alt-text="The screenshot is an example that shows the conversational bot interacting with web service using text."lightbox="../assets/images/invokebotwithtext.png":::

:::image type="content" source="../assets/images/invokebotwithcard.png" alt-text="The screenshot is an example that shows the conversational bot interacting with web service using interactive cards."lightbox="../assets/images/invokebotwithcard.png":::

:::image type="content" source="../assets/images/task-module-example.png" alt-text="The screenshot is an example that shows the conversational bot interacting with web service using task module."lightbox="../assets/images/task-module-example.png":::
...
:::image type="content" source="~/assets/images/FAQPlusEndUser.gif" alt-text="The illustration is an example that shows the sample FAQ bot.":::
