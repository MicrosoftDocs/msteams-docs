...
1. Extend functionality by adding more Teams capabilities and Microsoft 365 data with :::image type="icon" source="assets/icons/microsoft-icon.png"::: Microsoft Graph.
