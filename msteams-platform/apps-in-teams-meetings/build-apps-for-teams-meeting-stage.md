...
> * The Reaction API works only for apps in personal scope. To install an app in personal scope, see [Upload your app in Teams](../concepts/deploy-and-publish/apps-upload.md).
...
> * The Raise Hand API works only for apps in personal scope. To install an app in personal scope, see [Upload your app in Teams](../concepts/deploy-and-publish/apps-upload.md).
