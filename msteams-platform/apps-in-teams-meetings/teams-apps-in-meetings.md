...
This article provides an overview of meeting app extensibility, API references, enable and configure apps for meetings, and customize Together Mode scene in Teams.
...
The new customize Together Mode scene feature enables users to collaborate in a meeting with their team in one place without being separated by boxes.
...
* [Customize Together Mode scene](~/apps-in-teams-meetings/teams-together-mode.md)
