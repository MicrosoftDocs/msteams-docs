...
> * By default, Teams Meetings are available in light Theme. Your app can update the app UI based on the user's theme by using the [getContext API](meeting-apps-apis.md#get-user-context-api).
