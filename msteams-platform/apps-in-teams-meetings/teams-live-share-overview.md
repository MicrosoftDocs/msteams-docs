...
author: surbhigupta
description: Learn Live Share SDK and its user scenarios, Live share core, media, and canva, build apps with Live Share, Live Share collaborative contexts, and React integration.
ms.topic: overview
