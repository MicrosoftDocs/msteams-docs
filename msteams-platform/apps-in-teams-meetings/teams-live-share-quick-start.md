...
author: surbhigupta
description: Learn how to build and run the Dice Roller sample using Microsoft Live Share SDK with development environment such as Node.js, Microsoft Visual Studio Code, and Git.
ms.topic: conceptual
