...
|**canShareAppSegment**|This queries the Client SDK whether app can be shared to stage or not.|--|Microsoft Teams Client SDK|
|**shareAppContentToStage**|This allows for sharing a segment of an app to the meeting stage through the meeting’s side panel. |--|Microsoft Teams Client SDK|
|**getAppContentStageSharingCapabilities**|This API checks whether the app has the capability to share to stage. |--|Microsoft Teams Client SDK|
