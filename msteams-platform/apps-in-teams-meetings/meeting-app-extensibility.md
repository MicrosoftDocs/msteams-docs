...
| Actions supported | Select the dropdown menu next to the meet  and select schedule a meeting, it leads an user to the calender and auto adds the team within the channel. | Apps does'nt support unscheduled channel meetings. |
