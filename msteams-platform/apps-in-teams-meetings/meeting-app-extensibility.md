...
> * App manifest uses the context field and specifies the places in which you want the apps to appear. It also acts as a part of share-tray experinece, as mention in the specified design guidelines.
