...
| Channel Meetings Support Meeting Extensibility | Meetings on Mobile can have apps which can be accessed while you are in that channel meeting and are tied to that Post in the Channel | The intent is to only provide consumption experience on Mobile and not the capability to add apps on Mobile meetings.
