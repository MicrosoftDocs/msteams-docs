...
> * App manifest uses the context field and specifies the places, where the user want the apps to appear. Further, acts as a part of a share-tray experience as mentioned in the specified design guidelines.
