...
> [!NOTE]
> All the users in meeting can see the app when shared on desktop and mobile. However, the capability to start an app shared to stage from mobile is currently not available.
