...
| App caching | Sample app to show how app caching works in the meeting side panel. | NA | [(Work-in progress) View](https://github.com/OfficeDev/Microsoft-Teams-Samples/tree/main/samples/app-cache-meetings/nodejs) |
