...
The in-meeting dialog box is used to engage participants during the meeting and collect information or feedback during the meeting. [Send notification signal API](API-references.md#send-notification-signal-api) API to trigger a bubble notification. As part of the notification request payload, include the URL where the content to be shown is hosted.
