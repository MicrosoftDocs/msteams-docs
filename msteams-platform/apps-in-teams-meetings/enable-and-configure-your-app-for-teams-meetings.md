...
To create a deeplink to your meeting side panel, see [deep links](~/concepts/build-and-test/deep-links.md#generate-a-deep-link-to-your-tab). When a deeplink is selected anywhere in the meeting stage it will open the side panel or else it opens in the pre or post meeting tab.
