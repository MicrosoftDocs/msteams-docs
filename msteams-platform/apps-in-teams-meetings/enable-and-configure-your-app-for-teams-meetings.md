...
To create a deeplink to your Meeting SidePanel, see [deep links](~/concepts/build-and-test/deep-links#generate-a-deep-link-to-your-tab). When a deeplink is shared in the meeting stage then it would open the deeplink in the shared meeting stage.
