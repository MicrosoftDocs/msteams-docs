...
| **meetingStage** | An app from the **meetingSidePanel** can be shared to the meeting stage.You can't use this app either on mobile or Teams room clients, but users can view it on their mobile when it's shared via desktop. |
