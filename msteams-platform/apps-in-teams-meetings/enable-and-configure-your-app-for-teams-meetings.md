...
> [!NOTE]
> * The in-meeting dialog displays a dialog in a meeting and can simultaneously post an Adaptive Card in the meeting chat that users can access. This helps users in the meeting or when the meeting or the Teams app is minimized.
