...
> [!NOTE]
> * The side panel is not supported in the older version of SDK. Make sure you use the latest version 1.9.0 of [Teams SDK](https://docs.microsoft.com/javascript/api/overview/msteams-client?view=msteams-client-js-latest). The minimum required version is 1.9.0.
