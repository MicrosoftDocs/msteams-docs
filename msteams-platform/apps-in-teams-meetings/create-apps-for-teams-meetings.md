...
In-meeting dialog must not use task module. Task module is not invoked in meeting chat rather external resource URL is used to display content bubble pop-up in meeting. Then you can use `submitTask` method to submit the data in meeting chat.
