...
|[**Get app content stage sharing state**](build-apps-for-teams-meeting-stage.md#get-app-content-stage-sharing-state-api))| Fetch information about app's sharing state on the meeting stage. | [MSTC SDK](/javascript/api/@microsoft/teams-js/meeting.iappcontentstagesharingstate) |
|[**Get app content stage sharing capabilities**](build-apps-for-teams-meeting-stage.md#get-app-content-stage-sharing-capabilities-api))| Fetch the app's capabilities for sharing to the meeting stage. | [MSTC SDK](/javascript/api/@microsoft/teams-js/meeting.iappcontentstagesharingcapabilities) |
