...
After you're ready to deploy your code, you can use Teams Toolkit or the Teams Developer Portal to provision and upload your app's zip file. To learn more about publishing and deploying your Teams app, see the following resources:

* [Publish your app using Teams Toolkit](../toolkit/publish.md).
