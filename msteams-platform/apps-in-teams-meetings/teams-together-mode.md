...
5. Drag and drop the image into the environment as displayed in the following image:
    ...
    >[!NOTE]
    > * You can download the zip files with the images from [sample-app](~/apps-in-teams-meetings/Sample App-1.zip) and [sample-scene](~/apps-in-teams-meetings/Sample-Scene-1.zip)
