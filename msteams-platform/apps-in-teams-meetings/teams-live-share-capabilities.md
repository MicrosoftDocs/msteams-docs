...
| [SharedSequence](https://fluidframework.com/docs/data-structures/sequences/) | A list-like data structure for storing a set of items at set positions. |
| [SharedString](https://fluidframework.com/docs/data-structures/string/) | Distributed string sequence optimized for document-text editing. |

Let's look at a quick example of `SharedMap`:
...
| EphemeralState | Distributed string sequence optimized for document-text editing. |
