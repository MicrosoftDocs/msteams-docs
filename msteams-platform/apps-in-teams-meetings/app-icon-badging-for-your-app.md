...
> [!NOTE]
>
> * App icon badging is available for [Government Community Cloud (GCC), GCC High and Department of Defense (DOD)](~/concepts/app-fundamentals-overview.md#government-community-cloud) environments.
