...
| [Microsoft 365 account](../toolkit/accounts.md#Microsoft 365 developer subscription account types) | Microsoft 365 account includes 25 user licenses, including the administrator, for development purposes only. |
| [Microsoft 365 developer program](../toolkit/accounts.md#Join the Microsoft 365 developer program subscription) | The Microsoft 365 Developer Program helps you build apps that extend Microsoft 365. |
