...
|[Anonymous](../apps-in-teams-meetings/teams-apps-in-meetings.md#user-types-in-teams) |The anonymous participants are like external users but their identity isn't shown in the meeting. <br>**See also**: [Federated or external](#f); [In-tenant](#i); [Guest](#g)|
...
| [Guest](../apps-in-teams-meetings/teams-apps-in-meetings.md#user-types-in-teams)| A guest is a participant from another organization invited to access Teams or other resources in the organization's tenant. <br>**See also**: [Anonymous](#a); [In-tenant](#i); [Federated or external](#f)|
