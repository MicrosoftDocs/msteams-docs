...
| [Task info](../task-modules-and-cards/task-modules/invoking-task-modules.md#the-dialoginfo-object) | The `TaskInfo` object contains the metadata for a dialogs (referred as task modules in TeamsJS v.1.0).|
