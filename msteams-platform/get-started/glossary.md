...
| [Teams AI library v2](/microsoftteams/platform/teams-ai-library/welcome) | Teams AI Library v2 SDK (preview) simplifies the development of AI-driven bots for Microsoft Teams. <br> **See also**: [Custom engine agent](#c) |
