...
| [TeamsJS library](../tabs/how-to/using-teams-client-library.md) | The TeamsJS library enables you to create hosted experiences in supported clients including Teams, Outlook, and Microsoft 365.<br/> > [!NOTE] <br/> When using TeamsJS v.1.x, hosted experiences are for Teams client only. |
