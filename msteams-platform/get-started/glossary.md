...
| [Authorization](../resources/schema/manifest-schema.md#authorization)| An app manifest property that specifies and consolidates authorization related information for the app. <br> **See also**: [Permission](#p)|
