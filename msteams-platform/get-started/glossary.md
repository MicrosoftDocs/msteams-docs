...
| [GUID](../tabs/how-to/authentication/tab-sso-register-aad.md) | GUID, a specific-format identifier, is referred to as the application ID or client ID. Microsoft identity platform assigns this ID to your app when you register in Azure AD. The ID helps to uniquely identify your app and the configuration within the identity platform. <br> **See also**: [Application ID](#a) |
