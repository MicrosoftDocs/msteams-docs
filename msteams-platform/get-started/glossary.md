...
|[Authorization](../resources/schema/manifest-schema.md#authorization)| Specifies and consolidates authorization related information for the app.|
...
| [Configurable tab](../resources/schema/manifest-schema.md#configurabletabs)| Configurable tabs are supported only in the `team` and `groupChat` scopes and you can configure the same tabs multiple times. It is used when your app experience has a team channel tab experience, which requires extra configuration before it's added. <br> **See also**: [App manifest](#a)|
| [Configuration URL](../resources/schema/manifest-schema.md#configurabletabs)| The https:// URL to use when configuring the tab. <br> **See also**: [App manifest](#a)|
...
| [Content URL](../resources/schema/manifest-schema.md#statictabs)| The https:// URL that points to the entity UI to be displayed in the Teams canvas. <br> **See also**: [App manifest](#a)|
