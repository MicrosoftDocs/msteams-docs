...
| [First-run Experience](../concepts/design/design-teams-app-ui-templates.md)|A First-run Experience (FRE) is a user's introduction to your product. The FRE provides users with insight into the functions, features, and benefits of the product and helps influence users' to come back and continue using your product.|
