...
| [Microsoft Teams JavaScript client library](../tabs/how-to/using-teams-client-library.md) | Microsoft Teams JavaScript client library enables you to create hosted experiences in Teams. Starting with TeamsJS v.2.0.0, you can extend Teams apps to run in Outlook and Office. |
