...
| [Bot Framework](../bots/bot-features.md) | A rich SDK used to create bots using C#, Java, Python, and JavaScript. If you have a bot that is based on the Agents SDK, you can modify it to work in Teams. <br> [Bot Framework Token Service](#b); [Bot Framework Schema](#b) |
...
| Agents SDK Schemas | Agents SDK Schemas are specifications for JSON data. They define the shape of the data and can be used to validate JSON. <br> **See also**: [Bot Framework](#b) |
| [Bot Framework Token Service](../bots/how-to/authentication/bot-sso-overview.md) | It's a feature of Agents SDK that facilitates a bot app to use the OAuth protocol for acquiring and storing access token. <br> **See also**: [Bot Framework](#b); [SSO](#s); [Access token](#a); [Identity token](#i) <br> For more information, see [Bot Framework Token Service](/azure/bot-service/bot-builder-concept-authentication#about-the-bot-framework-token-service) |
