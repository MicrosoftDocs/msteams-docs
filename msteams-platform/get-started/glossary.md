...
| [Capabilities](../concepts/design/map-use-cases.md#app-capabilities-mapped-to-features)| Capabilities are the core functionalities that you can build in your app such as tabs, bots, and message extensions. They're also called entry or extension points because they enable integration and interaction. <br> **See also**: [App scope](#a)|
