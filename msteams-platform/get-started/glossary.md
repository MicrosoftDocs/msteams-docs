...
| [TeamsJS SDK](../tabs/how-to/using-teams-client-sdk.md) | TeamsJS SDK enables you to create hosted experiences in Teams. [Latest version](~/m365-apps/using-teams-client-sdk-preview.md) has functionalities to extend Teams app to run in Outlook and Office. |
