...
| App tray | An application tray located on the bottom bar of a Teams mobile app. It collects all apps that are open but not used or active. <br>**See also**: [Teams Mobile](#t) |
