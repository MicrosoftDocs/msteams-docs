...
| [Dialogs](../task-modules-and-cards/what-are-task-modules.md) (referred as task modules in TeamsJS v.1.0) | A feature of Teams app to create modal pop-up for completing tasks, displaying videos, or dashboard. <br> **See also**: [Adaptive Card](#a) |
...
| [Task modules](../task-modules-and-cards/what-are-task-modules.md) (referred as dialogs in TeamsJS v.2.0)| A feature of Teams app to create modal pop-up for completing tasks, displaying videos, or dashboard. <br> **See also**: [Adaptive Card](#a) |
