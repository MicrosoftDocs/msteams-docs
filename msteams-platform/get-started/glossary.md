...
| [Standalone app](../samples/integrating-web-apps.md) | An app that can be added to Teams to customize chats and channels by adding bots, tabs, message extensions, or connectors. Anyone can install standalone apps for their personal use, and based on permissions, both admins and members can install them in channels for collaboration. Standalone apps can be built by developers or provided by Microsoft such as, Planner, ServiceNow, and Jira. <br>**See also**: [Collaboration app](#c) |
