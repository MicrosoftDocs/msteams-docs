...
| [Local environment](../toolkit/teamsfx-multi-env.md#Create and manage environments for Teams app) | A default development environment created by Teams Toolkit.  <br>**See also**: [Environment](#e); [Dev environment](#d) |
