...
| Bot handle | The Bot Handle is a unique identifier for your bot. You can choose a different Display Name for your bot in the Settings blade after bot creation. <br> [SSO](#s), [Bot resource](#b), [Azure AD](#a) <br> For more information, see [Configure your app in Azure AD](../bots/how-to/authentication/bot-sso-register-aad.md). |
