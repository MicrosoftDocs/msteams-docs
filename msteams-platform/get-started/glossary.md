...
| [GUID](../tabs/how-to/authentication/tab-sso-register-aad.md) | The GUID is a specific format identifier  and also known as the application ID or client ID, is a value the Microsoft identity platform assigns to your app when you register it in Azure AD. The GUID value uniquely identifies the app and its configuration within the identity platform. <br> **See also**: [Application ID](#a) |
