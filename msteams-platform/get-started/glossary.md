...
| [TeamsJS](../tabs/how-to/using-teams-client-library.md) | TeamsJS enables you to create hosted experiences in Teams. Starting with TeamsJS v.2.0.0, you can extend Teams apps to run in Outlook and Office. |
