...
| [Custom engine agent](/microsoft-365-copilot/extensibility/agents-overview#custom-engine-agents) | Custom engine agents are fully customized AI assistants designed for scenarios that require complex workflows, orchestration, or specific language models. [Agents](#a); [Declarative agent](#d) |
