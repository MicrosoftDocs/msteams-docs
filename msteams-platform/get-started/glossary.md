...
|[Anonymous user](../apps-in-teams-meetings/teams-apps-in-meetings.md#user-types-in-teams) |The anonymous participants are like external users but their identity isn't shown in the meeting. <br>**See also**: [Federated or external user](#f); [In-tenant user](#i); [Guest user](#g)|
