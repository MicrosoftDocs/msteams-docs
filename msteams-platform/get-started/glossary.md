...
|[appInstallDialog](../m365-apps/teamsjs-support-m365.md#appinstalldialog)|`appInstallDialog` is a TeamsJS namespace used to open a dialog for installing an application. It's supported to run across Microsoft 365.|
...
| [Authentication](../concepts/authentication/authentication.md) | The process to validate a user's identity to access your app. <br> **See also**: [Identity providers](#i); [SSO](#s); [authentication for TeamsJS library](../m365-apps/teamsjs-support-m365.md#authentication) |
...
| [Capabilities](../concepts/design/map-use-cases.md#app-capabilities-mapped-to-features)| Capabilities are the core functionalities that you can build in your app. They're also called entry or extension points because they enable integration and interaction. <br> A TeamsJS library capability is a logical grouping of functionality that is atomatically implemented by a Microsoft 365 host.<br> **See also**: [App scope](#a)|
...
|[geoLocation](../m365-apps/teamsjs-support-m365.md#geolocation)|`geoLocation` is a TeamsJS capability namespace which provides the location-related functionality. It's supported for apps that run in Microsoft 365 and Microsoft 365 web.|
...
|[secondaryBrowser](../m365-apps/teamsjs-support-m365.md#secondarybrowser)|`secondaryBrowser` is a TeamsJS library namespace supporting in-app browser experiences of the host app. |
...
|[webStorage](../m365-apps/teamsjs-support-m365.md#webstorage)|`webStorage` is a TeamsJS library namespace which contains functionality to allow web apps to store data in webview cache.|
