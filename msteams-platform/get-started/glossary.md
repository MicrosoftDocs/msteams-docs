...
| [TeamsJS library](../tabs/how-to/using-teams-client-sdk.md) | TeamsJS library enables you to create hosted experiences in Teams. Starting with TeamsJS v.2.0.0, you can extend Teams apps to run in Outlook and Office. |
