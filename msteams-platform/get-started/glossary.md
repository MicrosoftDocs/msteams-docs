...
| Term | Definition |
| --- | --- |
| [Blazor](build-first-teams-app.md) | A free and open-source web framework that enables developers to create web apps using C# and HTML. It's being developed by Microsoft. |
