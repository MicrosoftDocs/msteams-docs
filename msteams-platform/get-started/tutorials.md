...
1. Select **Open** to open the app in personal scope.
    ...
    > [!TIP]
    > Check for issues before you upload a custom app, using the [app validation tool](https://dev.teams.microsoft.com/tools/store-validation). This tool is included in the toolkit. Fix the errors to upload the app.
    </details>
