...
1. **Recommended Tools**: Choose the tools based on the language that you've selected. You can also use teh Teams Developer Portal to manage and publish your app. The Teams Toolkit allows you to build your app with JavaScript, TypeScript, or C# in Visual Studio Code (VS Code) or Visual Studio.
