...
1. Select **Create new codespace**.
   ...
   Microsoft 365 Agents Toolkit prepares the tab app project for you and opens it in VS Code in the browser. The Microsoft 365 Agents Toolkit icon appears in the activity bar of VS Code.
...
1. Select **Preview your Teams App (F5)** to build your tab app.
      ...
      :::image type="content" source="../assets/images/get-started/toolkit-in-browser.png" alt-text="Screenshot shows you the Microsoft 365 Agents Toolkit window in browser with your tab app."lightbox="../assets/images/get-started/toolkit-in-browser.png":::
...
If you want to learn how to start a project with Microsoft 365 Agents Toolkit from the beginning, you'll need to set up your development environment. Select the following button to start building your basic tab app.
