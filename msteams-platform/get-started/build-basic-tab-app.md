...
1. Select **Create new codespace**.
   ...
   Agents Toolkit prepares the tab app project for you and opens it in VS Code in the browser. The Agents Toolkit icon appears in the activity bar of VS Code.
