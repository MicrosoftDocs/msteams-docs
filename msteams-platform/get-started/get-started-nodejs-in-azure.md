...
Environment variables are used in Azure to securely hold sensitive information like app ids and passwords.
...
The values for these settings were generated by App Studio in Teams when you were setting up your app.
