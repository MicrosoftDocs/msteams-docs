...
<img title="Azure icon" src="~/assets/images/get-started/visual-studio-code-azure-sign-in.png"/>
...
<img title="Azure icon" src="~/assets/images/get-started/visual-studio-code-azure-login-web.png"/>
...
<img title="Azure icon" src="~/assets/images/get-started/visual-studio-azure-account.png"/>
