...
1. To install App Studio in Teams, select the **Apps** icon at the bottom of the left-hand bar, and search for **App Studio**:
    ...
    :::image type="content" source="~/assets/images/get-started/searchforAppStudio.png" alt-text="Screenshot shows the steps to find App Studio in the store view.":::
...
1. Select **Test and distribute**  under **Finish** in the left-hand pane of App Studio:
    ...
    :::image type="content" source="~/assets/images/get-started/Testanddistribute.png" alt-text="The screenshot shows the steps to test your app.":::
...
1. Select the **Install** button at the bottom of the dialog box.
    ...
    :::image type="content" source="~/assets/images/get-started/Finishedhelloworld.png" alt-text="The screenshot shows the apps that are available in Teams.":::
...
:::image type="content" source="~/assets/images/samples-hello-world-tab-configure.png" alt-text="The screenshot shows the configured app.":::
