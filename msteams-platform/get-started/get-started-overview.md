...
:::image type="content" source="../assets/images/get-started/gs-build-options.png" alt-text="The screenshot descibes the basic steps to build and deploy a Teams app.":::
