...
:::image type="content" border="false" source="assets/images/overview/app-manifest.png" alt-text="Diagram shows the configuration of properties in the Teams app manifest." lightbox="assets/images/overview/app-manifest.png":::
