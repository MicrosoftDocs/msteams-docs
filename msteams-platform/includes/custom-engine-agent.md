...
> ### Add support for Microsoft 365 Copilot Chat in your custom engine agent
   ...
   >
   > 2. Perform step 1. to step 4. from [create your custom engine agent](../bots/how-to/teams-conversational-ai/teams-ai-library-tutorial.md#create-your-custom-engine-agent) and ensure you select the **Basic AI Chatbot Works in Teams and Microsoft 365 Copilot** for step 5. in Agents Toolkit. Continue with the rest of steps (step 6. to step 11.) to create your custom engine agent.<br>
   ...
   > 3. [Configure your custom engine agent](../bots/how-to/teams-conversational-ai/teams-ai-library-tutorial.md#configure-and-debug-your-custom-engine-agent). Ensure you perform the following steps before you debug:
