...
description: With this learning module, learn about Teams samples for Agents SDK, which includes working samples demonstrating the functionality.
...
For complete working samples demonstrating the functionality, see the following Teams samples for Agents SDK:
