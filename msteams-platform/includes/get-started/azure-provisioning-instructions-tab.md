...
1. Select a subscription to use for the Azure resources.
   ...
   >
   >For more information, see [Create resource group](docs.microsoft.com/azure/azure-resource-manager/management/manage-resource-groups-portal?branch=pr-en-us-6602#create-resource-groups).
