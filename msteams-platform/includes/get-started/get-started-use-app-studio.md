...
1. To install App Studio in Teams, select the **Apps** icon at the bottom of the left-hand bar, and search for **App Studio**:
    ...
    :::image type="content" source="~/assets/images/get-started/searchforAppStudio.png" alt-text="The screenshot describes how to find app studio in the store view.":::

1. Select the **App Studio** tile and choose **Install**. The App Studio is installed:

    :::image type="content" source="~/assets/images/get-started/InstallingAppStudio.png" alt-text="The screenshot describes how to install app studio.":::

1. To create the app package for your Teams app, select the **Manifest editor** tab in **App Studio**:

    :::image type="content" source="~/assets/images/get-started/AppStudio.png" alt-text="The screenshot describes how to select manifest editor to create app package.":::
...
1. Select the **Hello World** tile for your newly imported app:
    ...
    :::image type="content" source="~/assets/images/get-started/HelloWorldappdetails.png" alt-text="The screenshot is an example that shows the newly imported app view.":::
...
:::image type="content" source="~/assets/images/get-started/TeamTab.png" alt-text="The screenshot describes how to add a Teams tab.":::
...
:::image type="content" source="~/assets/images/get-started/PersonalTab.png" alt-text="The screenshot describes how to add a personal tab dialog box.":::
...
:::image type="content" source="~/assets/images/get-started/Bots.png" alt-text="The screenshot describes how to add a bot.":::
...
1. Select **Setup** to display the **Set up a bot** dialog box.
    ...
    :::image type="content" source="~/assets/images/get-started/Setupbot.png" alt-text="The screenshot describes how to add a bot dialog box.":::
...
1. Select **Message extensions** under **Capabilities** in the left-hand pane of App Studio to configure the message extension:
    ...
    :::image type="content" source="~/assets/images/get-started/Messagingextensions.png" alt-text="The screenshot describes how to add a message extension.":::
...
1. To upload your app to Teams, select the **Install** button under **Test and Distribute**:
    ...
    :::image type="content" source="~/assets/images/get-started/InstallingHelloWorld.png" alt-text="The screenshot describes how to add a message extension dialog box.":::
...
1. Select the **Install** button at the bottom of the dialog box.
    ...
    :::image type="content" source="~/assets/images/get-started/Finishedhelloworld.png" alt-text="The screenshot is an example that show the finished app available in Teams.":::
