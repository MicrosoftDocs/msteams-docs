...
1. To upload your app to Teams, select the **Install** button under **Test and Distribute**:
    ...
    > [!NOTE]
    > If you are unable to sideload the app, verify whether you have [enabled custom app uploading](~/get-started/get-started-dotnet-app-studio.md#prepare-your-development-environment).
