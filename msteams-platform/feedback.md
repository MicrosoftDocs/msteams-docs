...
Use the support channels listed in this article to report issues, ask questions, or share feedback related to the Microsoft Teams developer platform, Microsoft 365 Copilot agents, and feature requests. Choose the option that best fits your need:

* [Product support and service issues](#product-support-and-service-issues)
* [Developer community forums](#developer-community-forums)
* [Report issues](#report-issues)
* [Documentation feedback](#documentation-feedback)
* [Feature request and general help](#feature-request-and-general-help)
...
|:::image type="icon" source="assets/icons/stack-overflow-icon.png"::: [Stack Overflow](https://stackoverflow.com/questions/tagged/microsoft-teams)| Post your questions using the `microsoft-teams` tag. Explore and ask questions using the [microsoft-copilot](https://stackoverflow.com/questions/tagged/microsoft-copilot) and [microsoft-copilot-studio](https://stackoverflow.com/questions/tagged/microsoft-copilot-studio) tags. Write a clear title, describe the problem, and include steps to reproduce the issue. Off‑topic or feature‑request questions aren’t allowed. For more information, see [Stack Overflow Help Center](https://stackoverflow.com/help).|
