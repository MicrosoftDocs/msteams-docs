...
| **Partner Center support** | For issues related to Partner Center (for example, app submissions, account setup, publishing workflows), use the [Partner Center AI Assistant](https://learn.microsoft.com/en-us/partner-center/support/report-problems-with-partner-center#contact-support-using-partner-center-ai-assistant) to report problems or contact support. |
