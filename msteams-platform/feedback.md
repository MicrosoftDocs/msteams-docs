...
|:--------------------|:--------------------|
| :::image type="icon" source="assets/icons/microsoft-icon.png"::: [Microsoft Q & A](https://learn.microsoft.com/answers/tags/339/office-teams-development-routing?orderby=createdat)| Use this forum to ask questions and connect with other developers for building Teams agents, apps, or workflows using developer tools and APIs. Go to **Ask a question**, and add the `Microsoft Teams` tag to your question. You can also **Sign in to follow** to stay updated. |
...
Share feature ideas, ask questions, or talk to us about your experience with the Teams developer platform.
