...
| - | - | - |
| 09/26/2018 | The "Task modules" capability was released to Developer Preview. | [Task modules overview](~/concepts/task-modules/task-modules-overview) |
| 09/24/2018 | Calls and online meetings APIs for Microsoft Graph were released to beta, and you can now create bots that use them. | [Calls and online meetings overview](~/concepts/calls-and-meetings/calls-meetings-bots-overview) |
