...
| --- | --- | --- |
|03/28/2022| Introduced step-by-step guide to implement meeting side panel in Teams | Build apps for Teams meeting > Enable and configure apps for meetings > [Meeting Side Panel](sbs-meetings-sidepanel.yml)|
