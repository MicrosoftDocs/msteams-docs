...
| --- | --- | --- |
|03/16/2022| Added information on debug process| Tools and SDKs> Teams Toolkit for Visual Studio Code > [Debug your Teams app using Teams Toolkit](toolkit/debug%20local.md) > [Debug background process](toolkit/debug%20background%20process.md)|
