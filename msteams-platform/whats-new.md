...
| **Date** | **Update** | **Find here** |
| -------- | --------- | ----------------|
|07/20/2022| Introduces receiving meeting start and end event in channel meetings |Build apps for Teams meetings and calls > [Meeting apps API references](apps-in-teams-meetings/API-references.md)|
