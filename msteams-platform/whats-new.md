...
| --- | --- | --- |
|03/18/2022| Introduced step-by-step guide to invoke link unfurling in Teams using bot | Build messaging extensions > Add link unfurling > [Teams link unfurling using bot](sbs-botbuilder-linkunfurling.yml)|
