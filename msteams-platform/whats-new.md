...
* ***November 19, 2024***: Terminology update. **Copilot agent** is referred to as **agent**.
...
| 16/09/2024 | Explore the development guidance to build agents. | Build message extensions > Bot Framework > Search commands > [Guidelines to create and upgrade agents](messaging-extensions/dev-guidelines-copilot-agents.md) |
