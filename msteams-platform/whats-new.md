...
| 13/12/2024 | Learn to extend bot-based message extension as an agent for Microsoft 365 Copilot. | Build message extensions > Build message extensions using Microsoft 365 Agents SDK > Search commands > [Extend bot-based message extension as agent](messaging-extensions/build-bot-based-agent.md) |
...
|25/01/2024|Use Micro-capability templates to show rich unfurl previews of your links without installing your app in Microsoft Teams.|Build message extension > Build message extensions using Microsoft 365 Agents SDK > [Micro-capabilities for website links](messaging-extensions/how-to/micro-capabilities-for-website-links.md)|
...
|19/01/2024|Use / to invoke message extensions from command box in the new Teams client.|Build message extension > [Build message extensions using Agents SDK](messaging-extensions/build-bot-based-message-extension.md)|
...
|03/18/2021| Notice: Update to version 4.10 or above of the Microsoft 365 Agents SDK, as we've started with the deprecation process for `TeamsInfo.getMembers` and `TeamsInfo.GetMembersAsync`. | Build bots > [Bot API Changes for Team/Chat Members](resources/team-chat-member-api-changes.md) |
...
| 10/31/2019 | Conversational bots and message extension documentation updated to reflect the 4.6 Microsoft 365 Agents SDK. Documentation for the v3 SDK is available in the Resources section. | All bot and message extension documentation |
...
| 16/09/2024 | Explore the development guidance to build agents. | Build message extensions > Microsoft 365 Agents SDK > Search commands > [Guidelines to create and upgrade agents](messaging-extensions/dev-guidelines-agents.md) |
...
| 23/05/2024 | Enhance your Copilot message extension agent to hand off a conversation to your custom engine agent.| Build message extensions > Build message extensions using Microsoft 365 Agents SDK > Search commands > [Copilot handoff](bots/how-to/conversations/bot-copilot-handoff.md)|
