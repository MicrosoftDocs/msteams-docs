...
| --- | --- | --- |
|02/07/2022| Introduced step-by-step guide to build a search-based messaging extension | Build messaging extensions > Search commands > Define search commands > [Teams messaging extensions search](sbs-messagingextension-searchcommand.yml)|
