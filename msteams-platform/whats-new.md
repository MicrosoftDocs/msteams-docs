...
| -------- | --------- | ------------------ |
|03/12/2021|Notice: We've started with the deprecation process for `TeamsInfo.getMembers` and `TeamsInfo.GetMembersAsync`. Please update your apps to the lastest Bot Framework SDK and new paginated APIs. | [Bot API Changes for Team/Chat Members](resources/team-chat-member-api-changes.md) |
