...
| 05/28/2018 | The Teams developer preview (ring 3.6) has been updated to include the ability to add bots and tabs to group chat. | [Features in the developer preview](~/resources/dev-preview/developer-preview-features), [Features in the developer preview](~/resources/schema/manifest-schema-dev-preview)|
