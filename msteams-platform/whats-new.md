...
| --- | --- | --- |
| 05/24/2022 | Teams Toolkit is now GA | Tools and SDKs > Teams Toolkit for Visual Studio Code > [Teams Toolkit Overview](toolkit/teams-toolkit-fundamentals.md) <br> •  Tools and SDKs > Teams Toolkit for Visual Studio Code > [Preview and customize Teams app manifest](toolkit/TeamsFx-preview-and-customize-app-manifest.md) <br> • Tools and SDKs > Teams Toolkit for Visual Studio Code > [Connect to existing APIs](toolkit/add-API-connection.md) <br> •  Tools and SDKs > Teams Toolkit for Visual Studio Code > [Add capabilities to your Teams apps](toolkit/add-capability.md) <br> •  Tools and SDKs > Teams Toolkit for Visual Studio Code > [Add single sign-on experience](toolkit/add-single-sign-on.md) <br> •  Tools and SDKs > Teams Toolkit for Visual Studio Code > [Add cloud resources to Teams app](toolkit/add-resource.md) <br> •  Tools and SDKs > Teams Toolkit for Visual Studio Code > Tools and SDKs > Teams Toolkit for Visual Studio Code > [Step-by-step guide to build command bot with JavaScript](toolkit/add-capability.md) <br> •  Tools and SDKs > Teams Toolkit for Visual Studio Code > Tools and SDKs > Teams Toolkit for Visual Studio Code > [Step-by-step guide to build notification bot with JavaScript](toolkit/add-capability.md) |
