...
| **Date** | **Update** | **Find here** |
| -------- | --------- | ----------------|
| 06/15/2022 | Meeting apps for one-on-one calls, group calls, and meet now|Build apps for Teams meetings > [Overview](~/apps-in-teams-meetings/teams-apps-in-meetings.md)|
