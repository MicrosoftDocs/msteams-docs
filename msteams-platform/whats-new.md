...
| **Date** | **Notes** | **Changed topics** |
| -------- | --------- | ------------------ |
|20/05/2021| Teams Developer Portal introduced to easily register, configure, and manage your Teams apps. | [Teams Developer Portal](concepts/build-and-test/teams-developer-portal.md) |
