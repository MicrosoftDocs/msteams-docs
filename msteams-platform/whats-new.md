...
| **Date** | **Notes** | **Changed topics** |
| -------- | --------- | ------------------ |
|07/15/2021|Added Shared channels in Get context for your tab.|[Get context for your tab](tabs/how-to/access-teams-context.md), [Build tabs - Overview](tabs/what-are-tabs.md) |
