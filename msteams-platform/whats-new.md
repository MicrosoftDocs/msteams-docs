...
| --- | --- | --- |
|12/13/2021 | Introduced guidelines for app linked to SaaS offer | • Distribute your app > Publish to the Teams store > Review store validation guidelines > [Guidelines for app linked to SaaS offer](concepts/deploy-and-publish/appsource/prepare/personal/teams-store-validation-guidelines.md)
