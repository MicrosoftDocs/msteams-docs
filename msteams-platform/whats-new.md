...
| **Date** | **Update** | **Find here** |
| -------- | --------- | ----------------|
| 21/11/2025 | Use the Performance Report tool to evaluate the efficiency of your web and tab apps on mobile. | [Calculate performance metrics for apps](resources/teams-mobile-best-practices.md)
| 19/11/2025 | Create and manage agent identities for your agent. | [Agent Identity Blueprint](concepts/build-and-test/manage-your-apps-in-developer-portal.md)
