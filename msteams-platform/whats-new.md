...
| **Date** | **Update** | **Find here** |
| -------- | --------- | ------------------ |
| 06/17/2022 | Apps for instant meetings, one-on-one and group calls| Build apps for Teams meetings and calls > [Overview](apps-in-teams-meetings/teams-apps-in-meetings.md)|
