...
* ***December 11, 2024***: [Introducing multi parameters for API-based message extensions which allows more than one input type for query command](messaging-extensions/create-api-message-extension.md#multi-parameters).
