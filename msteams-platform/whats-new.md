...
> [!IMPORTANT]
> You can now get latest Teams updates by subscribing to [RSS feed](/microsoftteams/platform/feed.atom). For more information, see [configure RSS feed](#get-latest-updates).
