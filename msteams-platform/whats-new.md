...
| --- | --- | --- |
|22/11/2021|Overflow menu on Adaptive Cards|Build cards and task modules > Build cards >[Formatting cards in Microsoft Teams](msteams-platform\task-modules-and-cards\cards\cards-format.md)|
