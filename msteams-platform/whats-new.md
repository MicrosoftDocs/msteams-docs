...
| -------- | --------- | ------------------ |
| 07/01/2020 |Get started building apps with the Teams Visual Studio Code Toolkit.|[Build apps with the Microsoft Teams Toolkit and Visual Studio Code](toolkit/visual-studio-code-overview.md) |
