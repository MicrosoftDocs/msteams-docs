...
| --- | --- | --- |
|12/28/2021| Introduced step-by-step guide to do Teams file upload bot | Build bots > Send and receive files > [step-by-step guide to grant Teams file upload bot](sbs-file-handling-in-bot.yml) |
