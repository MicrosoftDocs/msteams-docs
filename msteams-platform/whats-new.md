...
* ***September 30, 2024***: [Create visually appealing Adaptive Cards with borders and rounded corners to Adaptive Card elements.](task-modules-and-cards/cards/cards-format.md#borders-and-rounded-corners-in-adaptive-cards)
