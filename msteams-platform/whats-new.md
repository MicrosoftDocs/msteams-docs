...
* ***June 22, 2023***: [App caching for iOS personal tray](tabs/how-to/app-caching.md)
...
|01/30/2023| Enable app caching to improve subsequent launch time of the apps to the meeting side panel.|Build apps for Teams meetings and calls > Enable and configure apps for meetings > [Enable app caching for your tab app](tabs/how-to/app-caching.md) |
