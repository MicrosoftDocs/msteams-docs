...
| -------- | --------- | ------------------ |
| 11/09/2018 | Getting started for Node JS and for .NET/C# has been updated to use App Studio in Teams, and a new section has been added on hosting Node based Teams apps in Azure. | [Get started on the Microsoft Teams platform with C#/.NET and App Studio](~/concepts/getting-started/get-started-dotnet-app-studio),  [Get started on the Microsoft Teams platform with Node JS and App Studio](~/concepts/getting-started/get-started-nodejs-app-studio), [Host your Node Teams app in Azure](~/concepts/getting-started/get-started-nodejs-in-azure)|
