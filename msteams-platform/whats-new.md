...
| **Date** | **Notes** | **Changed topics** |
| -------- | --------- | ------------------ |
|10/28/2021|Interactive mode for shared meeting stage|[Shared meeting stage](apps-in-teams-meetings/enable-and-configure-your-app-for-teams-meetings.md#shared-meeting-stage), [Teams client SDK APIs](apps-in-teams-meetings/API-references.md#teams-client-sdk-apis)|
