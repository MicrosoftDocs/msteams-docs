...
| --- | --- | --- |
|04/11/2022| Introduced step-by-step guide to send message using activity feed notification| Design apps > UI components > Activity feed notification > [Send message using activity feed notification](sbs-graphactivity-feedbroadcast.yml)
