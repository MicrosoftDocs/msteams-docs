...
| --- | --- | --- |
|03/25/2022| Introduced step-by-step guide to upload a file in Teams using bot | Bot conversations > Send and receive files > [Upload files in Teams using bot](sbs-file-handling-in-bot.yml)
