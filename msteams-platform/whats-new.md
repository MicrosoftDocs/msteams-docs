...
| **Date** | **Update** | **Find here** |
| -------- | --------- | ----------------|
| 06/08/2022 | Introduced step by step guide to send activity notifications | Design your app > UI components> Activity feed notifications > [Send activity feed notification](sbs-graphactivity-feedbroadcast.yml) |
