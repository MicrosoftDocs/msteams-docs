...
* ***August 02, 2024***: The Collaboration controls for model-driven applications **are** retired. We recommend removing the Collaboration controls and Collaboration connector from all Power Apps solutions.
