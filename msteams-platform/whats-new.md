...
# What's new for developers in Microsoft Teams [<img src="~/assets/images/bots/sequentialWorkflow.gif" alt="Sequential Workflow" width="40"/>](https://aka.ms/TeamsPlatformUpdates)
...
You can get latest Teams platform updates by configuring [RSS feed](/microsoftteams/platform/feed.atom).
