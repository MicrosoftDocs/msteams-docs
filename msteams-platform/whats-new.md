...
| **Date** | **Update** | **Find here** |
| -------- | --------- | ----------------|
| 08/09/2022 | Introduce Teams Toolkit for Visual Studio | Tools and SDK > Teams Toolkit for Visual Studio > [Teams Toolkit for Visual Studio](toolkit/teams-toolkit-overview-visual-studio.md) |
