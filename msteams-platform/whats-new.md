...
| --- | --- | --- |
|02/25/2022 | Introduced how to add authentication using external OAuth provider| Add authentication > Tabs > [Authentication using external OAuth providers](tabs/how-to/authentication/auth-oauth-provider.md) |
