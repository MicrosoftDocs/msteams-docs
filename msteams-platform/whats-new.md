...
| **Date** | **Update** | **Find here** |
| -------- | --------- | ----------------|
| 06/03/2022 | Updated Add authentication module for enabling SSO for tab app with new structure and procedures | Add authentication > Tabs > Enable SSO for tab apps |
