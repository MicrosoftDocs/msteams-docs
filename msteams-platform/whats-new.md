...
| -------- | --------- | ------------------ |
|08/19/2021| Installation update event | [Installation update event](bots/how-to/conversations/subscribe-to-conversation-events?tabs=dotnet#installation-update-event) |
