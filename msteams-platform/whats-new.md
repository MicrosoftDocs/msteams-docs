...
* ***October 21, 2024***: [Update bot or message extension app to use certificate or MSI for authentication](toolkit/update-bot-me-app-to-use-certificate-or-msi-for-authentication.md).
