...
|10/05/2021| Hide Teams app until Admin allows to un-hide the app | Design your app > [Hide Teams app from users](concepts/design/enable-app-customization.md#hide-teams-app-from-users) |
