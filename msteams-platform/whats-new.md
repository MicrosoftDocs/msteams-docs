...
| **Date** | **Notes** | **Changed topics** |
| -------- | --------- | ------------------ |
|10/29/2021|Interactive mode for shared meeting stage|[Shared meeting stage](apps-in-teams-meetings/enable-and-configure-your-app-for-teams-meetings.md#shared-meeting-stage), [Meeting apps API references](apps-in-teams-meetings/API-references.md)|
