...
| **Date** | **Update** | **Find here** |
| -------- | --------- | ----------------|
| 09/14/2022 | Updated the status code responses for messages in bot conversations | Build bots > Bot conversations > Message in bot conversations > Message in bot conversations > [Status code responses](bots/how-to/conversations/conversation-messages.md#status-codes-from-bot-apis) |
