...
| --- | --- | --- |
|02/11/2022| Introduced step-by-step guide to create and test a connector in Microsoft Teams. | Build webhooks and connectors > Create Office 365 Connectors > [Microsoft Teams Connectors](sbs-teams-connectors.yml)|
