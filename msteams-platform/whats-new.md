...
Discover announcements for the Microsoft Teams platform, including features that are generally available (GA) or in developer preview, and features that are deprecated. You can get the latest Teams platform updates by subscribing to the [RSS feed](https://aka.ms/TeamsPlatformUpdates). For more information, see [configure RSS feed](#get-latest-updates).

<!-- markdownlint-disable MD036 -->

## Teams SDK for .NET 2.1.0 is generally available
...
## Teams SDK for TypeScript 2.1.0 preview and 2.0 maintenance releases
...
## Teams SDK for Python 2.1.0 alpha preview and 2.0 maintenance release
...
## Developer Portal Environment Variables feature is being deprecated

*August 4, 2026*

The Environment Variables feature in Developer Portal is being deprecated as of August 31, 2026. Create a separate app for each environment instead. For more information, see [Manage your apps in Developer Portal](concepts/build-and-test/manage-your-apps-in-developer-portal.md#advanced).

## Meeting transcript access is now governed by Graph permissions and tenant admin controls

*July 30, 2026*

Access to meeting transcripts governed by both Microsoft Graph permissions and tenant-level administrator controls is now generally available. For more information, see [Graph API access to transcripts and recordings](graph-api/meeting-transcripts/overview-transcripts.md#configure-permissions-on-microsoft-entra-id-to-access-transcript-and-recording).

## Sending targeted messages in group conversations is generally available

*July 30, 2026*

Sending targeted messages in group conversations is generally available. For more information, see [Targeted messages](agents-in-teams/targeted-messages.md).

## Receiving targeted messages in group conversations is generally available

*July 29, 2026*

Receiving targeted messages in group conversations is generally available. For more information, see [Targeted messages](agents-in-teams/targeted-messages.md).

## Emoji chat reactions for agents are generally available

*July 10, 2026*

Emoji chat reactions for agents is now generally available. For more information, see [Emoji reactions](agents-in-teams/agent-reactions.md).

## Support for apps in private channels is generally available

*July 7, 2026*

Support for apps in private channels is now generally available. For more information, see [Shared and private channels](build-apps-for-shared-private-channels.md).

## Meeting transcript access controls available in developer preview

*June 30, 2026*

Access to meeting transcripts through Microsoft Graph is now governed by both Graph permissions and two tenant-level administrator controls, available in developer preview. Apps must have the required permissions, and tenant admins must enable transcript access settings before transcript data can be retrieved. For more information, see [Graph API access to transcripts and recordings](graph-api/meeting-transcripts/overview-transcripts.md#configure-permissions-on-microsoft-entra-id-to-access-transcript-and-recording).

## Together Mode is being deprecated
...
## Slash commands for agents and apps available in developer preview
...
## Agent reactions in Teams available in developer preview

*May 15, 2026*

Agent reactions in Teams are available in developer preview. For more information, see [Enable agent reactions in Teams](agents-in-teams/agent-reactions.md).

## Prompt starters are generally available
...
## Targeted messages for agents available in developer preview

*March 27, 2026*

Targeted messages for agents are available in developer preview. For more information, see [Enable targeted messages for agents](agents-in-teams/targeted-messages.md).

## Older posts

Explore previous announcements, listed by year.
...
| 19/11/2025 | Register MCP Servers as agent connectors. | Extend agent or app across Microsoft 365 > [Connect MCP servers to agents](m365-apps/agent-connectors.md) |
...
| 18/09/2025 | Teams AI library v1 is deprecated. We recommend that you upgrade your agents to use the updated [Teams AI library](/microsoftteams/platform/teams-ai-library/welcome). | |
...
| 10/04/2025 | Introducing custom engine agents support for Microsoft 365 Copilot Chat (developer preview). | Build bots and agents > Teams AI library v1 > [Build with Teams AI library](bots/how-to/teams-conversational-ai/how-conversation-ai-get-started.md#add-support-for-microsoft-365-copilot-chat) |
...
| 17/03/2025 | Precache your tab app to optimize its initial load time (developer preview). | Build tabs > Tab features > [App caching for your tab app](tabs/how-to/app-caching.md#precaching-tab-apps) |
| 07/03/2025 | Introducing app manifest v1.20 with elementRelationshipSet, requirementSet, and intuneInfo properties. | App manifest > [App manifest](/microsoft-365/extensibility/schema/) |
...
| 19/02/2025 | Introducing stop stream generation button for streaming bot messages (developer preview). | Build bots > Bot user experience > [Stream bot messages](bots/streaming-ux.md) |
...
| 03/02/2025 | Create personal scope apps that integrate seamlessly with Public Switched Telephone Network (PSTN) and Teams-to-Teams calls (developer preview). | Build apps for Teams meetings and calls > Enable and configure apps for Teams meeting > [Build tabs for meeting](apps-in-teams-meetings/build-tabs-for-meeting.md) |
...
| 19/11/2024 | Introduced optional `abbreviated` property for app display name on the app bar (developer preview). | App manifest > Public developer preview > Public developer preview app manifest > [name](/microsoft-365/extensibility/schema/root-name) |
...
| 18/11/2024 | Stream bot messages to deliver the bot's response to users in real-time (developer preview). | Build bots > Build custom engine agent > [Stream bot messages](bots/streaming-ux.md) |
...
| 17/10/2024 | Specify runtime requirements in app manifest to tailor your app's behavior in Microsoft 365 hosts (developer preview). | [Extend your app across Microsoft 365 > Specify Microsoft 365 host runtime requirements in app manifest](m365-apps/specify-runtime-requirements.md) |
| 17/10/2024 | `copilotExtensions` is renamed to `copilotAgents` in the developer preview app manifest. | App manifest > Public developer preview app manifest > [copilotAgents](/microsoft-365/extensibility/schema/root-copilot-agents) |
| 16/09/2024 | Learn about requirements for the validation of your agent to increase its chances of being listed on Teams Store (developer preview). | Publish to the Teams Store > [Validation guidelines for agents](concepts/deploy-and-publish/appsource/prepare/review-copilot-validation-guidelines.md) |
| 16/09/2024 | Explore the development guidance to build agents (developer preview). | Build message extensions > Bot Framework > Search commands > [Guidelines to create and upgrade agents](messaging-extensions/dev-guidelines-agents.md) |
...
| 03/09/2024 | Introduced nested app authentication for single-page applications that are embedded in host environment (developer preview). | Add authentication > [Enable nested app authentication](concepts/authentication/nested-authentication.md) |
...
| 14/06/2024 | Introduced preapproval of RSC permissions for admins to control RSC permissions for app installation (developer preview). | Utilize Teams data with Microsoft Graph > Resource-specific consent > [Preapproval of RSC permissions](graph-api/rsc/preapproval-instruction-docs.md) |
...
| 23/05/2024 | Leverage AI label, citations, feedback buttons, and sensitivity labels in your bot's messages (developer preview). | Build bots > Bot conversations > [Format AI bot messages](bots/how-to/format-ai-bot-messages.md) |
| 23/05/2024 | Enhance your Copilot message extension agent to hand off a conversation to your custom engine agent (developer preview). | Build message extensions > Build message extensions using Bot Framework > Search commands > [Copilot handoff](bots/how-to/conversations/bot-copilot-handoff.md) |
...
| 14/05/2024 | Introduced a new manifest property to let potential customers contact you with queries before they can confidently adopt your app (developer preview). | App manifest > [Public developer preview](/microsoft-365/extensibility/schema/root-developer-contact-info) |
| 07/05/2024 | You can specify a 32x32 color icon with a transparent background to ensure a consistent appearance when your app runs in Outlook and Microsoft 365 (developer preview). | Publish your app > [32x32 color icon](concepts/build-and-test/apps-package.md#app-icons) |
...
| 12/04/2024 | Introducing app manifest v1.17 with semanticDescription, samplePrompts, and dashboardCards. | [App manifest](/microsoft-365/extensibility/schema/#all-generally-available-versions) |
| 12/04/2024 | Outlook extensions specifies Outlook Add-ins within an app manifest and simplify the distribution and acquisition across the Microsoft 365 ecosystem. | App manifest > [extensions.requirements](/microsoft-365/extensibility/schema/requirements-extension-element) |
...
| 15/03/2024 | Extend static tabs to channels with a customizable experience (developer preview). | [Build tabs for Teams](tabs/what-are-tabs.md) |
...
| 12/02/2024 | Build API-based message extension using Developer Portal for Teams (developer preview). | Build message extension > [Build API-based message extension](messaging-extensions/build-api-based-message-extension.md) |
| 06/02/2024 | Introduced `systemDefault` reserved activity type for send activity feed notifications (developer preview). | Build tabs > [Send activity feed notifications](tabs/send-activity-feed-notification.md#requirements-to-use-the-activity-feed-notification-apis) |
...
| 12/01/2024 | Introduced Teams Toolkit command line interface v3 (developer preview). | Tools and SDKs > Tools > [Teams Toolkit command line interface](toolkit/teams-toolkit-CLI.md) |
...
| 27/11/2023 | Extend an action-based Teams message extension across Microsoft 365 (developer preview). | Extend your app across Microsoft 365 > [Extend m365 teams message extension](~/m365-apps/extend-m365-teams-message-extension.md) |
...
| 28/09/2023 | Configure your bot during installation or after installation from the team or group chat where the bot is installed (developer preview). | Build bots > [Bot configuration experience](bots/how-to/bot-configuration-experience.md) |
...
| 26/09/2023 | Use media elements such as audio or video clips to your Adaptive Card for enhanced media experience and user engagement. | Build cards and task modules > Build cards > [Media elements in Adaptive Card](task-modules-and-cards/media-elements-in-adaptive-cards.md) |
...
| 31/08/2023 | The new Teams client supports light theme for apps in Teams meetings (developer preview). | Build tabs > [Get context for your tab](tabs/how-to/access-teams-context.md#handle-theme-change) |
...
| 28/08/2023 | Teams app manifest is now referred to as app manifest. | App manifest > [Overview](/microsoft-365/extensibility/schema/) |
| 21/08/2023 | Introduced the new Microsoft Teams client to provide better experience for your apps and users (developer preview). | Resources > [Introducing the new Microsoft Teams client](resources/teams-updates.md) |
| 21/08/2023 | Use Adaptive Card-based Loop components to build collaborative experiences within Teams message extensions that work across Microsoft 365 (developer preview). | Extend your app across Microsoft 365 > [Adaptive Card-based Loop components](m365-apps/design-loop-components.md) |
...
| 08/08/2023 | Use callRecording API to fetch meeting recording from all meetings (developer preview). | Build apps for Teams meetings and calls > [Get meeting transcripts and recordings using Graph APIs](graph-api/meeting-transcripts/overview-transcripts.md) |
...
| 13/07/2023 | Extend static tabs to group chat or meetings with a customizable experience (developer preview). | Build tabs > [Overview](tabs/what-are-tabs.md) |
...
| 23/05/2023 | Teams AI library helps you build AI-powered Teams apps (developer preview). | Build Bots > [Teams AI library](bots/how-to/teams-conversational-ai/teams-conversation-ai-overview.md) |
| 23/05/2023 | Extend Microsoft 365 Copilot to integrate with Microsoft Teams apps to turn your app into the most powerful productivity tool (developer preview). | [Extend Microsoft 365 Copilot](messaging-extensions/how-to-extend-copilot.md) |
...
| 31/01/2023 | Send notifications to specific participants on a meeting stage with targeted in-meeting notification (developer preview). | Build apps for Teams meetings and calls > Enable and configure apps for meetings > Build in-meeting notification for Teams meeting > Build tabs for meeting > [Targeted in-meeting notification](apps-in-teams-meetings/in-meeting-notification-for-meeting.md#targeted-in-meeting-notification) |
| 30/01/2023 | Enable app caching to improve subsequent launch time of the apps to the meeting side panel (developer preview). | Build tabs > [App caching for your tab app](tabs/how-to/app-caching.md) |
...
| 05/12/2022 | Use share in meeting to share any document or third-party app to the meeting stage (developer preview). | Build apps for Teams meetings and calls > Enable and configure apps for meetings > [Share in meeting](concepts/build-and-test/share-in-meeting.md) |
...
| 19/10/2022 | Developer Portal for Teams is now available for GCC tenants. | Tools and SDKs > Developer Portal for Teams > [Overview](concepts/build-and-test/teams-developer-portal.md) |
| 13/10/2022 | Configure NavBar and create an overflow menu for multiple actions. | Design your app > App capabilities > [Personal apps](concepts/design/personal-apps.md#configure-and-add-multiple-actions-in-navbar) |
| 13/10/2022 | Configure back button of an app. | Design your app > App capabilities > [Personal apps](concepts/design/personal-apps.md#configure-back-button) |
| 12/10/2022 | Apps are supported in instant meetings, one-on-one, and group calls. | Build apps for Teams meetings and calls > [Overview](apps-in-teams-meetings/teams-apps-in-meetings.md) |
| 12/10/2022 | Live Share canvas. | Build apps for Teams meetings and calls > Enhanced collaboration with Live Share > [Canvas](apps-in-teams-meetings/teams-live-share-canvas.md) |
...
| 23/09/2022 | Use apps in Teams meetings scheduled through public channels (developer preview). | Build apps for Teams meetings and calls > [Apps for Teams meetings and calls](apps-in-teams-meetings/teams-apps-in-meetings.md) |
...
| 23/08/2022 | Share apps to the Teams meeting stage in mobile (developer preview). | Build apps for Teams meetings and calls > [Enable and configure apps for meetings](apps-in-teams-meetings/teams-apps-in-meetings.md) |
| 09/08/2022 | Introduced Teams Toolkit for Visual Studio 2022. | Tools and SDK > Teams Toolkit for Visual Studio > [Teams Toolkit overview for Visual Studio](toolkit/agents-toolkit-fundamentals.md) |
| 03/08/2022 | Share to Teams from personal app or tab. | Integrate with Teams > Share to Teams > [Share to Teams from personal app or tab](concepts/build-and-test/share-to-teams-from-personal-app-or-tab.md) |
| 03/08/2022 | Added feature for retrieving meeting transcripts in the post-meeting scenario. | Build apps for Teams meetings and calls > Get meeting transcripts using Graph APIs > [Overview](graph-api/meeting-transcripts/overview-transcripts.md) |
| 03/08/2022 | Link unfurling for share to teams from web apps. | Integrate with Teams > Share to Teams > [Share to Teams from web apps](concepts/build-and-test/share-to-teams-from-web-apps.md) |
| 03/08/2022 | Use toggle incoming audio API to toggle the incoming audio state setting for the user in Teams meeting stage from mute to unmute or vice-versa (developer preview). | Build apps for Teams meetings and calls > [Meeting apps API references](/microsoftteams/platform/apps-in-teams-meetings/api-references?tabs=dotnet) |
| 02/08/2022 | Use Collaboration controls to build custom collaborative experiences and integrate with Microsoft 365 services (developer preview). | Integrate with Teams > [Collaboration controls](samples/collaboration-control.md) |
...
| 08/07/2022 | Updates to send channel ID selected by user during app installation to bots via conversation and installation update events. | Build bots > Bot conversations > Conversation events in your Teams bot > [Conversation events in your Teams bot](bots/how-to/conversations/subscribe-to-conversation-events.md) |
| 16/06/2022 | Updated media capabilities to support desktop and mobile. | Integrate device capabilities > [Integrate media capabilities](concepts/device-capabilities/media-capabilities.md) |
| 08/06/2022 | Server handlers for card actions. | Build cards and task modules > Build cards > [Server handlers](task-modules-and-cards/cards/cards-actions.md#server-handlers) |
| 03/06/2022 | Updated Add authentication module for enabling SSO for tab app with new structure and procedures. | Add authentication > Tabs > [Enable single sign-on in a tab app](tabs/how-to/authentication/tab-sso-overview.md) |
| 24/05/2022 | Additional tips for rapid approval to publish your app linked to a SaaS offer. | Publish to the Teams Store > Overview > [Additional tips for rapid approval to publish your app linked to a SaaS offer](~/concepts/deploy-and-publish/appsource/publish.md#additional-tips-for-rapid-approval-to-publish-your-app-linked-to-a-saas-offer) |
| 24/05/2022 | Submit your Outlook- and Office-enabled apps to the Teams Store. | Extend your app across Microsoft 365 > [Overview](m365-apps/overview.md) |
| 24/05/2022 | App guidance and what's new in TeamsJS version 2.0.0. | Tools and SDKs > [Teams JavaScript client SDK](tabs/how-to/using-teams-client-library.md) |
| 24/05/2022 | Introduced app manifest version 1.13. | App manifest > [Manifest schema for Microsoft Teams](/microsoft-365/extensibility/schema/#all-generally-available-versions) |
| 24/05/2022 | Bots and Message extensions in GCC and GCCH. | • Plan your app > [Overview](concepts/cloud-overview.md#teams-app-capabilities) </br> • Build bots > [Overview](bots/what-are-bots.md) </br> • Build message extensions > [Overview](messaging-extensions/what-are-messaging-extensions.md) |
| 24/05/2022 | Use Live Share to transform Teams apps into collaborative multi-user experiences without writing any dedicated back-end code (developer preview). | Build apps for Teams meetings > Enhanced collaboration with Live Share > [Overview](apps-in-teams-meetings/teams-live-share-overview.md) |
| 28/04/2022 | Common reasons for app validation failure. | Publish your app > Publish to the Teams Store > [Common reasons for app validation failure](concepts/deploy-and-publish/appsource/common-reasons-for-app-validation-failure.md) |
| 26/04/2022 | Uninstall behavior for personal app with bot. | Build bots > Bot conversations > [Uninstall behavior updates in personal apps with bots](bots/how-to/conversations/subscribe-to-conversation-events.md#uninstall-behavior-for-personal-app-with-agent) |
| 22/04/2022 | Test preview for monetized apps. | Monetize your app > [Test preview for monetized apps](concepts/deploy-and-publish/appsource/prepare/test-preview-for-monetized-apps.md) |
| 22/04/2022 | In-app purchase flow for monetization of apps. | Monetize your app > [In-app purchases](concepts/deploy-and-publish/appsource/prepare/in-app-purchase-flow.md) |
| 20/04/2022 | Set up CI/CD pipelines. | Tools and SDKs > Teams Toolkit for Visual Studio Code > [Set up CI/CD pipelines](toolkit/use-CICD-template.md) |
| 19/04/2022 | Upload your app in Microsoft Teams. | Publish your app > [Upload your app](concepts/deploy-and-publish/apps-upload.md) |
| 01/04/2022 | Introduced step-by-step guide to create Teams conversational bot. | Build bots > Bot conversations > Channel and group conversations > [Step-by-step guide to create Teams conversational bot](sbs-teams-conversation-bot.yml) |
| 30/03/2022 | Updated the Get started module with Blazor app using tabs and bots. | Get started > [Build your first app using Blazor](sbs-gs-blazorupdate.yml) |
| 30/03/2022 | Device permissions for the browser. | Integrate device capabilities > [Device permissions for the browser](concepts/device-capabilities/browser-device-permissions.md) |
| 29/03/2022 | Integrate People Picker. | Integrate with Teams > [Integrate People Picker](concepts/device-capabilities/people-picker-capability.md) |
| 23/03/2022 | Introduced step-by-step guide to unfurl links in Teams using bot. | Build message extensions > Add link unfurling > [Unfurl links in Teams using bot](sbs-botbuilder-linkunfurling.yml) |
| 22/03/2022 | Added information on debug process. | • Tools and SDKs> Teams Toolkit for Visual Studio Code > [Debug your Teams app locally](toolkit/debug-local.md) </br> • Tools and SDKs> Teams Toolkit for Visual Studio Code > [Debug background process](toolkit/debug-background-process.md) |
| 14/03/2022 | Introduced step-by-step guide to build and test a connector in Microsoft Teams. | Build webhooks and connectors > Create connectors for Microsoft 365 Groups > [Build Teams connectors](sbs-teams-connectors.yml) |
| 10/03/2022 | Added information on Moodle LMS and Microsoft 365 plugins. | Integrate with Teams > Moodle LMS > [Moodle learning management system](resources/moodle-overview.md) |
...
| 25/02/2022 | Introduced step-by-step guide to invoke task modules in Teams. | Build cards and task modules > Build task modules > Use task modules from bots > [Invoke task module from Teams](sbs-botbuilder-taskmodule.yml) |
| 24/02/2022 | Introduced step-by-step guide to build action based message extension. | Build Message Extensions > Action commands > Define action commands > [Build action based message extension](sbs-meetingextension-action.yml) |
| 24/02/2022 | Introduced step-by-step guide to build search based message extension. | Build message extensions > Search commands > Define search commands > [Build search based message extension](sbs-messagingextension-searchcommand.yml) |
| 24/02/2022 | Introduced step-by-step guide to create Outgoing Webhooks. | Build webhooks and connectors > Create Outgoing Webhooks > [Create Outgoing Webhooks](sbs-outgoing-webhooks.yml) |
| 23/02/2022 | Microsoft Teams Store ranking parameters. | Publish your app > Publish to the Teams Store > [Microsoft Teams Store ranking parameters](concepts/deploy-and-publish/appsource/post-publish/teams-store-ranking-parameters.md) |
| 18/02/2022 | Introduced extensive Glossary for the Microsoft Teams Developer Documentation to help you find the definition about a term quickly. | [Glossary](~/get-started/glossary.md) |
| 18/02/2022 | Updated the Overview module for mapping Teams app to organizational goals, user story, and exploring Teams app features. | Overview > [Teams app that fits](overview.md) |
| 18/02/2022 | Updated the App fundamentals module to Plan your app to include mapping use cases to Teams features, and app planning checklist. | Plan your app > [Overview](~/concepts/app-fundamentals-overview.md) |
| 17/02/2022 | What to expect after you submit your app? | Publish your app > Publish to the Teams Store > [Overview](concepts/deploy-and-publish/appsource/publish.md) |
| 15/02/2022 | Introduced step-by-step guide how to upload files to Teams from a bot. | Build bots > Send and receive files > [Step-by-step guide how to upload files to Teams from a bot](sbs-file-handling-in-bot.yml) |
| 11/02/2022 | Shared meeting stage. | • Build apps for Teams meetings > [Shared meeting stage](apps-in-teams-meetings/build-tabs-for-meeting.md) </br> • Build apps for Teams meetings > [Build apps for Teams meetings](apps-in-teams-meetings/build-apps-for-teams-meeting-stage.md) </br> • App manifest > Public developer preview > [Developer preview manifest schema](/microsoft-365/extensibility/schema/) |
| 08/02/2022 | Introduced step-by-step guide to create Calling and Meeting bot. | Build bots > Calls and meetings bots > Register calls and meetings bot > [Step-by-step guide to create Calling and Meeting bot](sbs-calling-and-meeting.yml) |
...
| 25/01/2022 | Send real-time captions API. | Build apps for Teams meetings > Meeting apps API references> [Advanced meeting APIs](apps-in-teams-meetings/meeting-apps-apis.md) |
| 19/01/2022 | Server handlers for Adaptive Cards form completion. | Build cards and task modules > Build cards > [Server handlers](task-modules-and-cards/cards/cards-actions.md#server-handlers) |
| 17/01/2022 | People Picker in Adaptive Cards for desktop. | Build cards and task modules > Build cards > [People Picker in Adaptive Cards](task-modules-and-cards/cards/people-picker.md) |
| 28/10/2021 | Enable bots to receive all channel messages using resource-specific consent (RSC) (developer preview). | • Build bots > Bot conversations > [bot conversation overview](~/bots/how-to/conversations/conversation-basics.md) </br> • Build bots > Bot conversations > [channel and group conversations](~/bots/how-to/conversations/channel-and-group-conversations.md) |
| 16/06/2021 | Use resource-specific consent permissions to allow the app to access the data of a specific instance of a resource type (developer preview). | • Utilize Teams data with Microsoft Graph > [Resource-specific consent](graph-api/rsc/resource-specific-consent.md) </br> • Test your app > Microsoft Graph > [Test resource-specific consent permissions in Teams](graph-api/rsc/test-resource-specific-consent.md) |
...
| 05/10/2021 | App manifest v1.10 released. | App manifest > [Manifest schema](/microsoft-365/extensibility/schema/) |
...
| 04/08/2021 | App customization feature. | • Design your apps > [Design teams app overview](concepts/design/enable-app-customization.md) </br> • Tools and SDKs > [Developer Portal](concepts/build-and-test/teams-developer-portal.md) </br> • App manifest > Public developer preview > [Manifest schema](/microsoft-365/extensibility/schema/) |
...
| 11/16/2020 | Teams app manifest updated to version 1.8. | [Reference: Manifest schema for Microsoft Teams](/microsoft-365/extensibility/schema/) |
...
| 06/05/2020 | Manifest schema updated to version 1.7. | [Reference: Manifest schema for Microsoft Teams](/microsoft-365/extensibility/schema/) |
...
| 08/08/2018 | Message extensions now support multiple commands. | [composeExtensions.commands](/microsoft-365/extensibility/schema/root-compose-extensions#commands) |
...
| 07/23/2018 | Information about app recertification is added to the publishing section. | [Manifest permissions](/microsoft-365/extensibility/schema/root-authorization#permissions) |
