...
| --- | --- | --- |
|01-12-2021| Store location and name updated| • Design your app > App capabilities > [Designing your personal app for Microsoft Teams](concepts/design/personal-apps.md) </br> • [Design your tab for Microsoft Teams](tabs/design/tabs.md) </br> • [Designing your Microsoft Teams bot](bots/design/bots.md) </br> • [Designing your Microsoft Teams messaging extension](messaging-extensions/design/messaging-extension-design.md) </br> • [Unified meetings apps](apps-in-teams-meetings/meeting-app-extensibility.md) </br> • Design your app > UI components > • [Designing your Microsoft Teams app with advanced UI components](concepts/design/design-teams-app-advanced-ui-components.md) </br> • [Build tabs with Adaptive Cards](tabs/how-to/build-adaptive-card-tabs.md) </br> • [Designing task modules for your Microsoft Teams app](task-modules-and-cards/task-modules/design-teams-task-modules.md) </br> • [Designing activity feed notifications for your Microsoft Teams app](concepts/design/activity-feed-notifications.md)|
...
| 11/17/2021 | Updated Microsoft Teams store validation guidelines| Distribute your app > Publish to the Teams store > [Store validation guidelines](~/concepts/deploy-and-publish/appsource/prepare/teams-store-validation-guidelines.md)|
