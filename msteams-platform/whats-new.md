...
| **Date** | **Update** | **Find here** |
| -------- | --------- | ----------------|
| 17/10/2024 | Specify runtime requirements in app manifest to tailor your app's behavior in Microsoft 365 hosts.| Extend your app across Microsoft 365 > [Plan your app experience across Microsoft 365](m365-apps/specify-runtime-requirements.md) |
| 17/10/2024 | *copilotExtensions* renamed to `copilotAgents` in developer preview app manifest. | App manifest > Public developer preview > [Public developer preview app manifest](./resources/schema/manifest-schema-dev-preview.md#copilotagents) |
