...
| -------- | --------- | ----------------|
|23/05/2023 |  Introduced Live Share with Azure Communication Services. | Build apps for Teams meetings and calls > Enhanced collaboration with Live Share > [Live Share SDK](apps-in-teams-meetings/teams-live-share-overview.md)|
