...
| **Date** | **Update** | **Find here** |
| -------- | --------- | ----------------|
| 07/21/2022 | Get static meeting metadata in standard channel meeting | Meeting apps API references > Get meeting details API > [Get meeting details API](apps-in-teams-meetings/API-references.md#get-meeting-details-api) |
