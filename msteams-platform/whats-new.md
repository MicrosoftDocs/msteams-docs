...
description: Discover the latest Microsoft Teams developer features, updates to existing features, deprecation notes, and changes. Subscribe to the RSS feed for the latest updates.
...
Explore the Microsoft Teams platform features that are generally available (GA). Stay updated with the latest Teams platform updates by subscribing to the RSS feed [![download feed](~/assets/images/RSSfeeds.png)](https://aka.ms/TeamsPlatformUpdates). For more details, see [configure RSS feed](#get-latest-updates).
...
Teams platform features that are accessible to all app developers.</br>

**2025 November**

* ***November 21, 2025***: [Use the Performance Report tool to assess the efficiency of your web and tab apps on mobile.](resources/teams-mobile-best-practices.md#calculate-performance-metrics-for-apps)
...
|12/04/2024|Implement authentication in API-based search message extensions to ensure secure and seamless access to your app.|Build message extensions > Build message extensions using API > [Authentication](messaging-extensions/build-api-based-message-extension.md)|
|12/04/2024|Introducing app manifest v1.17, which includes semanticDescription, samplePrompts, and dashboardCards.|[App manifest](/microsoft-365/extensibility/schema/#all-generally-available-versions)|
|12/04/2024|Outlook extensions specify Outlook Add-ins within an app manifest, simplifying distribution and acquisition across the Microsoft 365 ecosystem.|App manifest > [extensions.requirements](/microsoft-365/extensibility/schema/requirements-extension-element)|
|12/04/2024|Create Dashboardcards that can be pinned to a dashboard like Microsoft Viva Connections to provide a summarized view of app information.|App manifest > [dashboardCards](/microsoft-365/extensibility/schema/dashboard-card)|
|12/04/2024|Share code snippets as richly formatted Adaptive Cards in Teams chats, channels, and meetings using the CodeBlock element.|Build cards and dialogs > [CodeBlock in Adaptive Cards](task-modules-and-cards/cards/cards-format.md#codeblock-in-adaptive-cards)|
|12/04/2024|Introduced a bot configuration experience that enables users to configure their bot during installation and reconfigure it later.|Build bots > [Bot configuration experience](bots/how-to/bot-configuration-experience.md)|
...
|04/04/2024|Added support for Python in the Teams AI library.|Build bots > Teams AI library > [Teams AI library](bots/how-to/teams-conversational-ai/teams-conversation-ai-overview.md)|
|04/04/2024|Stageview API with the openmode property allows you to open your app content in different Stageview experiences.|Build tabs > [Open content in Stageview](tabs/open-content-in-stageview.md)|
...
|26/03/2024|Adaptive Cards responsive layout helps you design cards to look great on any device, providing an enhanced user experience across chat, channels, and meeting chat.|Build cards and dialogs > Build cards > Format cards in Microsoft Teams > [Adaptive Card responsive layout](task-modules-and-cards/cards/cards-format.md#adaptive-card-responsive-layout)|
|07/03/2024|Introduced Adaptive Card Previewer to view real-time changes for Visual Studio 2022.|Tools and SDKs > Tools > [Adaptive Card Previewer for Visual Studio](concepts/build-and-test/adaptive-card-previewer-vs.md)|
|07/03/2024|Introduced Teams App Test Tool to streamline the debug process of bot-based apps for Visual Studio 2022.|Tools and SDKs > Tools > Teams Toolkit for Visual Studio > Prepare to build apps using Teams Toolkit > Debug your Teams app > [Debug bot using Teams App Test Tool](toolkit/toolkit-v4/debug-your-agents-playground-vs.md)|
...
|15/02/2024|Share to Teams from a personal app or tab for mobile clients.|Integrate with Teams > Share to Teams > [Share to Teams from personal app or tab](concepts/build-and-test/share-to-teams-from-personal-app-or-tab.md)|
...
|24/01/2024|Introduced an advanced step-by-step guide to learn how to debug your AI chatbot using Teams App Test Tool.|[Debug your AI chat bot using Teams App Test Tool](toolkit/teams-app-test-tool-tutorial.md)|
|19/01/2024|Use / to invoke message extensions from the command box in the new Teams client.|Build message extension > [Build message extensions using Bot Framework](messaging-extensions/build-bot-based-message-extension.md)|
|04/01/2024|Apps for Teams meetings are available in the Department of Defense (DoD) environment.|[Build apps for Teams meetings and calls](apps-in-teams-meetings/teams-apps-in-meetings.md)|
...
| **Date** | **Update** | **Find here** |
| -------- | --------- | ----------------|
|20/12/2023|Incoming Webhooks are available in the GCC High environment.|[Build webhooks and connectors](~/webhooks-and-connectors/what-are-webhooks-and-connectors.md)|
...
|12/12/2023|Use Teams AI library to build apps that can leverage LLMs to facilitate more natural conversational interactions with users, guiding that conversation into your app's skills.|Build bots > [Teams AI library](bots/how-to/teams-conversational-ai/teams-conversation-ai-overview.md)|
|21/11/2023|Terminology update. LOB apps are referred to as custom apps built for your org (LOB apps).||
...
|17/11/2023|Terminology update. Sideload is referred to as uploading a custom app.||
|17/11/2023|Introduced Teams App Test Tool to streamline the debug process of bot-based apps.|Tools and SDKs > Tools > Teams Toolkit for Visual Studio Code > Prepare to build apps using Teams Toolkit > Debug your Teams app > [Teams app Test Tool](toolkit/debug-your-agents-playground.md) |
|14/11/2023|Use callRecording API to fetch meeting recordings from all meetings.|Build apps for Teams meetings and calls > [Get meeting transcripts and recordings using Graph APIs](graph-api/meeting-transcripts/overview-transcripts.md)|
|14/11/2023|Branding update. Azure Active Directory (Azure AD) is referred to as Microsoft Entra ID.||
|03/11/2023|Apps for Teams meetings are available in the GCC High environment.|[Build apps for Teams meetings and calls](apps-in-teams-meetings/teams-apps-in-meetings.md)|
...
|11/10/2023|Introduced the new Microsoft Teams client to provide a better experience for your apps and users. | Resources > [Introducing the new Microsoft Teams client](resources/teams-updates.md)|
|05/10/2023|Use callTranscript API to fetch meeting transcripts from all meetings.|Build apps for Teams meetings and calls > [Get meeting transcripts and recordings using Graph APIs](graph-api/meeting-transcripts/overview-transcripts.md)|
|05/10/2023|You can rate apps on the Microsoft Teams Store and offer feedback on your usage experience.|Publish your app > Publish to the Teams Store > [Maintain your published app](concepts/deploy-and-publish/appsource/post-publish/overview.md#ratings-and-review-for-teams-apps)|
...
|26/09/2023|Use media elements such as audio or video clips in your Adaptive Card for enhanced media experience and user engagement.|Build cards and task modules > Build cards > [Media elements in Adaptive Card](task-modules-and-cards/cards/media-elements-in-adaptive-cards.md)|
...
| 29/08/2023 | Use Microsoft Teams Store with an intelligent search experience to display apps that are the closest match to the user's specified characters.|Publish your app > [Publish to the Teams Store](concepts/deploy-and-publish/appsource/publish.md#teams-store-search-experience) |
...
| 25/07/2023 | Use the people icon in an Adaptive Card to view the images of users.|Build cards and task modules > Build cards > Review Teams Store validation guidelines > [Build cards](task-modules-and-cards/cards/cards-format.md#people-icon-in-an-adaptive-card) |
...
| 14/06/2023 | Added validation guidelines for Teams apps powered by Artificial Intelligence (AI). | Publish your app > Publish to the Teams Store > Review Teams Store validation guidelines > [Apps powered by Artificial Intelligence](concepts/deploy-and-publish/appsource/prepare/teams-store-validation-guidelines.md#apps-powered-by-artificial-intelligence) |
...
| 25/05/2023 | Use a deep link to open a tab app in the meeting side panel in the Teams mobile client. | Build apps for Teams meetings and calls > Enable and configure apps for Teams meeting > [Build tabs for meeting](apps-in-teams-meetings/build-tabs-for-meeting.md#deep-link-to-meeting-side-panel) |
...
| 04/04/2023 | Tab apps in shared channels are available in the Department of Defense (DoD) environment. | Build tabs > [Build apps for shared channels](~/concepts/build-and-test/shared-channels.md) |
...
| 20/03/2023 | Bots are available in the Department of Defense (DoD) environment. | Build bots > [Overview](bots/what-are-bots.md)|
| 20/03/2023 | Message extensions are available in the Department of Defense (DoD) environment. | Build message extensions > [Overview](messaging-extensions/what-are-messaging-extensions.md)|
...
| 16/11/2022 | Introducing the Adaptive Cards overflow menu. | Build cards and task modules > Build cards > Format cards in Microsoft Teams > [Adaptive Cards overflow menu](task-modules-and-cards/cards/cards-format.md#adaptive-cards-overflow-menu) |
...
| 02/11/2022 | Support for global routing in bot APIs. | Build bots > Bot conversations > Proactive messages > [Create the conversation](bots/how-to/conversations/send-proactive-messages.md#create-the-conversation) |
| 10/27/2022 | Introducing the Workflow bot for Teams. | Tools and SDKs > Teams Toolkit > Use Teams Toolkit to create your app > Develop your Teams app > Create multi-capability app > [Create Teams workflow bot](sbs-gs-workflow-bot.yml) |
| 10/26/2022 | Build an in-meeting app to enable meeting participants to sign documents in real time. | Build apps for Teams meetings and calls > Enable and configure apps for Teams meetings > [Build apps for Teams meeting stage](apps-in-teams-meetings/build-apps-for-teams-meeting-stage.md#build-an-in-meeting-document-signing-app) |
...
| 10/13/2022 | Configure the NavBar and create an overflow menu for multiple actions. | Design your app > App capabilities > [Personal apps](concepts/design/personal-apps.md#configure-and-add-multiple-actions-in-navbar) |
| 10/13/2022 | Configure the back button of an app. | Design your app > App capabilities > [Personal apps](concepts/design/personal-apps.md#configure-back-button) |
...
| 09/06/2022 | Introduced code snippets for capturing videos using the camera through the `selectMedia` API. | Integrate device capabilities > Integrate media capabilities > [Code snippets](concepts/device-capabilities/media-capabilities.md#code-snippets) |
...
| 08/03/2022 | Share to Teams from a personal app or tab. | Integrate with Teams > Share to Teams > [Share to Teams from personal app or tab](concepts/build-and-test/share-to-teams-from-personal-app-or-tab.md) |
...
| 08/03/2022 | Link unfurling for sharing to Teams from web apps. | Integrate with Teams > Share to Teams > [Share to Teams from web apps](concepts/build-and-test/share-to-teams-from-web-apps.md) |
| 08/01/2022 | Notice: Developer Portal is now GA, and App Studio is deprecated as of August 1, 2022. | Tools and SDK > [Developer Portal for Teams](concepts/build-and-test/teams-developer-portal.md) |
| 07/28/2022 | Add the Teams display picture and people card for in-meeting notifications. | Build apps for Teams meetings and calls > Enable and configure apps for Teams meetings > [Build in-meeting notification for Teams meeting](apps-in-teams-meetings/in-meeting-notification-for-meeting.md) |
...
| 07/28/2022 | Introduced app manifest v1.14. | App manifest > [App manifest schema for Teams](/microsoft-365/extensibility/schema/#all-generally-available-versions) |
...
| 07/21/2022 | Introduced a step-by-step guide to send activity feed notifications. | Design your app > UI components > Activity feed notifications > [Send activity feed notification](sbs-graphactivity-feedbroadcast.yml) |
| 07/08/2022 | Updates to send the channel ID selected by the user during app installation to bots via conversation and installation update events. | Build bots > Bot conversations > Conversation events in your Teams bot > [Conversation events in your Teams bot](bots/how-to/conversations/subscribe-to-conversation-events.md) |
...
| 06/08/2022 | Optional card feedback for success messages. | Build cards and task modules > Build cards > [Form completion feedback](task-modules-and-cards/cards/cards-actions.md#form-completion-feedback) |
| 06/03/2022 | Updated the Add authentication module for enabling SSO for tab apps with new structure and procedures. | Add authentication > Tabs > [Enable single sign-on in a tab app](tabs/how-to/authentication/tab-sso-overview.md) |
...
| 04/26/2022 | Uninstall behavior for personal apps with bots. | Build bots > Bot conversations > [Uninstall behavior updates in personal apps with bots](bots/how-to/conversations/subscribe-to-conversation-events.md#uninstall-behavior-for-personal-app-with-bot) |
...
| 04/01/2022 | Introduced a step-by-step guide to create a Teams conversational bot. | Build bots > Bot conversations > Channel and group conversations > [Step-by-step guide to create Teams conversational bot](sbs-teams-conversation-bot.yml) |
...
| 03/23/2022 | Introduced a step-by-step guide to unfurl links in Teams using a bot. | Build message extensions > Add link unfurling > [Unfurl links in Teams using bot](sbs-botbuilder-linkunfurling.yml) |
| 03/22/2022 | Added information on the debug process. | • Tools and SDKs > Teams Toolkit for Visual Studio Code > [Debug your Teams app locally](toolkit/debug-local.md) </br> • Tools and SDKs > Teams Toolkit for Visual Studio Code > [Debug background process](toolkit/debug-background-process.md) |
| 03/14/2022 | Introduced a step-by-step guide to build and test a connector in Microsoft Teams. | Build webhooks and connectors > Create connectors for Microsoft 365 Groups > [Build Teams connectors](sbs-teams-connectors.yml) |
...
| 03/03/2022 | How to add authentication using an external OAuth provider. | Add authentication > Tabs > [Use external OAuth providers](tabs/how-to/authentication/auth-oauth-provider.md) |
| 02/25/2022 | Introduced a step-by-step guide to invoke task modules in Teams. | Build cards and task modules > Build task modules > Use task modules from bots > [Invoke task module from Teams](sbs-botbuilder-taskmodule.yml) |
| 02/24/2022 | Introduced a step-by-step guide to build action-based message extensions. | Build Message Extensions > Action commands > Define action commands > [Build action-based message extension](sbs-meetingextension-action.yml) |
| 02/24/2022 | Introduced a step-by-step guide to build search-based message extensions. | Build message extensions > Search commands > Define search commands > [Build search-based message extension](sbs-messagingextension-searchcommand.yml) |
| 02/24/2022 | Introduced a step-by-step guide to create Outgoing Webhooks. | Build webhooks and connectors > Create Outgoing Webhooks > [Create Outgoing Webhooks](sbs-outgoing-webhooks.yml) |
...
| 02/18/2022 | Introduced an extensive Glossary for the Microsoft Teams Developer Documentation to help you find the definition of a term quickly. | [Glossary](~/get-started/glossary.md) |
...
| 02/15/2022 | Introduced a step-by-step guide on how to upload files to Teams from a bot. | Build bots > Send and receive files > [Step-by-step guide on how to upload files to Teams from a bot](sbs-file-handling-in-bot.yml) |
...
| 02/08/2022 | Introduced a step-by-step guide to create Calling and Meeting bots. | Build bots > Calls and meetings bots > Register calls and meetings bot > [Step-by-step guide to create Calling and Meeting bot](sbs-calling-and-meeting.yml) |
...
| 08/30/2021 | Custom Together Mode scenes feature combines participants into a single virtual scene and places their video streams in predetermined seats | Build apps for Teams meetings > [Custom Together Mode scenes](~/apps-in-teams-meetings/teams-together-mode.md) |
...
Discover Microsoft Teams platform features that are in developer preview. You can now get the latest Teams platform updates by subscribing to the RSS feed [![download feed](~/assets/images/RSSfeeds.png)](https://aka.ms/TeamsPlatformUpdates). For more information, see [configure RSS feed](#get-latest-updates).
...
Explore Microsoft Teams platform features currently in developer preview. You can now receive the latest Teams platform updates by subscribing to the RSS feed [![download feed](~/assets/images/RSSfeeds.png)](https://aka.ms/TeamsPlatformUpdates). For more information, see [configure RSS feed](#get-latest-updates).
...
The Developer preview is a public program offering early access to unreleased Teams platform features.
...
| **Date** | **Update** | **Find here** |
| -------- | --------- | ---------------- |
| 19/11/2024 | Introduced optional `abbreviated` property for app display name on the app bar. | App manifest > Public developer preview > Public developer preview app manifest > [name](/microsoft-365/extensibility/schema/root-name) |
...
| 17/10/2024 | Learn about copilotExtensions renamed to copilotAgents in developer preview app manifest. | App manifest > Public developer preview app manifest > [copilotAgents](/microsoft-365/extensibility/schema/root-copilot-agents) |
...
|28/08/2023| Teams app manifest is now referred to as app manifest. | App manifest > [App manifest schema](/microsoft-365/extensibility/schema/)|
...
Explore Microsoft Teams platform features that are deprecated. You can now receive the latest Teams platform updates by subscribing to the RSS feed [![download feed](~/assets/images/RSSfeeds.png)](https://aka.ms/TeamsPlatformUpdates). For more information, see [configure RSS feed](#get-latest-updates).
...
| 11/10/2023 | Adaptive Card tabs **are** now deprecated in the new Microsoft Teams. If your app currently uses Adaptive Card tabs, we recommend rebuilding the tab as a web-based tab. | Build tabs > [Overview](tabs/what-are-tabs.md) |
...
| **Date** | **Update** | **Find here** |
| -------- | --------- | ------------------ |
|01/08/2022 | App Studio is deprecated; use the Developer Portal for Teams instead.| Tools and SDKs > Tools > [Developer Portal for Teams](concepts/build-and-test/teams-developer-portal.md)|
...
In addition to new features, we also offer [production-ready Teams app templates](samples/app-templates.md) that you can deploy immediately or customize to fit your needs. Newly added templates are marked with a star ☆.

## Submit your feedback

We encourage Teams developers to ask questions, report bugs, submit feature requests, and contribute. You can provide feedback through any of the [available channels](feedback.md).

## Get latest updates

Stay updated with the latest Teams platform updates by configuring the [RSS feed](https://aka.ms/TeamsPlatformUpdates).

### To configure RSS feed

1. Open Teams.
1. Select **Teams** from the left pane.
1. Choose a channel in the team.
1. Select the ellipsis &#x25CF;&#x25CF;&#x25CF; and from the dropdown list, select **Connectors**.
1. In the **Connectors** dialog box that appears, search for **RSS**.
1. Select **Configure**.
1. In **Enter a name for your RSS connection**, enter a name.
1. In **Address for RSS feed**, enter **<https://aka.ms/TeamsPlatformUpdates>**.
1. Choose the frequency of the feed from the **Digest frequency** dropdown list.
1. Select **Save**.