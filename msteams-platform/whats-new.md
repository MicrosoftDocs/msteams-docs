...
| **Date** | **Update** | **Find here** |
| -------- | --------- | ----------------|
|23/05/2023 | Introducing Teams AI library to help build AI-powered Teams apps. | Build Bots > [Teams AI library](bots/how-to/Teams%20conversational%20AI/teams-conversation-ai-overview.md)|
