...
| -------- | --------- | ------------------ |
|09/13/2021| Guidelines for apps linked to SaaS offer. | [Microsoft Teams store validation guidelines](concepts/deploy-and-publish/appsource/prepare/teams-store-validation-guidelines.md) |  
