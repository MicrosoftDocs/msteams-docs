...
| --- | --- | --- |
|04/08/2022| Tips to avoid app rejection and pass app validation | Distribute your app > Publish to the Teams store > [Tips to avoid app rejection and pass app validation](concepts/deploy-and-publish/appsource/tips-to-avoid-app-rejection.md)|
