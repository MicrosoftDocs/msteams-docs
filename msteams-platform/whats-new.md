...
| --- | --- | --- |
| 02/23/2022 |Microsoft Teams store ranking parameters| Distribute your app > [Microsoft Teams store ranking parameters](concepts/deploy-and-publish/appsource/post-publish/teams-store-ranking-parameters.md)|
