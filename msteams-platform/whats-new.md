...
***April 3, 2024***: [Share code snippets as Adaptive Cards with the CodeBlock property.](task-modules-and-cards/cards/cards-format.md#codeblock-in-adaptive-cards)
