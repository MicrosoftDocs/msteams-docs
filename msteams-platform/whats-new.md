...
* ***April 01, 2025***: [Increase app engagement with custom activity icons in activity feed notifications](/graph/teams-send-activityfeednotifications?toc=%2Fmicrosoftteams%2Fplatform%2Ftoc.json&bc=%2Fmicrosoftteams%2Fplatform%2Fbreadcrumb%2Ftoc.json&tabs=desktop%2Chttp#custom-activity-icons-in-activity-feed-notifications).
...
| -------- | --------- | ----------------|
| 27/03/2025 | Learn about the best practices to optimize tab app performance in Teams mobile clients. | Resources > [Best practices for Teams mobile app](resources/teams-mobile-best-practices.md) |
| 07/03/2025 | Introduced app manifest v1.20 with `elementRelationshipSet`, `requirementSet`, and `intuneInfo` properties. | App manifest > [App manifest](/microsoftteams/platform/resources/schema/manifest-schema) |
| 07/03/2025 | Specify runtime requirements in app manifest to tailor your app's behavior in Microsoft 365 hosts. | Extend your app across Microsoft 365 > [Plan your app experience across Microsoft 365 hosts](m365-apps/specify-runtime-requirements.md) |
| 07/03/2025 | Enable Intune Mobile App Management (MAM) support for Outlook add-ins to ensure compliance with organizational data protection policies. | [Office.Mailbox interface](/javascript/api/outlook/office.mailbox?view=outlook-js-preview&preserve-view=true) |
