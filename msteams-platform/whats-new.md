...
* ***February 19, 2025***: [Introducing the app package editor in the Developer Portal for Teams, which allows you to create, manage, and customize app packages, and also add declarative agents and their related files.](concepts/build-and-test/manage-your-apps-in-developer-portal.md#configure)
