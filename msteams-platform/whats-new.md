...
This enhancement enables the host to acquire authentication tokens proactively before the app launches, improving startup performance and reducing latency.](./concepts/authentication/nested-authentication#token-prefetching-for-nested-app-authentication)
