...
***November 02, 2023***: [Introduced systemDefault reserved activity types for send activity feed notifications.](tabs/send-activity-feed-notification.md#reserved-activity-types)
