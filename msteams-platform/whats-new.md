...
| -------- | --------- | ----------------|
| 09/30/2022 | Manage SaaS licenses for third party apps in Teams. | [Manage SaaS licenses for third party apps in Teams](concepts/deploy-and-publish/appsource/prepare/include-saas-offer.md#manage-license-for-third-party-apps-in-teams) |
| 09/29/2022 | Teams mobile app now supports file downloads to local devices. | [Teams mobile app now supports file downloads to local devices](concepts/device-capabilities/media-capabilities.md#file-download-on-teams-mobile) |
| 09/16/2022 | Adaptive Cards in search based message extensions now support Universal Actions. | [Adaptive Cards in search based message extensions now support Universal Actions](messaging-extensions/how-to/search-commands/universal-actions-for-search-based-message-extensions.md) |
| 09/06/2022 | Introduced code snippets for capturing videos using camera through `selectMedia` API. | [Introduced code snippets for capturing videos using camera through `selectMedia` API](concepts/device-capabilities/media-capabilities.md#code-snippets) |
