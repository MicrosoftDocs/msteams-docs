...
| **Date** | **Notes** | **Changed topics** |
| -------- | --------- | ------------------ |
|07/15/2021|Added Get context in shared channels section under Get context for your tab.|[Get context in shared channels](tabs/how-to/access-teams-context.md), [Build tabs - Overview](tabs/what-are-tabs.md) |
