...
| --- | --- | --- |
|04/01/2022| Introduced step-by-step guide to upload file in Teams using bot | Bot conversations > Send and receive files > [Upload file in Teams using bot](sbs-file-handling-in-bot.yml)
