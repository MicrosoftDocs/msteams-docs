...
| --- | --- | --- |
|04/06/2022| Introduced step-by-step guide to generate meeting side panel in Teams| Build apps for Teams meetings > Enable and configure apps for meetings > [Generate meeting side panel](sbs-meetings-sidepanel.yml)
