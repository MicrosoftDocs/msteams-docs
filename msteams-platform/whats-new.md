...
| --- | --- | --- |
| 12/21/2021 | Updated the Get started JavaScript, C#, and Node.js modules for Teams Toolkit 3.0.0. | • Get started > [Build your first app with JavaScript](https://docs.microsoft.com/en-us/microsoftteams/platform/sbs-gs-javascript) <br> • Get started > [Build your first app with C# or .NET](https://docs.microsoft.com/en-us/microsoftteams/platform/sbs-gs-csharp) <br> • Get started> [Build your first app with Node.js](https://docs.microsoft.com/en-us/microsoftteams/platform/sbs-gs-nodejs) |
|12/20/2021 | Introduced guidelines for app linked to SaaS offer. | Distribute your app > Publish to the Teams store > Review store validation guidelines > [Guidelines for apps linked to SaaS offer](concepts/deploy-and-publish/appsource/prepare/teams-store-validation-guidelines.md#apps-linked-to-saas-offer)|
