...
| -------- | --------- | ------------------ |
|03/04/2021|Information masking in Adaptive cards is in developer preview.| [Information masking in Adaptive cards](task-modules/card/cards-format.md#information-masking-in-adaptive-cards) |
