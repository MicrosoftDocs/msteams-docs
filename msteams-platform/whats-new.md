...
* ***October 25, 2024***: [Configure your app's default landing capability](/concepts/deploy-and-publish/add-default-install-scope.md#configure-your-apps-default-landing-capability).
