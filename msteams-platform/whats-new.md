...
| 02/07/2024 | Extend bot-based message extension agents to Teams meetings. | Build message extensions > Build message extensions using Bot Framework > Search Commands > [Enable message extension as a agent for Copilot for meetings](messaging-extensions/build-bot-based-agent.md#enable-message-extension-as-a-agent-for-copilot-for-meetings) |
