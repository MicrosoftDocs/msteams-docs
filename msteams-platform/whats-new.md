...
| **Date** | **Update** | **Find here** |
| -------- | --------- | ---------------- |
| 10/31/2025 | Ad hoc calls—spontaneous, unscheduled meetings—are now receiving enhanced support across Graph APIs. | Build apps for Teams meetings and calls > Get meetings, transcripts, recordings and AI summaries > [Meeting transcripts and recordings](graph-api/meeting-transcripts/overview-transcripts.md)|
