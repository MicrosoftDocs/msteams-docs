...
| **Date** | **Update** | **Find here** |
| -------- | --------- | ------------------ |
|11/23/2021|Interactive mode to share meeting stage.|[Shared meeting stage](apps-in-teams-meetings/enable-and-configure-your-app-for-teams-meetings.md#shared-meeting-stage), [Meeting apps API references](apps-in-teams-meetings/API-references.md), and [Developer preview manifest schema](resources/schema/manifest-schema-dev-preview.md)|
