...
* **November 14,2023**: Introduced [Teams App Test Tool](toolkit/debug-your-Teams-app-test-tool.md), a utility that streamlines the debugging process of bot-based applications in a sandbox environment.
