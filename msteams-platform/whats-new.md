...
| --- | --- | --- |
|02/09/2022| Introduced step-by-step guide to create a bot to invoke Teams task module | Build cards and task modules > Build task modules > Use task modules from bots > [Teams task module bot](sbs-botbuilder-taskmodule.yml)|
