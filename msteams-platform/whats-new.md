...
| **Date** | **Update** | **Find here** |
| -------- | --------- | ------------------ |
| 05/24/2022| Updated media capabilities for desktop  | Integrate device capabilities > [Integrate media capabilities](concepts/device-capabilities/media-capabilities.md)|
