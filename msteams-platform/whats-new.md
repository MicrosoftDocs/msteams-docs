...
| -------- | --------- | ------------------ |
|09/21/2021|Teams supports AAD Object ID and UPN in user mention for bots and Incoming Webhooks. | [AAD Object ID and UPN in user mention](task-modules-and-cards/cards/cards-format.md), [Cards](task-modules-and-cards/what-are-cards.md#support-for-aad-object-id-and-upn-in-user-mention)|
