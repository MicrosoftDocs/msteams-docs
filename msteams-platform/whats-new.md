...
| -------- | --------- | ------------------ |
| 04/23/2019 | Bots are now [enabled for groupchat](~/concepts/bots/bots-conversations.md) | |
| 04/23/2019 | Action-based Message Extensions are now available | [Action-based Message Extensions](~//messaging-extensions/create-extensions.md) |
