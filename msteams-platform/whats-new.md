...
* ***January 25, 2024***: Teams, Outlook, and Microsoft 365 web domains are migrating to *cloud.microsoft* domain. Configure your app before June 2024 to ensure continued functionality. For more information, see [Configure Content Security Policy headers](m365-apps/extend-m365-teams-personal-tab.md#configure-content-security-policy-headers).
