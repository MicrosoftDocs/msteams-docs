...
* ***March 27, 2024***: [Learn how to configure Teams deep links using the `msteams://` and `https://` protocol handlers.](concepts/build-and-test/deep-links.md#protocol-handlers-in-deep-links)
