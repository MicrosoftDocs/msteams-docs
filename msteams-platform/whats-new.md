...
* ***October 30, 2022***: [Enable app caching to improve subsequent launch time of the apps](apps-in-teams-meetings/enable-and-configure-your-app-for-teams-meetings.md#app-caching)
