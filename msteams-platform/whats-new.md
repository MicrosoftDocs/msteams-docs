...
| --- | --- | --- |
|05/10/2022 |  Updated location capability for desktop |Integrate device capabilities > [Location capability](concepts/device-capabilities/location-capability.md)|
...
| **Date** | **Update** | **Find here** |
| -------- | --------- | ----------------|
|09/28/2022  | Updated location capability for desktop |Integrate device capabilities > [Location capability](concepts/device-capabilities/location-capability.md)|
