...
Bot Connector is the service that agents use to interact with Teams. Before your agent's runtime can authenticate to Bot Connector and perform actions in Teams, you need to register it with the service.
