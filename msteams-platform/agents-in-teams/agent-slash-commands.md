...
If your agent or app implements functionality that is intended to be accessed via named commands, you can add configuration to your agent that makes those commands more discoverable from conversational surfaces in Teams. TODO add a simple concrete scenario here.
...
Command implementations should also inspect the received message to determine whether it is targeted (private) and
