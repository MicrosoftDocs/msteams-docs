...
You can do so by following [provision SharePoint-based app](/microsoftteams/platform/sbs-gs-spfx?tabs=vscode%2Cviscode&tutorial-step=4). Building a Teams app using SharePoint Framework with Teams Toolkit does not have direct integration with the Microsoft Entra admin center.
