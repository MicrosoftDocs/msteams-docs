...
For more information on Teams Toolkit, see [Create a new Teams project](toolkit/create-new-project.md) and [Microsoft 365 Agents Toolkit CLI](toolkit/Teams-Toolkit-CLI.md) (previously known as Teams Toolkit CLI).
...
If you get errors with Teams Toolkit in Visual Studio Code, you can select **Get Help** on the error notification to go to the related document. If you're using Agents Toolkit CLI, there'll be a hyperlink at the end of error message that points to the help doc.
<br>
