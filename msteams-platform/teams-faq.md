...
| --- | --- | --- |
| 1 | Zoom to contact with Microsoft (M365 CAPE Store Ops) - [Rajarshi Mandal](rmandal@microsoft.com) while performing the steps for any clarification or guidance required. | M365 CAPE Store Ops |
...
| 6 | Submit this manifest and app package over [email](teamsubm@microsoft.com) to M365 CAPE Store Ops | M365 CAPE Store Ops |
