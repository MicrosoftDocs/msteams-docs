...
For more information on Teams Toolkit, see [Create a new Teams project](toolkit/create-new-project.md) and [Microsoft 365 Agents Toolkit CLI](toolkit/Teams-Toolkit-CLI.md).
...
* [Microsoft 365 Agents Toolkit CLI](toolkit/Teams-Toolkit-CLI.md)
