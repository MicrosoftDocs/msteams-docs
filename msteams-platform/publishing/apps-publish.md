...
* For apps incorporating private URLS a signed-in user must have a sign-out option. For apps incorporating public URLS a sign-out option is not mandatory although including a sign-out option is a better user experience.
