...
4. Enter the overview information for your app.
   ...
   * **App logo** This is the icon that appears in the AppSource catalog. This icon can be a .png, .jpg, .jpeg, or .gif file, and should not exceed 512 KB. Note that the gallery within the Teams app will use `icon.color` from your manifest, not this image.
