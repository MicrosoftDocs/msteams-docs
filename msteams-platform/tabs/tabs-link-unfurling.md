...
[StageViewParams](/javascript/api/@microsoft/teams-js/stageview.stageviewparams) where `openMode` isn't defined. The default response is `popoutWithChat` (Collaborative Stageview).
