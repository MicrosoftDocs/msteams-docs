...
|-----------|-----------|-----------|-----------|-----------|
|Collaborative Stage View|Invoke from Adaptive Cards.|**Chat**: Opens Teams pop-out window with chat pane. **Channel**: Opens Stage View modal|Opens Stage View modal.|Opens Stage View modal.|
