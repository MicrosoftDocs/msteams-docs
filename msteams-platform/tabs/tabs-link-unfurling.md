...
To use Stage View, developers must enable 'Tab Link Unfurling' for their app. If it's already enable, Stage View is available, and requires no additional developer investment.
