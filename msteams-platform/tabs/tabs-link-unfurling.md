...
## Stage View vs. Dialogs

|Stage View|Dialog|
|:-----------|:-----------|
|Stage View is useful when you have rich content to display to the users, such as a page, a dashboard, a file, and so on. It provides rich features that help to render your content in the full-screen canvas.|[Dialogs](../task-modules-and-cards/task-modules/task-modules-tabs.md) (task module) are especially useful to display messages that require user attention, or collect information required to move to the next step.|
