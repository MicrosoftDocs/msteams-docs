...
> [!NOTE]
>
> To use Stage View, developers must enable 'Tab Link Unfurling' for their app. If it is already available, this Stage View update is free, and requires no additional developer investment.
