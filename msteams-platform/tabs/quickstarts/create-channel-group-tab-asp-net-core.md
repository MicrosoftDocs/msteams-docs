...
- Click the <button class="button"style="background-color:#5458AE;color:white;font-size:small;letter-spacing:1px;font-weight:light; border-radius:4px;width:75px;height:35px;margin:3px">Install</button> button.
