...
ms.author: laujan
---
# Quickstart: Build a custom personal tabs with Node.js and the Microsoft Teams Yeoman Generator

[!INCLUDE [common-node-js-build-custom-tabs](common-node-js-build-custom-tabs.md)]
