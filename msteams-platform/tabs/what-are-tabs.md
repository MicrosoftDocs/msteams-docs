...
> [!Note]
>
> * Teams app doesn't support sub iframes. Therefore, it'll not load if there is an iframe within the tab app.
> * Teams app can't use native plugins when it runs inside sandboxed iframes.
