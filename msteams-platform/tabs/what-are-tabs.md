...
> * For all [apps that are not distributed through thge AppSource](../concepts/deploy-and-publish/overview.md), the tabs open in an in-app WebView within the Teams clients by default and there is no separate approval process required.
