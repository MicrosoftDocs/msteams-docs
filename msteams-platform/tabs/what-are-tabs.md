...
For personal tabs also you can create a configuration page and add it to your `contentUrl` codespace. For more information, see [personal tabs.](~/tabs/how-to/create-personal-tab.md#customizable-personal-tab) 
