...
*See also*, [Request device permissions](concepts/device-capabilities/native-device-permissions.md) and [Mobile device camera and image capabilities](concepts/device-capabilities/mobile-camera-image-permissions.md).