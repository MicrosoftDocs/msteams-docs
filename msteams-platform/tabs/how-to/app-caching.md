...
author: surbhigupta
description: Learn how to enable app caching to your tab app in Teams and how it improves the app's launch time. Know about code examples and app caching limitations.
ms.topic: conceptual
