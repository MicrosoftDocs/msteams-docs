...
1. The Teams clients open the URL in an external browser after replacing the placeholders automatically for `oauthRedirectMethod` and `authId` with suitable values.
