...
:::image type="content" source="../../../assets/images/authentication/teams-sso-tabs/azure-app-details.png" alt-text="Screenshot shows app configuration values in Azure AD.":::
