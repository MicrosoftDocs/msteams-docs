...
- If your app uses dialogs (referred as task modules in TeamsJS v.1.0) from within a bot, a tab, a message extension, or Adaptive Cards, then you can use the SSO API to authenticate your app users.
