...
- Redirects aren't supported for apps that are iframed or brokered. If you use the redirect APIs, ensure you use MSAL.js in the top frame of the window, or use the popup API `(window.parent!==window) => true`.
