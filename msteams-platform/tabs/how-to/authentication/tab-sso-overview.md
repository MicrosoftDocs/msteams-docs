...
description: Learn about single sign-on (SSO) authentication in Teams, how to enable SSO in tab apps and enhance user experience, and understand SSO at runtime.
ms.topic: conceptual
