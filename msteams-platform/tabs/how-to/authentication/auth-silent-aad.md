...
Silent authentication in Azure Active Directory (Azure AD) minimizes the number of times a user needs to enter their login credentials by silently refreshing the authentication token. (For proper SSO support, view our [SSO Documentation](~/tabs/how-to/authentication/auth-aad-sso))
