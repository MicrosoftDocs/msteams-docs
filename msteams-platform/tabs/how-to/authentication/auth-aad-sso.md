...
>
> * We only support user-level Graph API permissions, e.g., email, profile, offline_access, openid. If you need access to other Graph scopes, read our recommended workaround at the end of this documentation.
