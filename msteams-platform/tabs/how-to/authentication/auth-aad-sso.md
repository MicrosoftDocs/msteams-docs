...
1. Under **Manage**, select **Expose an API**.
    ...
    > For example, when you create an app service or web app, if you enter base resource name as `DemoApplication`, then the URL will be `https://DemoApplication.azurewebsites.net`. This works in desktop, web and iOS, but not in android.
