...
Teams establishes a trusted connection with providers, to access data from services, such as Facebook, Twitter, and to access user information protected by Azure Active Directory (AAD). Teams has different authentication flows for the app. You can use the web-based authentication flow for tabs and web-based authentication flow in a content page embedded in tab
...
* [Single Sign-on authentication in tabs](~/tabs/how-to/authentication/auth-add-sso.md) describes how to authorize Teams tab or task module on desktop or mobile client.
