...
> [!NOTE]
> If we select personal Microsoft accounts or accounts in any organizational directory during app registration, then only we need to alter as 2, if not we can leave the default null value alone.
