...
> - If you've two separate apps registered in Microsoft Entra ID and require individual tokens for each app, use the [OBO flow](/azure/active-directory/develop/v2-oauth2-on-behalf-of-flow) to enable communication between the apps.
