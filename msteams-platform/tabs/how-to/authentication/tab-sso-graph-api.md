...
> 
> - Do not use `notifySuccess` result to return token information to the parent page. Use localStorage to avoid passing the token via notifySuccess; instead we send the item key. 
