...
It's also available as a `{hostName}` [URL placeholder value](./access-teams-context.md#get-context-by-inserting-url-placeholder-values). We recommend you to use the *hostName* mechanism sparingly:
