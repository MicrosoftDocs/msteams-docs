...
|-----------|--------------|-------|
| app | Teams, Outlook, Office, Office for Android | Namespace representing app initialization and lifecycle. |
| appInitialization| | Deprecated. Replaced by `app` namespace. |
| appInstallDialog | Teams||
| authentication | Teams, Outlook, Office, Office for Android | |
| calendar | Outlook ||
| call | Teams||
| chat |Teams||
...
| pages | Teams, Outlook, Office, Office for Android | Namespace representing page navigation. See notes on [Deep linking](#deep-linking). |
| people |Teams||
