...
For more information to build complex application, see [Teams Fluid Hello World](https://github.com/microsoft/FluidHelloWorld) example in our FluidExamples repo.
