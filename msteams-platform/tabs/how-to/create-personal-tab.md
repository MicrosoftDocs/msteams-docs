...
1. Go to your Microsoft Teams and select :::image type="content" source="~/assets/images/teams-toolkit-v2/prerequisites/upload-custom-app.png" alt-text="Teams store":::
