...
> [!NOTE]
> * Extending static tabs to group chat and meetings is available only in [public developer preview](~/resources/dev-preview/developer-preview-intro.md). Extending static tabs to group chat and meetings is available only in classic Teams client and isn't available in the [new Teams client](~/resources/teams-updates.md).
