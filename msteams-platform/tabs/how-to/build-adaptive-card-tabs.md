...
> [!WARNING]
> Adaptive Card tabs will be deprecated in the new Teams client. Apps are expected to be available in the new Teams client by March 2024. If your app is using Adaptive Card tabs, we recommend to rebuild the tab as a web-based tab. For more information, see [Build tabs for Teams](../what-are-tabs.md).
