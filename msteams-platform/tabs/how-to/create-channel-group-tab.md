...
> [!NOTE]
> * Migrating your configurable tab to static tab is available only in [public developer preview](~/resources/dev-preview/developer-preview-intro.md) and classic Teams client. Migrating your configurable tab to static tab isn't available in the [new Teams client](~/resources/teams-updates.md). 
