...
```json
{
    ...
    "tenantSKU": "The type of license for the current user tenant",
    "userLicenseType": "The license type for a current user",
    "parentMessageId": "The parent message ID from which this task module is launched",
    "ringId": "The current ring ID",
    "appSessionId": "The Unique ID for the current session used for correlating telemetry data",
    "isCallingAllowed": "Represents if calling is allowed for the current logged in user",
    "isPSTNCallingAllowed": "Represents if PSTN calling is allowed for the current logged in user",
