...
author: v-silakshmi
description: Learn how to build dashboard tab app in Teams, customize the layout, use a widget, make Graph API calls using the Teams Toolkit, and embed a Power BI dashboard.
