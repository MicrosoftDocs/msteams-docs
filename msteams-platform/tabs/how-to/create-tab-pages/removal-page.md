...
> * After you invoke the `registerOnRemoveHandler` event handler, you'll have 15 seconds to respond to the method. The app must call `setValidityState(true)` in order to enable the Remove button and the remove handler to get invoked.
