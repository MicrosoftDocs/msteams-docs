...
* To improve the user experience please include a personal bot that sends a welcome message to the user on the first run and responds to the **hi**, **help**, and **hello** commands in addition to the personal tab. You can refer to the documentation on [conversational bots](https://docs.microsoft.com/en-us/microsoftteams/platform/bots/what-are-bots#in-a-one-to-one-chat) for further assistance.
