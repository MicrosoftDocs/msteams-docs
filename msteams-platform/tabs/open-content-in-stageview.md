...
Microsoft Teams provides multiple methods to open app content in immersive canvas experiences. Stageview allows users to adopt multitasking inside Teams. For example, users can open app content in a new Teams window with a specific chat in the side panel. Stageview is designed to:
...
Stageview Multi-window is useful for scenarios that require users to multitask in Teams without the need for collaboration. This view opens app content in a new Teams window without a side panel conversation, allowing users to focus on their task.
...
Stageview Modal is a full-screen UI component used to render app content inside the Teams main window. This view provides users with a focused experience to engage with app content. Stageview Modal is useful for displaying rich content that doesn't require users to multitask. It’s the default view when Collaborative Stageview and Stageview Multi-window aren't supported.
