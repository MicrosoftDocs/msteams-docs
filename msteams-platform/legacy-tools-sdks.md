...
Teams AI Library is now Teams SDK. Update existing solutions that use any versions of Teams AI Library to use the current version of Teams SDK.
...
- [Archived Teams Platform documentation](/previous-versions/microsoftteams/platform/toolkit/teamsfx-sdk)
