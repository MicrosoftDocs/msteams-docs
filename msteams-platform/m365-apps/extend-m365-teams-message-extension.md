...
1. Select **Custom Search Results** to download the sample code for a Teams message extension using the latest app manifest (previously called Teams [app manifest](../resources/schema/manifest-schema.md)).
