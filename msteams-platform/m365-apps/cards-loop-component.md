...
|----------------|-----------------|--------------|
| Messaging Extension with Adaptive Card Loop Component | This sample demonstrates how to create a message extension with adaptive card-based loop component.|[View](https://github.com/OfficeDev/Microsoft-Teams-Samples/tree/main/samples/msgext-unfurling-ac-loop-components/nodejs)|
