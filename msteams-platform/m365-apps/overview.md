...
> [!NOTE]
> Apps with app manifest version below 1.13 are exclusive to Teams. However, apps with app manifest version 1.13 or above are compatible with Teams, Outlook, and Microsoft 365 app.
