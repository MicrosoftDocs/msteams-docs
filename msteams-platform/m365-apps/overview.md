...
| [**Message extensions-search-based**](../messaging-extensions/how-to/search-commands/define-search-command.md)| `composeExtensions` | Web, Desktop, Mobile| Web (preview), Desktop (preview) | - | See [notes](extend-m365-teams-message-extension.md#troubleshooting). |
| [**Link unfurling**](../tabs/tabs-link-unfurling.md) | `composeExtensions.messageHandlers` | Web, Desktop, Mobile | Web (preview), Desktop (preview), Mobile (preview) | - | See [notes](extend-m365-teams-message-extension.md#link-unfurling). |
| [**Adaptive Card Loop components**](./design-loop-components.md)|`composeExtensions.messageHandlers`|Web (preview), Desktop (preview), Mobile* (preview)|Web (preview), Desktop (only for [new Outlook](https://support.microsoft.com/office/getting-started-with-the-new-outlook-for-windows-656bb8d9-5a60-49b2-a98b-ba7822bc7627) preview), Mobile* (preview)|-| *Viewable (but not composable) in Teams/Outlook mobile (iOS, Android). See [notes](cards-loop-component.md).
| [**Stage View**](extend-m365-teams-message-extension.md#stage-view)|`composeExtensions.messageHandlers`|Web, Desktop, Mobile|Web (preview), Desktop (preview), Mobile* (preview)|-| *Viewable (but not composable) in Outlook mobile (iOS, Android). See [notes](extend-m365-teams-message-extension.md#stage-view).
