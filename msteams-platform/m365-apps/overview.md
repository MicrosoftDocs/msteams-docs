...
> [!WARNING]
> Please note that if Targeted release is enabled, access to the in-market app on the Teams platform will be lost if you migrate to the new manifest version.
