...
| [**Outlook Add-ins**](/office/dev/add-ins/develop/json-manifest-overview) | `extensions` | - | Web, Desktop | - | See [notes](#outlook-add-ins-preview).|
...
You can now define and deploy Outlook Add-ins in [version 1.17](../resources/schema/manifest-schema.md) of the app manifest.
