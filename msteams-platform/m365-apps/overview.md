...
|--|--|--|--|--|--|
| [**Tabs-personal scope**](../tabs/how-to/create-personal-tab.md)     |`staticTabs`  | Web, Desktop, Mobile (iOS and Android) | Web (Targeted Release), Desktop (Beta Channel), Mobile (iOS and Android) | Web, Desktop, Mobile (iOS and Android)| Channel and group scope not yet supported for Microsoft 365. For more information, see [notes](../tabs/how-to/using-teams-client-sdk.md#microsoft-365-support-running-teams-apps-in-office-and-outlook).
| [**Message extensions-search-based**](../messaging-extensions/how-to/search-commands/define-search-command.md)| `composeExtensions` | Web, Desktop, Mobile (iOS and Android)| Web (Targeted Release), Desktop (Beta Channel)| - |Action-based not yet supported for Microsoft 365. For more information, see [notes](extend-m365-teams-message-extension.md#troubleshooting). |
