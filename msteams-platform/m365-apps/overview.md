...
| [**Meeting apps**](extend-m365-meeting-app.md)|`configurableTabs`|Web, Desktop, Mobile|Desktop (preview)|-|Meeting stage view not supported in Outlook. See [notes](extend-m365-meeting-app.md).|
