...
> [!NOTE]
> Apps with manifest version below 1.13 are exclusive to Teams. However, for those with manifest version of 1.13 or higher, compatibility extends to Outlook, Microsoft 365 App, and Teams.
