...
| [**Meeting apps**](extend-m365-meeting-app.md)|`configurableTabs`|Web, Desktop, Mobile|Desktop (preview)|-|Stage view not supported. See [notes](extend-m365-meeting-app.md).|
