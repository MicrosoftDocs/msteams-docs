...
1. Go to the local folder and open *configuration-Office365-x86.xml* (or **x64.xml*, depending on your environment) in a text editor. Ensure the *Channel* value is set to the scenario you are previewing for, refer to the table below for guidance.
