...
You also need to enable app upload for your tenant:
 ...
 1. Under Custom apps, turn on the **Interaction with custom apps** toggle and **Save**.
    ...
    :::image type="content" source="images/teams-admin-enable-sideloading.png" alt-text="The screenshot is an example that enables uploading for custom apps from the Teams Admin Center":::
