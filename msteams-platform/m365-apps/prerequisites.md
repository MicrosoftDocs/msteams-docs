...
[[Sideloading is enabled for your tenant if you see the option to 'Upload a custom app' from the Teams 'Apps' pane](~/m365-apps/images/teams-sideloading-enabled.png)](~/m365-apps/images/teams-sideloading-enabled.png#lightbox)
...
1. Under the Organization profile tab, Go to the [Organizational profile](https://admin.microsoft.com/AdminPortal/Home?#/Settings/OrganizationProfile).
...
[[Microsoft 365 admin center 'Release preferences' menu with Targeted release option selected](~/m365-apps/images/m365-admin-center-targeted-releases.png)](~/m365-apps/images/m365-admin-center-targeted-releases.png#lightbox)
...
[[Ellipses '...' entry point to sideloaded Teams tab apps in outlook.com](~/m365-apps/images/outlook-web-ellipses.png)](~/m365-apps/images/outlook-web-ellipses.png#lightbox)
...
1.	At the upper right, turn on the **Coming Soon** toggle.
  ...
  [[Coming Soon' button in Outlook desktop toggled to 'On'](~/m365-apps/images/outlook-coming-soon.png)](~/m365-apps/images/outlook-coming-soon.png#lightbox)

* To verify if your tenant has support for Teams personal tabs running on office.com and outlook.com, sign in to Microsoft 365 admin center with your test tenant credentials and check for ellipses (**...**) option on the lower left pane.
* To verify test tenant support for messaging extensions in outlook.com, check for **More apps** option in the Outlook compose message area.

[[Ellipses '...' entry point to sideloaded Teams tab apps in Outlook for desktop](~/m365-apps/images/outlook-desktop-ellipses.png)](~/m365-apps/images/outlook-desktop-ellipses.png#lightbox)
...
[[From Teams ellipses menu, open 'About' and verify 'Developer Preview](~/m365-apps/images/teams-dev-preview.png)](~/m365-apps/images/teams-dev-preview.png#lightbox)
