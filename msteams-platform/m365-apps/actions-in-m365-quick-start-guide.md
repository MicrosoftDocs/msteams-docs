...
Let's learn how to build and run a sample app in your local environment. You'll use Teams Toolkit for Visual Studio Code to setup and upload the application to your tenant. Let’s get started!
