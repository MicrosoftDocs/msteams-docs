...
1. Select your app icon to launch your app in the Microsoft 365 app.
    ...
    :::image type="content" source="images/office-mobile-apps.png" alt-text="Screenshot shows the Apps option on the side bar of the Microsoft 365 app to see your installed personal tabs.":::
...
1. Find the `Microsoft Teams Tab` with your tab URL and select **inspect** to start debugging your app with DevTools.
    ...
    :::image type="content" source="images/office-android-debug.png" alt-text="Screenshot shows the list of webviews in devtool.":::
