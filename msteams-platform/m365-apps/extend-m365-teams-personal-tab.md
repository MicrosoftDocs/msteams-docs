...
description: In this learning path, you'll learn how to extend a Teams personal tab app across Microsoft 365 by updating personal tab to run in both outlook and office.
ms.date: 05/24/2022
ms.topic: tutorial
ms.custom: m365apps
