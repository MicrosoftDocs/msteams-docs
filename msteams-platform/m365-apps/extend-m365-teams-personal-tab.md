...
description: Update your personal app to run in Outlook and Office. Update manifest and TeamsJS SDK, amend consent security, update Azure AD app registration for SSO, and sideload. 
ms.date: 05/24/2022
ms.topic: tutorial
ms.custom: m365apps
