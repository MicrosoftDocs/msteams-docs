...
> [!NOTE]
> This article is applicable only to Teams Toolkit version 5. For information about Teams Toolkit version 4 capabilities, see[Add capability](toolkit-v4/add-capability-v4.md).
