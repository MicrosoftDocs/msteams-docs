...
|--------|-------------|
| Tabs |  Tab are Teams-aware webpages embedded in Microsoft Teams. They are simple HTML tags that point to domains declared in the app manifest and can be added as part of a channel inside a team, group chat, or personal app for an individual user. |
...
## Build a Teams app
Build a Teams app from the beginning or see samples to help you quickly get started with the basic Teams app concepts and code structures. Before you begin with creating your first Teams app, you must install a few tools and set up your development environment.
...
- [M365](https://developer.microsoft.com/en-us/microsoft-365/dev-program)
...
To sign in into M365 and Azure accounts, See [Sign in to your Microsoft 365 and Azure accounts](../get-started/prerequisites.md#sign-in-to-your-microsoft-365-and-azure-accounts) 
