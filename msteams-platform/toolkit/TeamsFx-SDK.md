...
`TeamsBotSsoPrompt` integrates with the Microsoft 365 Agents SDK (previously known as Bot Framework SDK). It simplifies the authentication process when you develop bot application and want to use the bot SSO.
