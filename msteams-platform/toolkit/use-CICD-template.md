...
* Secret: The Microsoft 365 Agents Toolkit CLI supports sign-in using a service principal with a secret. For more information, see how to [create a new client secret](/entra/identity-platform/howto-create-service-principal-portal).
