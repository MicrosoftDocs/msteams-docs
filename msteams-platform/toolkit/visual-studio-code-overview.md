...
- [Azure Functions Core Tools](https://docs.microsoft.com/en-us/microsoftteams/platform/get-started/code-samples)
...
- [.NET SDK](https://docs.microsoft.com/en-us/microsoftteams/platform/get-started/code-samples)
