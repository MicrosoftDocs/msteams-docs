...
1. Enter your Project and Solution name then select **Create**.
...
* Users don't have to provide consent again in another device as they're signed in automatically, while using your app.
