...
# It contains mock data for testing  Microsoft 365 Agents SDK (previously known as Bot Framework SDK) APIs or Bot Builder SDK methods such as TeamsInfo.getTeamMembers().
