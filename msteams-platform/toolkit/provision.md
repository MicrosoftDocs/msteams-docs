...
**aadApp/update**
**What it is**
This action will update your Azure Active Directory (AAD) application based on give AAD app manifest. It will refer the id property in AAD app manifest to determine which AAD app to update.
...
**botAadApp/create**
**What it is**
This action will create a new or reuse an existing Azure Active Directory (AAD) application for bot.
...
- uses: arm/deploy
    with:
      ...
      # Reqired. The ARM templates to be deployed.
      templates:
...
* *Add below environment variables and their values to env\.env.{env} file
...
* *If your application requires an Azure AD app client secret, add below environment variable and its value to env\.env.{env}.user file
...
**Add below environment variable and its value to env\.env.{env} file**
