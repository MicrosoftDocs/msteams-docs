...
> [!NOTE]
> Add configuration in .vscode or tasks.json files, as projects generated through Teams Toolkit has pre-defined set of Visual Studio Code tasks in .vscode or tasks.json files. These tasks are for debugging which are generated by Teams Toolkit 4.1.0 and so on.
