...
Visual Studio code allows you to create a new Teams app using Teams Toolkit. After installing Teams Toolkit extension, you will see the Teams Toolkit icon in the sidebar :::image type="icon" source="../assets/images/teams-toolkit-v2/manual/toolkit-icon.png" border="false":::. Select any one of the following options:
...
:::image type="content" source="../assets/images/teams-toolkit-v2/manual/view-samples.png" alt-text="View sample":::
