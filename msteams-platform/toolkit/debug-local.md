...
author: surbhigupta 
description: Learn how to set up Teams Toolkit to debug Teams app in Visual Studio Code, and know about the debug process, dev tunnel, and debug configurations. 
