...
author: MuyangAmigo
description: Learn how to add API connection in Teams toolkit, to allow bootstrap sample access to existing APIs, and the list of different authentication types.
ms.author: zhany
