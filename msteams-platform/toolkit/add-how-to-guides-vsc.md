...
author: surbhigupta
description: Learn about the How-to guides from Microsoft 365 Agents Toolkit for Visual Studio Code to configure tab, bot, message extension, and Outlook add-in capabilities.
