...
| Reuse existing Microsoft Azure Active Directory (Azure AD) app for Teams app | <ul> <li>`auth` section in`.fx/config.<envName>.json`.</li> </ul> |  [Use an existing Microsoft Azure Active Directory (Azure AD) app for your Teams app](provision.md#use-an-existing-azure-ad-app-for-your-teams-app). |
| Reuse existing Microsoft Azure Active Directory (Azure AD) app for bot | <ul> <li>`bot` section in`.fx/config.<envName>.json`.</li> </ul> | [Use an existing Microsoft Azure Active Directory (Azure AD) app for your bot](provision.md#use-an-existing-azure-ad-app-for-your-bot). |
