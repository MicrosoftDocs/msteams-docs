...
1. Select **OK**.
   ...
   :::image type="content" source="../assets/images/teams-toolkit-v2/teams-toolkit-v5/vs-localdebug-disable-deploy.png" alt-text="Screenshot shows the uncheck deploy in configuration properties." lightbox="../assets/images/teams-toolkit-v2/teams-toolkit-v5/vs-localdebug-disable-deploy.png":::
