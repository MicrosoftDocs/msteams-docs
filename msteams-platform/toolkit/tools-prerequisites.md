...
* **Microsoft account for personal use**
  ...
  :::row:::
    ...
    :::column-end:::
    :::column span="1":::
             :::image type="content" source="../assets/images/toolkit-v2/teams toolkit fundamentals/personal-account-icon.png" alt-text="Screenshot shows the personal account icon.":::
   :::column-end:::
...
* **Microsoft work account for business**
  ...
  :::row:::
    ...
    :::column-end:::
    :::column span="1":::
             :::image type="content" source="../assets/images/toolkit-v2/teams toolkit fundamentals/work-account-icon.png" alt-text="Screenshot shows the work account icon.":::
    :::column-end:::
