...
An Azure account allows you to host a Teams app or the back-end resources for your Teams app to Azure. You can do this using Microsoft 365 Agents Toolkit for Visual Studio Code. You must have an Azure subscription in the following scenarios:
