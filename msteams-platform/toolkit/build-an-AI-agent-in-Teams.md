...
author: surbhigupta
description: Learn how to build AI Agent in Teams SDK using Assistants API within Microsoft 365 Agents Toolkit, customize prompt augmentation, and assistant creation.
ms.topic: conceptual
