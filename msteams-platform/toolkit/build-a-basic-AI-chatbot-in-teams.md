...
author: surbhigupta
description: Learn how to build a basic AI chatbot using Teams AI library in Teams Toolkit. Know about bot app source code, AI chatbot workflow, and customize AI chatbot.
ms.topic: conceptual
