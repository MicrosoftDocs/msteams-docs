...
:::row:::
   ...
   :::column span="":::
        ...
        * **Validate Application**: Validate if Teams app manifest file is in right schema or validate the Teams app package.
...
:::row:::
   ...
   :::column span="":::
       ...
       * **Create a new Teams app**: Use the Teams Toolkit wizard to prepare project scaffolding for app development.
        ...
        * **Edit manifest file**: Edit the app manifest file with the Teams client.
   :::column-end:::
:::row-end:::
