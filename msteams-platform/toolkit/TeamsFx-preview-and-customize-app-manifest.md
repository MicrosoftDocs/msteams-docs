...
* You can also upload zip app package from Solution Explorer, if you right-click on your project name under **Solution Explorer** and then select **Teams Toolkit** > **Zip App Package** > **For Local** or **For Azure**.
