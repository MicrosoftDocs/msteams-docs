...
author: surbhigupta
description: Learn how to edit and preview app manifest in local and remote environment, customize app manifest in Visual Studio Code, and ways to validate and update your app.
