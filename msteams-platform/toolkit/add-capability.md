...
|------------|------------------------|---------|
|Bot, message extension and tab| &nbsp; |&nbsp; |
| &nbsp; |Includes a **hello world** bot or tab application template into your project.|A frontend bot or tab template code is added into a subfolder with path `yourProjectFolder/bot` or `yourProjectFolder/tab` respectively.|
