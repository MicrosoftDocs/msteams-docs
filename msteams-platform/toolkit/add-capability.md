...
| |<ul><li>The ID of your bot.</li><li>The scopes of your bot.</li><li>The commands that hello world bot application can respond to.</li></ul> |
...
| |<ul><li>The configurable and static tabs.</li><li>The scopes of the tabs.</li></ul> |
