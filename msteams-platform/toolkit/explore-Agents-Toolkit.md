...
<summary><b>Select to view a video to learn about the process of creating a new Teams app:</b></summary>
   ...
   :::image type="content" source="../assets/videos/agent.gif" alt-text="Graphical representation shows the steps to create an agent." lightbox="../assets/videos/agent.gif":::
</details>
