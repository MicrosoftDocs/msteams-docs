...
1. [Create tab app using Microsoft Teams Toolkit](#create-message-extension-app-using-microsoft-teams-toolkit)
...
1. [Setup local debug environment (1)](#setup-local-debug-environment-1)
