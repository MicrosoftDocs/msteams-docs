...
:::image type="content" source="../assets/images/toolkit-v2/teams toolkit fundamentals/teams-toolkit-user-journey2.png" alt-text="Illustration shows the User Journey of the Teams Toolkit." lightbox="../assets/images/toolkit-v2/teams toolkit fundamentals/teams-toolkit-user-journey2.png":::
...
:::image type="content" source="../assets/images/toolkit-v2/teams toolkit fundamentals/create-new-app_2.png" alt-text="Screenshot shows the list of new Teams app menu to create in Visual Studio Code.":::
