...
TeamsFx integrates with Azure services that are common for the following application scenarios:
...
|Resources Added|Changes|Why these changes are made|
|---------------|---------------|-----------------------------|
...
- You can't add cloud resource more than once
