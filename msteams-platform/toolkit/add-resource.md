...
Microsoft 365 Agents Toolkit enables you to provision cloud resources for hosting your app, tailored to your development needs. By adding more cloud resources in TeamsFx, you can autogenerate all configuration files and seamlessly connect to the Teams app using Microsoft 365 Agents Toolkit. Additionally, Microsoft 365 Agents Toolkit allows you to access and use existing APIs, whether developed by your organization or a third party, for building Teams apps.
...
### To add cloud resources using Microsoft 365 Agents Toolkit
