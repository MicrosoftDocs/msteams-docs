...
1. Select **Project** > **Teams Toolkit** > **Provision in the Cloud**.
   ...
   :::image type="content" source="../../assets/images/toolkit-v2/teams-toolkit-vs/teams-toolkit-vs-provision-in-cloud.png" alt-text="Screenshot shows sign in to Azure account.":::

1. Select **Sign in...**.

   :::image type="content" source="../../assets/images/toolkit-v2/teams-toolkit-vs/teams-toolkit-vs-provision-start.png" alt-text="Screenshot shows the sign in to Azure account.":::
...
1. Select **Project** > **Teams Toolkit** > **Provision in the Cloud...**.
   ...
   :::image type="content" source="../../assets/images/toolkit-v2/teams-toolkit-vs/teams-toolkit-vs-provision-in-cloud.png" alt-text="Screenshot shows how to provision in cloud.":::
...
1. Enter the following details to provision your resources:
   ...
   :::image type="content" source="../../assets/images/toolkit-v2/teams-toolkit-vs/teams-toolkit-vs-provision-select-subscription.png" alt-text="Screenshot shows the selection of resource group." lightbox="../../assets/images/toolkit-v2/teams-toolkit-vs/teams-toolkit-vs-provision-select-subscription.png":::

1. In the pop-up window that appears, select **Provision**.

   :::image type="content" source="../../assets/images/toolkit-v2/teams-toolkit-vs/teams-toolkit-vs-provision-warning.png" alt-text="Screenshot shows the provision warning.":::
...
1. In the pop-up window that appears, to view all the resources that are provisioned, select **View provisioned resources**.
   ...
   :::image type="content" source="../../assets/images/toolkit-v2/teams-toolkit-vs/teams-toolkit-vs-provision-provision-success-info.png" alt-text="Screenshot shows the provisioned resources.":::
