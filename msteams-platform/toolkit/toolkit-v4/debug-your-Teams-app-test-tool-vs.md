...
1. The `appsettings.Playground.json` file helps to configure the Test Tool by updating few parameters. To update `appsettings.Playground.json` file, follow either OpenAI or Azure OpenAI steps:
