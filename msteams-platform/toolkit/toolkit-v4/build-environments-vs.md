...
author: surbhigupta
description: Learn about build environments such as C# and Blazor of Microsoft 365 Agents Toolkit in Visual Studio to integrate Azure capabilities and cloud services.
...
# Prepare to build apps using Microsoft 365 Agents Toolkit in Visual Studio
...
Use Microsoft 365 Agents Toolkit in Visual Studio to create a Teams app using C# using the Blazor framework. You can create tab app, bot app, and message extension app in a C# build environment.
