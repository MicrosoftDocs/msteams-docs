...
1. Select **Project** > **Teams Toolkit** > **Add Authentication Code**.
    ...
    :::image type="content" source="../../assets/images/toolkit-v2/teams-toolkit-vs/vs-add-authentication-code.PNG" alt-text="Screenshot shows the option to add authentication code.":::
