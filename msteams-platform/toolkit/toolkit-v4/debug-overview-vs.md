...
* Start debugging: Perform debugging with a single operation, press **F5** to start debugging. Agents Toolkit builds code, starts services, and launches the app in your browser.

* Toggle breakpoints: Toggle breakpoints in the source code of tabs, bots, message extensions, and Azure Functions. The breakpoints execute when you interact with Teams app in your web browser.

  The following image shows the toggle breakpoints:
![Screenshot shows the local debug toggle breakpoints.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/toolkit-v2/toolkit-vs/vs-localdebug-toggle-breakpoint.png)
...
![Screenshot shows the select hot reload icon.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/toolkit-v2/toolkit-vs/vs-localdebug-hot-reload.png)
To enable auto Hot Reload, select **Hot Reload on File Save** from the dropdown.
![Screenshot shows the select hot reload on file save.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/toolkit-v2/toolkit-vs/vs-localdebug-hot-reload-filesave.png)
> [!Tip]
...
* Stop debugging: Select **Stop Debugging (Shift+F5)** after local debug is completed.
![Screenshot shows the select stop debug icon.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/toolkit-v2/toolkit-vs/vs-localdebug-Stopdebug.png)

### Add environment variables

Add the `environmentVariables` to the `launchSettings.json` file.

![Screenshot shows the add custom environment variables.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/toolkit-v2/toolkit-vs/vs-localdebug-environment-variables.png)
...
![Screenshot shows the launch teams as a web app by removing launchurl.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/toolkit-v2/toolkit-vs/vs-localdebug-launch-teamsapp-webapp.png)

1. Right-click on **Solution** (in this scenario the project name is M365Agents) and select **Properties**.
![Screenshot shows the right click solution and select properties.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/toolkit-v2/toolkit-vs/vs-localdebug-solution-properties.png)
...
1. Select **OK**.
![Screenshot shows the uncheck deploy in configuration properties.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/toolkit-v2/toolkit-vs/vs-localdebug-disable-deploy.png)
