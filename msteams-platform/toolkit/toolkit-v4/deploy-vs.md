...
1. Select **Project** > **Teams Toolkit** > **Deploy to the Cloud**.
      ...
      :::image type="content" source="../../assets/images/toolkit-v2/teams-toolkit-vs/deploy-to-the-cloud-button.png" alt-text="Screenshot shows steps to deploy to the cloud.":::

1. In the pop-up window that appears, select **Deploy**.

      :::image type="content" source="../../assets/images/toolkit-v2/teams-toolkit-vs/deploy_warning.png" alt-text="Screenshot shows deploy warning window.":::
