...
| **Bot** |  Bots help to interact with your web service through text, interactive cards, and dialogs (referred as task modules in TeamsJS v.1.0).|Basic message extension, SSO-enabled tab, and basic tab|
