...
> [!NOTE]
> Teams app builds with the SharePoint Framework and Teams Toolkit and doesn't directly integrate with Azure, the doc contents don't apply to SPFx-based apps.
