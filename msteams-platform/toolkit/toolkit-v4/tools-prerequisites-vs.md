...
1. In the Teams client, select **Apps** > **Manage your apps** > **Upload an app**.
    ...
    :::image type="content" source="../../assets/images/toolkit-v2/teams-toolkit-vs/upload-app.png" alt-text="Screenshot shows the option to select upload an app in Teams manage your apps.":::

1. Check if you can see the option **Upload a custom app** as you can see in the following image:

    :::image type="content" source="../../assets/images/toolkit-v2/teams-toolkit-vs/upload-custom-app.png" alt-text="Screenshot shows the option to select upload a custom apps.":::
