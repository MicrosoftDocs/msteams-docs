...
author: surbhigupta
description: Learn how to customize and preview the app manifest in different environments in Teams Toolkit for Visual Studio, and sync local changes in Developer Portal.
