...
You can either upload your app for local, or deploy for Azure to preview the app manifest file. You can preview the app manifest file by performing the following steps:
