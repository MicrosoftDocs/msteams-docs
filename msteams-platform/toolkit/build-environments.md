...
|---|---|---|
| >5.14.0 | SPFx <br> <br> Non-SPFx | Support depends on the user's SPFx version [See compatibility](/sharepoint/dev/spfx/compatibility)<br> 18, 20, 22 |
| 5.12.* | SPFx <br> <br> Non-SPFx | Support depends on the user's SPFx version [See compatibility](/sharepoint/dev/spfx/compatibility)<br> 18, 20 |
