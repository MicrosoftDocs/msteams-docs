...
:::image type="content" source="../assets/images/toolkit-v2/build-apps-ttk-vsc.png" alt-text="Illustration shows the steps to prepare to build apps using Teams Toolkit." lightbox="../assets/images/toolkit-v2/build-apps-ttk-vsc.png":::
