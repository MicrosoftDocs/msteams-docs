...
author: surbhigupta
description: Learn about build environments such as SPFx of Microsoft 365 Agents Toolkit for Visual Studio Code. Toolkit integrates Azure Functions capabilities for building apps.
...
Microsoft 365 Agents Toolkit for Visual Studio Code supports building the following apps using JavaScript or TypeScript:
...
Microsoft 365 Agents Toolkit for Visual Studio Code allows you to create tab apps using SPFx. These apps have the following advantages:
