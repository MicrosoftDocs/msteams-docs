...
author: zyxiaoyuer
description: In this module, learn how to publish Teams apps using Teams Toolkit and publish to individual scope or app upload permission.
...
* [Publish to individual scope or app upload permission](#publish-to-individual-scope-or-app-upload-permission)
