...
1. You can publish your Teams app in one of the following ways:
     ...
     * Select **View** > **Command Palette...** > **Teams: Publish to Organization**.
       ...
       :::image type="content" source="../assets/images/toolkit-v2/toolkit-fundamentals/select-publish_1.png" alt-text="Screenshot shows the Publish option highlighted." lightbox="../assets/images/teams-toolkit-v2/teams toolkit fundamentals/select-publish_1.png":::
