...
![Image](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/agents-toolkit-landing/agents-toolkit-scenarios.png)
...
| - | -|-|-|
| ![Image](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/agents-toolkit-landing/vscode.png)| Visual Studio Code | Agents Toolkit extension optimized for TypeScript and JavaScript development. | [Install Agents Toolkit for VS Code](install-teams-toolkit.md) |
| ![Image](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/agents-toolkit-landing/visual-studio.png) | Visual Studio | Agents Toolkit workload optimized for .NET development. | [Install Agents Toolkit for Visual Studio](toolkit-v4/install-teams-toolkit-vs.md) |
| ![Image](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/agents-toolkit-landing/terminal.png) | CLI | Text-based interface to Agents Toolkit for the terminal or CI/CD processes.| [Agents Toolkit command line interface](teams-toolkit-cli.md) |
...
![Image](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/agents-toolkit-landing/agents-channels.png)
...
![Image](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/agents-toolkit-landing/agents-playground.png)
