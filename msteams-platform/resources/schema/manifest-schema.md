...
|`scopes`|array of enums|3|✔️| Static tabs support `personal` and `groupChat` scopes, which means it can be provisioned as part of the personal and group chat experience.|
