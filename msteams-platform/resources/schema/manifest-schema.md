...
|`botId`|String|||The unique Microsoft app ID for the bot that backs the message extension, as registered with the Agents SDK. The ID can be the same as the overall App ID.|
...
|Name| Type| Maximum size | Required | Description|
|---|---|---|---|---|
|`botId`| String | | | The unique Microsoft app ID for the bot as registered with the Agents SDK. ID must be a GUID.|
