...
* **RSC delegated permissions for a team**
    ...
    |`LiveShareSession.ReadWrite.Group`|Allows the app to create and synchronize Live Share sessions for the team and its associated meetings. It also provides access to information related to the meeting's roster, such as the user roles in meeting, on behalf of the signed-in user.|
...
* **RSC delegated permissions for chats or meetings**
    ...
    |`LiveShareSession.ReadWrite.Chat`|Allows the app to create and synchronize Live Share sessions for the chat and its associated meetings. It also provides access to information related to the meeting's roster, such as the user roles in meeting, on behalf of the signed-in user.|
