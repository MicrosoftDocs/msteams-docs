...
> [!NOTE]
> The bot application doesn't support in the mobile client when the manifest contains empty `commandLists`.
...
> [!NOTE]
> The `supportsAnonymousGuestUsers` property in the app manifest schema v1.16 is supported only in [new Teams client](../teams-updates.md).
