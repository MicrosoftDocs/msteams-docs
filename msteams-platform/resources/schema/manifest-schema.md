...
|`tabs.label`| String | 64 characters | | Specifies the text displayed for the tab.<br>**Recommendation**: Although the maximum length is 64 characters, to ensure that the tab fits correctly in the ribbon, it's a good practice to limit the label to 16 characters.|
...
|`tabs.groups.label`| String | 64 characters | | Specifies the text displayed for the group.<br>**Recommendation**: Although the maximum length is 64 characters, to ensure that the group of controls fits correctly in the ribbon, it's a good practice to limit the label to 16 characters.|
...
|`tabs.groups.controls.label`| String | 64 characters | ✔️ | Specifies the text displayed for the control.<br>**Recommendation**: Although the maximum length is 64 characters, to ensure that the control fits correctly in the ribbon, it's a good practice to limit the label to 16 characters.|
...
|`tabs.customMobileRibbonGroups`| Array | 10 | | Defines groups of controls on the default tab of the ribbon on a mobile device. This array property can only be present on tab objects that have a `tabs.builtinTabId` property that is set to "DefaultTab". For non-mobile devices, see `tabs.groups`.|
