...
|`samplePrompts`|array|5 |No|Property used by Copilot to display prompts supported by the plugin to the user.<br>**Note:** Sample prompts feature will be available soon in Copilot for Microsoft 365.|
