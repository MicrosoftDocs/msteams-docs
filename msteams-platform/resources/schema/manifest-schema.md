...
The app manifest (previously called Teams app manifest) describes how your app integrates into the Microsoft Teams product. Your app manifest must conform to the schema hosted at [https://developer.microsoft.com/json-schemas/teams/v1.22/MicrosoftTeams.schema.json](https://developer.microsoft.com/json-schemas/teams/v1.21/MicrosoftTeams.schema.json). Previous versions 1.0, 1.1,...,1.21, and the current version is 1.22 are each supported (using "v1.x" in the URL). Version 1.18 is not available.
