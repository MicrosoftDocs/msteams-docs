...
To support Microsoft Teams apps, we made significant changes in our manifest. If you've already built your app on the [v0.4 manifest](~/msteams-platform/resources/schema/manifest-schema-v04), here are a few tips to help in conversion:
...
| `tabs:description` | `description` | Use your existing tab description or create new ones to represent your entire app experience. |
| `tabs:icons` | `icons` | Icons have been promoted to a top-level object. Note that [icons have been changed in v1.x](~/msteams-platform/concepts/apps/apps-package#icons), and must be included as part of the package. URLs to hosted icons are not allowed. |
