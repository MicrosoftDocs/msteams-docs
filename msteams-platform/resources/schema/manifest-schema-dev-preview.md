...
|`scopes`|Array of enum|1|✔️|Currently, static tabs support only the `personal` and `groupChat` scopes, which means it can be provisioned only as part of the personal and group chat experience.|
