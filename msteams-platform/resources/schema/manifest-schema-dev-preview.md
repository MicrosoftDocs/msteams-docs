...
|`customFunctions`| Object | | | Custom functions enable developers to add new functions to Excel by defining those functions in JavaScript as part of an add-in. Users within Excel can access custom functions just as they would access any native function in Excel, such as **SUM**. |
