...
|`fixedControls.enabled`| Boolean | | ✔️ | This property must be specified in the `fixedControls` object, but it does not affect the functionality of the spam-reporting add-in. <br>Default value: `True` |
