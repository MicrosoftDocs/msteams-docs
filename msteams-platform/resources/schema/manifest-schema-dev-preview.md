...
|`alternateIcons`| Object | | ✔️ | Specifies the main icons that are used to represent the in-market add-in in the insertion UX, AppSource, and the vertical task pane tab bar. |
|`alternateIcons.icon`| String | 2048 | ✔️ | Specifies the full, absolute URL of the image file that is used to represent the add-in. |
|`alternateIcons.highResolutionIcon`| String | 2048 | ✔️ | Specifies the full, absolute URL of the image file that is used to represent the add-in on high DPI screens. |
