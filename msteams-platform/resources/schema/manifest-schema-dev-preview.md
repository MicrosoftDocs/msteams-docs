...
|`customFunctions.functions.id`| String | 64 characters | ✔️ | Specifies a unique ID for the function. This ID can only contain alphanumeric characters and periods and shouldn't be changed after it's set. It must start with a letter and have a minimum of three characters. Use uppercase letters as a best practice. |
