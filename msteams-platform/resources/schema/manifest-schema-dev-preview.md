...
|`requirements.capabilities`| Array | | | Do not use when the grandparent is a content runtime object. |
...
|`requirements.formFactors`| Array of enums | | | Do not use when the grandparent is a content runtime object. |
