...
description: Learn about public developer preview manifest schema for Microsoft Teams, the sample and schema properties, and how to enable the developer preview.
ms.topic: reference
