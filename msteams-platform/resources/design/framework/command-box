...
![Command suggestions](~/assets/images/Command box-cmd suggestions.png)
...
![Command box app state](~/assets/images/Command box-app state.png)
...
![Drop-down active state](~/assets/images/Command box-active state.png)
