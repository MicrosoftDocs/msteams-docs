...
:::image type="content" source="../assets/images/tabs/remove-margins-tabs.png" alt-text="The screenshot is an examples that shows the tab with and without margins.":::
