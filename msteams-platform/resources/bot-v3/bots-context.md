...
Your bot can query for the list of team members and their basic profiles. The basic profiles include Teams user IDs and Azure Active Directory information such as name and object ID. You can use this information to correlate user identities. For example, check if a user logged into a tab through Azure AD credentials is a team member.
