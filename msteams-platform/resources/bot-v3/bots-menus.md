...
description: In this module, learn how to add a bot menu in Microsoft Teams and create menus for bots in Microsoft Teams and its support on Teams mobile app.
ms.topic: how-to
