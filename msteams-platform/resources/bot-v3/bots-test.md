...
Complete instructions on the  Microsoft 365 Agents SDK (previously known as Bot Framework SDK) Emulator can be found [here](/azure/bot-service/bot-service-debug-emulator?view=azure-bot-service-4.0&preserve-view=true).
