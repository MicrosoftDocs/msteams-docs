...
> [!NOTE]
> When a bot app is added to a team and is later blocked for the team owner, it no longer receives conversation update events if the owner removes a user from the team.
