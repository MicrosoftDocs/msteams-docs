...
> [!NOTE]
> If a bot app is added to a team and later blocked for the team owner, it will not receive conversation update events when the team owner removes a user from the team.
