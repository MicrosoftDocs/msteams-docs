...
> [!NOTE]
> If a bot is added to a team and later blocked for the team owner by tenant admin, it doesn't receive conversation update events when the owner removes a user from the team.
