...
> [!NOTE]
> If a bot is added to a team and later blocked for the team owner in the Teams admin center, it doesn't receive conversation update events when the team owner removes a user from the team.
