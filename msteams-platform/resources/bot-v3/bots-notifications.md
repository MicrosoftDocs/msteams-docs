...
> [!NOTE]
> If a bot is added to a team and later becomes blocked for the team owner, it no longer receives conversation update events when the owner removes a user from the team.
