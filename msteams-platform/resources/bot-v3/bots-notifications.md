...
> [!NOTE]
> A bot that is blocked for the team owner doesn't get conversation update events (notifications about team membership changes) when the owner removes a user from the team.
