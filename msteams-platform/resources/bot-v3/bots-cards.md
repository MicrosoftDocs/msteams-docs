...
A *card* is a user-interface (UI) container for short or related pieces of information. Cards can have multiple properties and attachments. Teams support cards in bots, connectors and messaging extensions. See [Cards](~/task-modules-and-cards/cards/cards.md) for an overview of what cards are and how Teams uses them.
