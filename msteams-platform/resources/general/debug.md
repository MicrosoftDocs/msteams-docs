...
> [!NOTE]
> To update the messaging endpoint for a bot, you must use the Bot Framework &ndash; click on your bot in [your list of bots in Bot Framework](https://dev.botframework.com/bots)). However, be aware that if you haven't already done so, you must first *migrate* your bot's registration to Microsoft Azure. [More information on this temporary limitation is here](~/concepts/bots/bots-create#bots-and-microsoft-azure).
