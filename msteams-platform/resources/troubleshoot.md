...
> [!NOTE]
> A blank tab appears when the given tab URL redirects to sign-in screen. Sign-in pages don’t render in iFrames as a safeguard against clickjacking. Your authentication logic must use a method other than redirect.
