...
:::image type="content" source="~/assets/images/compose-extensions/compose-extension-settings-menu-item.png" alt-text="The screenshot is an examples that shows the locations of Settings menu item.":::
...
:::image type="content" source="~/assets/images/compose-extensions/messagingextensions_linkunfurling.png" alt-text="The screenshot is an examples that shows the link unfurling.":::
