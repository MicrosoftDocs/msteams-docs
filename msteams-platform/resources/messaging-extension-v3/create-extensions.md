...
description: Learn how to create and configure action-based message extensions for Microsoft Teams using Agents SDK to allow users to trigger external services.
