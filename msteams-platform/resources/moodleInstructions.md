...
1. On the **Teams Settings** page, configure the required settings to enable the Teams app integration. Clicking the **Check Moodle settings** link updates all required configurations for the Teams integration to work.
