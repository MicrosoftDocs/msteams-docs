...
Microsoft 365 Teams theme plugins displays a custom view of Moodle course home page within Teams and is available when users access their Moodle courses within Teams.
