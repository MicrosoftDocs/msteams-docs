...
The Teams Platform documentation aims to support application development by presenting platform features and implementation guidance mainly in terms of Teams SDK's API and tools.
...
* **Microsoft 365 Copilot compatibility** - Agents built with Teams SDK can be used from both Microsoft 365 Copilot and Teams.
