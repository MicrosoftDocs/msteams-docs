...
description: Learn how to integrate with Microsoft 365 Copilot through message extensions, Graph connectors, agents, and connect external data sources.
...
You can extend Microsoft 365 Copilot by building a agent or by connecting to an external data source.

## What is an agent?

Agent allows Copilot to interact directly with third-party data, apps, and services, enhancing its capabilities and broadening its range of capabilities.
Agent allow Copilot to:

* Retrieve real-time information, for example, latest news coverage on a product launch.
* Retrieve knowledge-based information, for example, my team’s design files in Figma.
* Perform actions on behalf of the user, for example, create a Jira ticket.

## How do I build a agent?

> [!NOTE]
> Agents for Microsoft 365 Copilot are in early access preview.

If you already have a Teams message extension, then you already have a agent that works with Copilot. If not, create a [message extension using the Teams Toolkit](~/messaging-extensions/what-are-messaging-extensions.md).

**Scenario 1: I want to create a new agent from an existing API or OpenAI plugin**
...
3. Update your manifest with agent metadata such as name, publisher, APIs used.
4. Optional: If you want your agent to return an Adaptive Card, provide an Adaptive Card template and reference the template in the manifest.
5. Test your agent.
6. Preview and publish your agent.

**Scenario 2: I want to build a agent from an existing Microsoft 365 message extension**

Your Message Extension will work with Copilot (after quality testing).

## What makes a good agent for Microsoft 365 Copilot?

To ensure your agent works as intended, it's important to include good descriptions in your manifest. This allows the underlying LLM to take full advantage of your agent’s capabilities. It’s recommended to test different descriptions and instructions to find the most effective way for the LLM to utilize your agent. Also, it’s important that the manifest file is up to date with any changes or enhancements you make to your agent.
...
3. Adaptive Card responses: By incorporating Adaptive Cards into your agent’s response, you can enhance the user experience by providing more dynamic, actionable content within the responses and references, allowing users to interact more effectively with the information provided.

4. Including links in agent response: Including links within your skill’s response serves multiple purposes:
...
5. Deep Content Retrieval: To further enhance your agent’s functionality, it’s recommended that your API supports deep content retrieval scenarios that can be leveraged by the LLMs to obtain grounding data. This involves enabling Copilot to send targeted requests, such as limiting a search to a specific date range, to your API for particular tasks and queries.

## Upgrading your agent to a rich conversational Teams app  

When you connect your API to Teams, you've built a simple, powerful Microsoft 365 Copilot agent. Teams makes it easier and helps you enhance this experience by adding rich conversational components. In addition to your agent, you can use Teams Toolkit to add a bot to your manifest file. Developing a bot has never been easier with the release of the new [Teams AI library](../bots/how-to/teams-conversational-ai/teams-conversation-ai-overview.md). By bot, your agent becomes a full conversational Teams app, allowing you to develop link unfurling experiences, message extensions, message actions, search bar actions, and end-to-end conversational bots.
