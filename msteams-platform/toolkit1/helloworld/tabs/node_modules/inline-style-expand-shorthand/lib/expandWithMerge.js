...
exports["default"] = expandWithMerge;

var _expandProperty = _interopRequireDefault(require("./expandProperty"));
  ...
  try {
    for (var _iterator = sortedKeys[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      if (typeof value === 'string' || typeof value === 'number') {
        var expansion = (0, _expandProperty["default"])(property, value);
