...
exports.getDocument = exports.HIDDEN_FROM_ACC_TREE = exports.FOCUSZONE_SUB_ATTRIBUTE = exports.FOCUSZONE_ID_ATTRIBUTE = exports.IS_VISIBLE_ATTRIBUTE = void 0;

var _accessibility = require("@fluentui/accessibility");

var _utilities = require("@uifabric/utilities");

exports.getParent = _utilities.getParent;
exports.getWindow = _utilities.getWindow;
exports.getDocument = _utilities.getDocument;
...
exports.IS_VISIBLE_ATTRIBUTE = IS_VISIBLE_ATTRIBUTE;
var FOCUSZONE_ID_ATTRIBUTE = 'data-focuszone-id';
exports.FOCUSZONE_ID_ATTRIBUTE = FOCUSZONE_ID_ATTRIBUTE;
var FOCUSZONE_SUB_ATTRIBUTE = 'data-is-sub-focuszone';
exports.FOCUSZONE_SUB_ATTRIBUTE = FOCUSZONE_SUB_ATTRIBUTE;
var HIDDEN_FROM_ACC_TREE = 'data-is-hidden-from-acc-tree';
exports.HIDDEN_FROM_ACC_TREE = HIDDEN_FROM_ACC_TREE;
...
function isElementTabbable(element, checkTabIndex) {
  ...
  var isFocusableAttribute = element.getAttribute ? element.getAttribute(_accessibility.IS_FOCUSABLE_ATTRIBUTE) : null;
...
function focusAsync(element) {
  if (element) {
    ...
    targetToFocusOnNextRepaint = element;
    var win = (0, _utilities.getWindow)(element);
...
function getElementIndexPath(fromElement, toElement) {
  ...
  while (currentElement && fromElement && currentElement !== fromElement) {
    var parent = (0, _utilities.getParent)(currentElement, false);
