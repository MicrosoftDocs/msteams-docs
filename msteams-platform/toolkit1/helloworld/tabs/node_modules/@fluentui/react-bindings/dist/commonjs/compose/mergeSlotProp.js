...
function mergeSlotProp(slotProp, slotProps, mappedProp) {
  ...
  if (mappedProp === void 0) {
    mappedProp = 'children';
  }

  if (typeof slotProp === 'object' && ! /*#__PURE__*/React.isValidElement(slotProp)) {
    return Object.assign({}, slotProp, slotProps);
  }

  return Object.assign((_Object$assign = {}, _Object$assign[mappedProp] = slotProp, _Object$assign), slotProps);
}
