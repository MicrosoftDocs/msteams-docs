 ...
 */
var doesNodeContainClick = function doesNodeContainClick(node, e, // eslint-disable-next-line no-undef
target, allowVirtualParents) {
  ...
  if (e.target) {
    ...
    if (target.querySelector('[data-suir-click-target=true]')) {
      ...
      return (0, _domUtilities.elementContains)(node, e.target, allowVirtualParents);
    }
