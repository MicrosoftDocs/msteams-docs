...
var _getReactFiberFromNode = require("../getReactFiberFromNode");
...
function usePopperOptions(options, popperOriginalPositionRef) {
  ...
  var placement = (0, _positioningHelper.getPlacement)(options.align, options.position, options.rtl);
  var strategy = options.positionFixed ? 'fixed' : 'absolute';
  var handleStateUpdate = (0, _reactBindings.useEventCallback)(function (_ref) {
  ...
  var userModifiers = (0, _reactBindings.useDeepMemo)(function () {
    return options.modifiers;
  }, options.modifiers);
  return React.useCallback(function (target, container, arrow) {
    var scrollParentElement = (0, _getScrollParent.getScrollParent)(container);
    ...
    unstable_disableTether && {
      ...
      options: {
        altBoundary: true,
        boundary: (0, _getBoundary.getBoundary)(container, flipBoundary)
      }
    }, overflowBoundary && {
      name: 'preventOverflow',
      options: {
...
function usePopper(options) {
  ...
  var isFirstMount = (0, _reactBindings.useFirstMount)();
  ...
  var handlePopperUpdate = (0, _reactBindings.useEventCallback)(function () {
    ...
    if ((0, _isBrowser.isBrowser)() && enabled) {
  ...
  var targetRef = (0, _reactBindings.useCallbackRef)(null, handlePopperUpdate, true);
  var containerRef = (0, _reactBindings.useCallbackRef)(null, handlePopperUpdate, true);
  var arrowRef = (0, _reactBindings.useCallbackRef)(null, handlePopperUpdate, true);
