...
var setInput = function setInput(event) {
  ...
  if (!isBuffering) {
    ...
    if (currentInput !== value && shouldUpdate) {
      currentInput = value; // https://github.com/testing-library/user-event/issues/709
...
if ((0, _isBrowser.isBrowser)() && 'addEventListener' in window && Array.prototype.indexOf) {
  setUp();
}
/*
 * set up for document
...
var setUpWhatInput = function setUpWhatInput(target) {
  var targetWindow = target.defaultView;

  if ((0, _isBrowser.isBrowser)() && targetWindow && 'addEventListener' in targetWindow && Array.prototype.indexOf) {
...
var tryCleanupWhatInput = function tryCleanupWhatInput(target) {
  var targetWindow = target.defaultView;

  if ((0, _isBrowser.isBrowser)() && targetWindow && 'removeEventListener' in targetWindow) {
...
var setWhatInputSource = function setWhatInputSource(target, newInput) {
...
var isFromKeyboard = function isFromKeyboard() {
  return ask() === 'keyboard';
};
