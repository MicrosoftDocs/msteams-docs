...
import { getFirstTabbable, getLastTabbable, getFirstFocusable, getLastFocusable, getNextElement, getPreviousElement, focusAsync } from '@fluentui/react-bindings';
export declare const FocusZoneUtilities: {
    getFirstTabbable: typeof getFirstTabbable;
    getLastTabbable: typeof getLastTabbable;
    getFirstFocusable: typeof getFirstFocusable;
    getLastFocusable: typeof getLastFocusable;
    getNextElement: typeof getNextElement;
    getPreviousElement: typeof getPreviousElement;
    focusAsync: typeof focusAsync;
};
