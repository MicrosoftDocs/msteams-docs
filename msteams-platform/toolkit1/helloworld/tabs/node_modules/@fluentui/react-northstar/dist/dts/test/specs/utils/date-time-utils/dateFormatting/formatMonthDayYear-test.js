...
var DateGrid = require("../../../../../src/utils/date-time-utilities/dateFormatting/formatMonthDayYear");
var Months;
(function (Months) {
...
describe('formatMonthDayYear', function () {
    var date = new Date(2016, Months.Apr, 1);
    it('returns default format', function () {
        var result = DateGrid.formatMonthDayYear(date, strings);
