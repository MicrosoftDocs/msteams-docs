...
exports.menuVariables = void 0;
var menuVariables_1 = require("../../../teams/components/Menu/menuVariables");
var colorUtils_1 = require("../../../colorUtils");
var menuVariables = function (siteVars) { return ({
    colorScheme: colorUtils_1.pickValuesFromColorScheme(colorUtils_1.extendColorScheme(siteVars.colorScheme, {
        default: {
    ...
    }), menuVariables_1.menuColorAreas),
