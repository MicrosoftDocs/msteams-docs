...
exports.radioGroupItemVariables = void 0;
var utils_1 = require("../../../../utils");
var radioGroupItemVariables = function (siteVars) { return ({
    ...
    padding: "0 " + utils_1.pxToRem(2),
    margin: utils_1.pxToRem(5) + " " + utils_1.pxToRem(8) + " " + utils_1.pxToRem(5) + " " + utils_1.pxToRem(2),
}); };
exports.radioGroupItemVariables = radioGroupItemVariables;
