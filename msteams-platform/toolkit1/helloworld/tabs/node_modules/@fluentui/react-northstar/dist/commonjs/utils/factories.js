...
function createShorthandFactory(_ref) {
...
function createShorthandInternal(_ref2) {
  ...
  var valIsNoop = (0, _isNil2.default)(value) || typeof value === 'boolean';
  ...
  var valIsArray = (0, _isArray2.default)(value);
  ...
  if (defaultProps.styles || overrideProps.styles || usersProps.styles) {
    props.styles = (0, _styles.mergeStyles)(defaultProps.styles, usersProps.styles, overrideProps.styles);
  } // ----------------------------------------
  // Get key
  // ----------------------------------------
  ...
  if (generateKey && (0, _isNil2.default)(props.key)) {
    if (valIsPrimitive) {
