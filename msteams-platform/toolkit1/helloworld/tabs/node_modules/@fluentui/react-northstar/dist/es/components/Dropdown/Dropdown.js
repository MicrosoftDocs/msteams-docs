...
export var Dropdown = /*#__PURE__*/function () {
  var Dropdown = /*#__PURE__*/React.forwardRef(function (props, ref) {
    ...
    // PositioningProps passed directly to Dropdown
    ...
    // PositioningProps passed to Dropdown `list` prop's `popper` key
    ...
    var renderItemsList = function renderItemsList(highlightedIndex, toggleMenu, selectItemAtIndex, getMenuProps, getItemProps, getInputProps) {
      ...
      var _getMenuProps = getMenuProps({
        ...
        suppressRefError: true
          ...
          accessibilityMenuProps = _objectWithoutPropertiesLoose(_getMenuProps, _excluded2); // If it's just a selection, some attributes and listeners from Downshift input need to go on the menu list.
          ...
          if (value.length > 0 && !_isNil(activeSelectedIndex)) {
            if (activeSelectedIndex < value.length - 1) {
              ...
              if (search) {
                ...
                // prevents caret to forward one position in input.
    ...
    var element = /*#__PURE__*/React.createElement(ElementType, _extends({
      ...
      var _getRootProps = getRootProps({
        ...
        suppressRefError: true
          ...
          accessibilityRootPropsRest = _objectWithoutPropertiesLoose(_getRootProps, _excluded3);
