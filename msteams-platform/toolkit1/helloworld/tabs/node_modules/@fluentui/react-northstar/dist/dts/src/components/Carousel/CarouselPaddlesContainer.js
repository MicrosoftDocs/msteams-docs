 ...
 */
exports.CarouselPaddlesContainer = React.forwardRef(function (props, ref) {
    ...
    var element = (React.createElement(ElementType, __assign({}, getA11Props('root', __assign({ className: classes.root, ref: ref }, unhandledProps))), utils_1.childrenExist(children) ? children : content));
    setEnd();
    return element;
});
exports.CarouselPaddlesContainer.displayName = 'CarouselPaddlesContainer';
exports.CarouselPaddlesContainer.propTypes = __assign({}, utils_1.commonPropTypes.createCommon());
