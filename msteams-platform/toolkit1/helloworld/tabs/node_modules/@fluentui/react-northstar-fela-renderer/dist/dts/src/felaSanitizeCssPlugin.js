...
exports.felaSanitizeCssPlugin = void 0;
/**
...
var felaSanitizeCssPlugin = function (styles, type, renderer, props) {
    ...
    Object.keys(styles).forEach(function (cssPropertyNameOrIndex) {
        ...
        if (typeof cssPropertyValue === 'object') {
            processedStyles[cssPropertyNameOrIndex] = exports.felaSanitizeCssPlugin(cssPropertyValue, type, renderer, props);
            return;
        }
...
exports.felaSanitizeCssPlugin = felaSanitizeCssPlugin;
