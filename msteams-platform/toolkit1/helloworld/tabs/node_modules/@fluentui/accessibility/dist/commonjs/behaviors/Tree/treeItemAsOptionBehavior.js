...
var _treeItemBehavior = require("./treeItemBehavior");

var _treeTitleAsOptionBehavior = require("./treeTitleAsOptionBehavior");
 ...
 */
var treeItemAsOptionBehavior = function treeItemAsOptionBehavior(props) {
  var _Object$assign;

  var behavior = (0, _treeItemBehavior.treeItemBehavior)(props);
  var definition = Object.assign({}, behavior, {
    attributes: {
      root: Object.assign({
        ...
        tabIndex: -1
      }, _Object$assign[_attributes.IS_FOCUSABLE_ATTRIBUTE] = true, _Object$assign.role = 'option', _Object$assign['aria-setsize'] = props.treeSize, _Object$assign['aria-posinset'] = props.index, _Object$assign), props.selectable && {
        'aria-selected': !!props.selected
      }))
    },
    childBehaviors: {
      title: _treeTitleAsOptionBehavior.treeTitleAsOptionBehavior
    }
  });

  if (process.env.NODE_ENV !== 'production') {
    if (props.hasSubtree) definition.attributes.root['data-aa-class'] = 'TreeItemOption';else definition.attributes.root['data-aa-class'] = behavior.attributes.root['data-aa-class'];
  }
...
//# sourceMappingURL=treeItemAsOptionBehavior.js.map
