...
export var chatMessageBehavior = function chatMessageBehavior(props) {
  var _Object$assign;

  return {
    attributes: {
      root: Object.assign((_Object$assign = {}, _Object$assign[IS_FOCUSABLE_ATTRIBUTE] = true, _Object$assign.tabIndex = -1, _Object$assign), props.hasActionMenu && !props.inlineActionMenu && {
