 ...
 */
export declare const toolbarMenuItemBehavior: Accessibility<ToolbarMenuItemBehaviorProps>;
export declare type ToolbarMenuItemBehaviorProps = Omit<MenuItemBehaviorProps, 'vertical'> & {
