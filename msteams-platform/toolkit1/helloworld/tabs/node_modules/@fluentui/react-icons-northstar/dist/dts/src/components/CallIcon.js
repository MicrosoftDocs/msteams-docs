...
exports.CallIcon = createSvgIcon_1.createSvgIcon({
    svg: function (_a) {
        ...
        return (React.createElement("svg", { viewBox: "2 2 16 16", role: "presentation", focusable: "false", className: classes.svg },
            ...
            React.createElement("path", { className: classnames_1.default(iconClassNames_1.iconClassNames.filled, classes.filledPart), d: "M6.986 2.066a2 2 0 012.327.946l.074.149.662 1.471a2.497 2.497 0 01-.442 2.718l-.133.132-1.043.973c-.188.178-.047.867.633 2.045.612 1.06 1.11 1.555 1.355 1.582h.043l.053-.01 2.05-.627a1.5 1.5 0 011.564.441l.091.115 1.357 1.88a2 2 0 01-.125 2.497l-.121.126-.543.514a3.5 3.5 0 01-3.715.705c-1.935-.78-3.693-2.562-5.29-5.329-1.6-2.772-2.265-5.19-1.968-7.258a3.5 3.5 0 012.262-2.79l.192-.064.717-.216z" })));
    },
