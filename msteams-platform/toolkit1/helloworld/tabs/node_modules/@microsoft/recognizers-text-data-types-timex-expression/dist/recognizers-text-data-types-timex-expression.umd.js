...
const fixedFormatNumber$2 = timexDateHelpers.fixedFormatNumber;

const dateValue = function (obj) {
    if (obj.year !== undefined && obj.month !== undefined && obj.dayOfMonth !== undefined) {
        return `${fixedFormatNumber$2(obj.year, 4)}-${fixedFormatNumber$2(obj.month, 2)}-${fixedFormatNumber$2(obj.dayOfMonth, 2)}`;
    }
    return '';
};
...
const timeValue = function (obj) {
    if (obj.hour !== undefined && obj.minute !== undefined && obj.second !== undefined) {
        return `${fixedFormatNumber$2(obj.hour, 2)}:${fixedFormatNumber$2(obj.minute, 2)}:${fixedFormatNumber$2(obj.second, 2)}`;
    }
    return '';
};
...
const TimexProperty$4 = timexProperty.TimexProperty;




const dateOfLastDay$1 = timexDateHelpers.dateOfLastDay;
const dateOfNextDay$1 = timexDateHelpers.dateOfNextDay;
...
const resolveDefinite$1 = function (timex, date) {
...
const lastDateValue = function (timex, date) {
    ...
    if (timex.dayOfWeek !== undefined) {
        const day = timex.dayOfWeek === 7 ? 0 : timex.dayOfWeek;
        const result = dateOfLastDay$1(day, date);
...
const nextDateValue = function (timex, date) {
    ...
    if (timex.dayOfWeek !== undefined) {
        const day = timex.dayOfWeek === 7 ? 0 : timex.dayOfWeek;
        const result = dateOfNextDay$1(day, date);
        return timexValue.dateValue({ year: result.getFullYear(), month: result.getMonth() + 1, dayOfMonth: result.getDate() });
    }
};

const resolveDate$1 = function (timex, date) {
    return [
...
const resolveTime$1 = function (timex) {
    return [ { timex: timex.timex, type: 'time', value: timexValue.timeValue(timex) } ];
};

const resolveDuration$1 = function (timex) {
...
const resolveTimeRange$1 = function (timex, date) {
    if ('partOfDay' in timex) {
...
const resolveDateTime = function (timex, date) {
    const resolvedDates = resolveDate$1(timex, date);
...
const resolve = function (timexArray, date) {
    ...
    for (const timex of timexArray) {
        const t = new TimexProperty$4(timex);
