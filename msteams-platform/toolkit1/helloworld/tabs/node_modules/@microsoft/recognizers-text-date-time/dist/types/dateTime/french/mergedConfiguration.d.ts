...
export declare class FrenchMergedExtractorConfiguration implements IMergedExtractorConfiguration {
...
export declare class FrenchMergedParserConfiguration extends FrenchCommonDateTimeParserConfiguration implements IMergedParserConfiguration {
    readonly beforeRegex: RegExp;
    readonly afterRegex: RegExp;
    readonly sinceRegex: RegExp;
