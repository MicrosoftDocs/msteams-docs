...
export declare class FrenchDurationExtractorConfiguration implements IDurationExtractorConfiguration {
...
export declare class FrenchDurationParserConfiguration implements IDurationParserConfiguration {
    readonly cardinalExtractor: BaseNumberExtractor;
