...
A bot behaves differently depending on what kind of conversation it is involved in. Teams supports several kinds of conversations (called scopes in the [Manifest](~/resources/schema/manifest-schema)).
