...
![](~/assets/images/tabs/sharepoint-integration/image001.png)
...
![](~/assets/images/tabs/sharepoint-integration/image003.png)
...
![](~/assets/images/tabs/sharepoint-integration/image005.png)
...
![](~/assets/images/tabs/sharepoint-integration/image014.png)
...
![](~/assets/images/tabs/sharepoint-integration/image016.png)
...
![](~/assets/images/tabs/sharepoint-integration/image018.png)
...
![](~/assets/images/tabs/sharepoint-integration/image020.png)
...
![](~/assets/images/tabs/sharepoint-integration/image022.png)
...
![](~/assets/images/tabs/sharepoint-integration/image028.png)
...
![](~/assets/images/tabs/sharepoint-integration/image030.png)

Click on the "Manifest editor" tab and the "Import and existing app" button:

![](~/assets/images/tabs/sharepoint-integration/image032.png)
...
![](~/assets/images/tabs/sharepoint-integration/image034.png)
...
![](~/assets/images/tabs/sharepoint-integration/image038.png)

Scroll to the bottom of App Details:

![](~/assets/images/tabs/sharepoint-integration/image043.png)

### 2: Tabs

![](~/assets/images/tabs/sharepoint-integration/image046.png)

### 3: Bots

![](~/assets/images/tabs/sharepoint-integration/image049.png)

### 4: Messaging extensions

![](~/assets/images/tabs/sharepoint-integration/image052.png)
...
![](~/assets/images/tabs/sharepoint-integration/image054.png)
...
![](~/assets/images/tabs/sharepoint-integration/image057.png)

Next, you'll see the dialog below (of course, the team name will be different). Here, it shows the General Channel:

![](~/assets/images/tabs/sharepoint-integration/image059.png)
...
![](~/assets/images/tabs/sharepoint-integration/image061.png)
...
![](~/assets/images/tabs/sharepoint-integration/image063.png)
...
![](~/assets/images/tabs/sharepoint-integration/image065.png)

In your site, create a new page, by clicking in the gear button (top-right) and then "Add a page"

![](~/assets/images/tabs/sharepoint-integration/image066.png)

You'll see the pages authoring experience:

![](~/assets/images/tabs/sharepoint-integration/image067.png)
...
![](~/assets/images/tabs/sharepoint-integration/image069.png)

This will create a web part in the canvas that contains your Teams Tab:

![](~/assets/images/tabs/sharepoint-integration/image071.png)
...
![](~/assets/images/tabs/sharepoint-integration/image073.png)
...
![](~/assets/images/tabs/sharepoint-integration/image075.png)
...
![](~/assets/images/tabs/sharepoint-integration/image077.png)
...
![](~/assets/images/tabs/sharepoint-integration/image078.png)
...
![](~/assets/images/tabs/sharepoint-integration/image080.png)

Example from a formatted version of this JSON:

![](~/assets/images/tabs/sharepoint-integration/image081.png)