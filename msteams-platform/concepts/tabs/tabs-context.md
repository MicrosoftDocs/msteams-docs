...
Use placeholders in your configuration or content URLs. Microsoft Teams replaces the placeholders with the relevant values when determining the actual configuration or content URL to navigate to. The available placeholders include all fields on the [Context](~/javascript/api/microsoft/teams-js/microsoftteams.context) object. Common placeholders include the following:
