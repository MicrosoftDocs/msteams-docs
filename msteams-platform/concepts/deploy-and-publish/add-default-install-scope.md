...
Configure the default install scope for your app. You can set only one scope at a time. For more information, see [app manifest schema](~/resources/schema/manifest-schema.md#defaultinstallscope).
...
Configure the default capability when your app is installed for a team, meeting, or groupchat. For more information, see [app manifest schema](~/resources/schema/manifest-schema.md#defaultgroupcapability).
