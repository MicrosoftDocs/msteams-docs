...
* **Prior to app submission**
  ...
  1. As you prepare for app submission, be careful to ensure:
      ...
      1. [Follow the checklist](/microsoftteams/platform/concepts/deploy-and-publish/appsource/prepare/submission-checklist) and include the following details as part of your submission package:
