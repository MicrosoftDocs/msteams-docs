...
:::row:::
   :::column span="1":::
      :::image type="icon" source="../../../assets/icons/broken-links-errors-icon-1.png" border="false"::: [**Broken links, Bugs and errors**](#broken-links-functional-bugs-app-crashes-and-unexpected-errors)
   :::column-end:::
   :::column span="1":::
     :::image type="icon" source="../../../assets/icons/app-description-icon.png" border="false"::: [**App description**](#app-description)
   :::column-end:::
   ::column span="1":::
      :::image type="icon" source="../../../assets/icons/trademark-icon.png" border="false"::: [Violation of Microsoft Trademark and Brand Guidelines](#violation-of-microsoft-trademark-and-brand-guidelines)
   :::column-end:::
:::row-end:::
