...
1. **Build a *collaborative app* product line**: Provide Teams users a unique, differentiated, rich, familiar, end to end and deeply immersive experience – all contained in Teams and centered around collaboration versus individual productivity. [Collaborative apps](https://www.microsoft.com/en-us/microsoft-365/blog/2021/11/02/stay-in-the-flow-of-work-with-new-collaborative-apps-for-microsoft-teams/), a new app pattern, which is designed to bring people, processes, and data together to help users thrive in the hybrid workplace are positioned to transform how people in every organization do more together with the help of ubiquitous software in the flow of work. Collaborative apps offer an experience that’s preferred by the user over other channels where the app exists and often use one of Teams-only capabilities such as meeting extensions, Live Share, Graph APIs, message extensions, and so on, to deliver significant user value, on top of table stake scenarios.
