...
A video in your listing can be the most effective way to communicate with the users about your app. You can add the URL of videos hosted on YouTube in the format `https://www.youtube.com/watch?v=:id` and `https://youtu.be/:id` or Vimeo in the format `https://vimeo.com/:id`.
