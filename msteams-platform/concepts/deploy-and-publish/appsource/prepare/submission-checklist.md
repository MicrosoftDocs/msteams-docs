...
1. Go to the [Microsoft Teams app validation tool](https://dev.teams.microsoft.com/validation). The app validation tool is also available in [App Studio](../../../build-and-test/app-studio-overview.md).
