...
This is used in messaging extensions marked as a favorite by the user and the left navigation menu. Make sure it's simple and recognizable. Your outline icon must contain only white and transparency (no other colors). Please see detailed requirement [here](~/concepts/build-and-test/apps-package#icons) before submitting.
