...
>[!IMPORTANT]
> Make sure the Developer Name in your app Manifest is the same as the Provider Name in Partner Center
...
**Do's:**
* Listing features as bullet points will aid readers scanning your description.  


> [!NOTE]
>To create bulleted list, below formatting must be used. No other formatting is allowed currently for long description.   
> [#LI] First feature[/#LI]  
...
* Make sure you call out any limitations/constraints/out of scope for better user guidance
