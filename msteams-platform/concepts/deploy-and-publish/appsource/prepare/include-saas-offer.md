...
As an extended phase of planning your offer, there are technical configurations required to create a SaaS offer. You must also have the technical information handy to update the offer configuration.
...
| 1. Create an offer | 2. [Configure the offer](/partner-center/marketplace-offers/create-new-saas-offer-properties) | 3. Create a plan |
| --- | --- | --- |
...
For more information, see [create a SaaS offer](/partner-center/marketplace-offers/create-new-saas-offer) and [create plans for SaaS offer](/partner-center/marketplace/create-new-saas-offer-plans).
