...
* Apps must not take user out of Teams for core user scenarios, highly recommended to make use of Task modules , tabs to display information to the user within Teams
