...
description: Learn to manage SaaS licenses for third-party apps purchased from Teams storefront such as create an offer, post purchase, and integrate with Graph usageRights API.
