...
description: Learn the basic tasks & concepts needed to implement in-app purchases such as app manifest update, purchase experience API, and trial functionality in Teams apps.
author: v-npaladugu
