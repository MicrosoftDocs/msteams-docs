...
2.1When the agent is provided with the tracking ID, it must return the details of the performed action or the item
details on which the action has been executed. [Must-fix]
