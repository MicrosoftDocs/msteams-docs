...
* The developerName in your manifest must be same as the Provider Name defined in Partner Center or Seller Dashboard.
...
* Ensure the app title used in your manifest matches exactly with the App title entered in Partner Center submission. Please refer to [this link](https://docs.microsoft.com/office/dev/store/create-effective-office-store-listings#use-a-consistent-add-in-name) for details
