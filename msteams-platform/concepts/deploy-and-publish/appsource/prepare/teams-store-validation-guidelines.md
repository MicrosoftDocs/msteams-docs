...
* Starting July 2026, new Teams Store submissions for apps and agents that operate in channels must use manifest version **v1.25 or higher** and support collaborative or team capabilities across all channel types (Standard, Shared, and Private). For more information, see [Apps for shared and private channels](../../../../build-apps-for-shared-private-channels.md).</br> To ensure a consistent and transparent experience [*Must fix*]:
