...
## Apps linked to Software as a Service (SaaS) offer
...
* Users completing a purchase must manage the licenses and have the following selections in SaaS application: 
