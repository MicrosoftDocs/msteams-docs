...
1. Select **Apps** > **Manage your apps** and **Publish an app**.
    ...
    :::image type="content" source="~/assets/images/publish-app/manage-apps.png" alt-text="The screenshot shows the steps to publish an app.":::

1. Select **Upload a custom app**.

   :::image type="content" source="~/assets/images/publish-app/publish-app.png" alt-text="The screenshot shows the steps to upload a custom app.":::
...
1. Add your app to Teams as per your requirement:</br>
   ...
   b. Use the dropdown menu to add your app to a Team or chat.
    ...
    :::image type="content" source="~/assets/images/publish-app/teams-app-detail.png" alt-text="The screenshot shows the app description.":::
...
1. Go to **Apps** and select **Manage your apps** in Teams to view the installed apps across all your channels or for personal use in a list format.
    ...
    :::image type="content" source="~/assets/images/publish-app/manage-apps-list.png" alt-text="The screenshot shows the steps to access Teams apps list.":::

1. Select the app dropdown to view all the scopes where the app is installed.

    :::image type="content" source="~/assets/images/publish-app/app-scopes.png" alt-text="The screenshot shows the steps to access Teams app scope.":::
...
1. Select **Update available** to view update.
     ...
     :::image type="content" source="~/assets/images/publish-app/update-available.png" alt-text="The screenshot shows the steps to update Teams app.":::

1. Select **View update**, a window with update option appears.
1. Select **Update** button to update your app.

     :::image type="content" source="~/assets/images/publish-app/update-window.png" alt-text="The screenshot shows the steps to update Teams app in manage apps.":::

     :::image type="content" source="~/assets/images/publish-app/updated-app.png" alt-text="The screenshot shows the updated app.":::
...
1. Select &nbsp;:::image type="content" source="~/assets/images/publish-app/bin-icon.png" alt-text="The screenshot describes on how to remove app in Teams.":::&nbsp; at the scope of the installed app.
    ...
    :::image type="content" source="~/assets/images/publish-app/uninstall-from-channel.png" alt-text="The screenshot shows the steps to remove app in a channel.":::

1. Select **Remove** to remove your app.

    :::image type="content" source="~/assets/images/publish-app/remove-app-teams.png" alt-text="The screenshot shows the steps to remove an app from Teams.":::
