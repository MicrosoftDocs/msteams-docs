...
> [!IMPORTANT]
> * Currently, sideloading apps are available in Government Community Cloud (GCC), but aren't available for GCC-High and Department of Defense (DOD).
> * App installation is supported in desktop only.
