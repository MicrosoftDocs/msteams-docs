...
[Plan apps for Teams mobile](../concepts/design/plan-apps-for-teams-mobile.md) covers some common scenarios and helps with planning apps for Teams mobile. The document guides on how to stratrgize for apps on mobile. You can also learn about the different satges and different types of Teams app.
