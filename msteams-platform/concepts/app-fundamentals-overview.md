...
description: Understand use case and Microsoft Teams app features, map use cases, plan responsive tabs for mobile. Learn Teams features, availability, and app support for GCC, GCC-High, and DOD.
ms.topic: conceptual
