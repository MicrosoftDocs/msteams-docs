...
* [Search based messaging extensions](~/concepts/messaging-extensions/search-extensions): Query your service for information and insert that into a message. Ex: Lookup a work item
* [Create based messaging extensions](~/concepts/messaging-extensions/create-extensions): Collect information from the user and post to your service. Ex: Create a workitem