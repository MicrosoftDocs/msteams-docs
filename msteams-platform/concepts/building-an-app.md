...
* [Designing great tabs](~/tabs/design/foo.md)
* [Designing messaging extensions](~/messaging-extensions/design/foo.md)
* [Designing useful conversational bots](~/bots/design/foo.md)

## Prepare your environment

You need to make sure you have an environment where you can upload and test your Teams app. If you don't already have an O365 subscription with Teams enabled and the ability to upload apps to it you can [sign up for the O365 developer program](https://dev.office.com/devprogram) which will give you access to a free Office 365 subscription for development purposes. See [setting up your O365 environment](~/concepts/build-and-test/prepare-youre-o365-tenant.md) for additional information.
