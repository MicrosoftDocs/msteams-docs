...
To verify that an `HttpPOST` action is working correctly, use your [custom incoming webhook](~/connectors/connectors-using#setting-up-a-custom-incoming-webhook).
