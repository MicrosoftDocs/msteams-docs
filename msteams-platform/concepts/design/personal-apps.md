...
description: Learn how to design a Teams personal app and get the Teams UI Kit, create components, such as, dashboard, form, task board for Mobile and Desktop experience.
