...
:::image type="content" source="../../assets/images/overview/teams-app-cap-2.png" alt-text="screenshot showing the graphical representation." lightbox="../../assets/images/overview/teams-app-cap-2.png":::
