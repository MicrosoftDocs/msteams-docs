...
:::image type="content" source="../../assets/images/overview/teams-app-cap4.png" alt-text="screenshot showing the graphical representation." lightbox="../../assets/images/overview/teams-app-cap4.png":::
