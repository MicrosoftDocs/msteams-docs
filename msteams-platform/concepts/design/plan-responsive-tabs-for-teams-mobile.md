...
:::image type="content" source="../../assets/images/app-fundamentals/taskboarding-apps-consumption.png" alt-text="The screenshot is an example that shows the list of tasks in a vertical stack.":::
...
:::image type="content" source="../../assets/images/app-fundamentals/taskboarding-apps-quick-actions.png" alt-text="The screenshot describes on how to create tasks to reduce cognitive load of the users.":::
...
:::image type="content" source="../../assets/images/app-fundamentals/taskboarding-apps-enablement.png" alt-text="The screenshot describes on how to enable the user experience by adding projects and boards.":::
...
:::image type="content" source="../../assets/images/app-fundamentals/coauthoring-and-whiteboarding-apps-consumption.png" alt-text="The screennshot is an example that shows content and assets in desktop experience.":::
...
:::image type="content" source="../../assets/images/app-fundamentals/coauthoring-and-whiteboarding-apps-quick-actions.png" alt-text="The screenshot is an example that introduces to create new board for collaboration.":::
...
:::image type="content" source="../../assets/images/app-fundamentals/coauthoring-and-whiteboarding-apps-enablement.png" alt-text="The screenshot describes on how to enable user experience by adding text shapes, quick notes, and other capabilities.":::
