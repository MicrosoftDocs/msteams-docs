...
:::image type="content" source="../../assets/images/apps-in-meetings/manageappsblockedapps.png" alt-text="The screenshot shows the stpes to manage apps blocked by publisher.":::
