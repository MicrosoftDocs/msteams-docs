...
* **Microsoft Teams store validation guidelines**: Microsoft Teams store validation guidelines provide standards for Teams apps. You must follow the [guidelines](~/concepts/deploy-and-publish/appsource/prepare/teams-store-validation-guidelines.md) to design a quality app. 
