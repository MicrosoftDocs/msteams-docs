...
Quickly create complex, high-fidelity designs with [templates for common Teams use cases and workflows](design-teams-app-ui-templates.md). For [apps extended across Microsoft 365](../../m365-apps/overview.md#app-planning-and-design), app playbooks and UI templates are also available.
