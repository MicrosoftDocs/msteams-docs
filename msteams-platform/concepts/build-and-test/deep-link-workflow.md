...
You can also generate a deep link to [meeting side panel](~/apps-in-teams-meetings/build-tabs-for-meeting.md#deep-link-to-meeting-sidepanel) in a meeting. Use the following format for a deep link to the meeting side panel:
