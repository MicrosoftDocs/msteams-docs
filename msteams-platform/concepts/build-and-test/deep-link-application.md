...
* Apps submitted to org catalog: Org catalog ID. For more information, see [how to find ID based on the Teams app manifest ID](/graph/api/appcatalogs-list-teamsapps##example-3-find-application-based-on-the-teams-app-manifest-id)
