...
* Apps submitted to org catalog: Org catalog ID ([Check how to Find Id based on the Teams app manifest ID](https://learn.microsoft.com/en-us/graph/api/appcatalogs-list-teamsapps?view=graph-rest-1.0&tabs=http#example-3-find-application-based-on-the-teams-app-manifest-id))
