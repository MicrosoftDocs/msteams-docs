...
:::image type="content" source="~/assets/images/share-to-teams-popup.png" alt-text="The screenshot is an example that shows the Share to Teams popup window.":::
...
:::image type="content" source="~/assets/images/share-to-teams-link-unfurling.png" alt-text="The screenshot is an example that shows the Share to Teams link unfurling.":::
...
1. Add an HTML element on your webpage with the `teams-share-button` class attribute and the link to share in the `data-href` attribute.
    ...
    :::image type="content" source="~/assets/icons/share-to-teams-icon.png" alt-text="The screenshot is an example that shows the Share to Teams icon.":::
