...
2. Select **Show All** > **Teams**.
    ...
    :::image type="content" source="~/assets/images/prepare-test-tenant/admin-center.png" alt-text="The screenshot shows the admin center menu.":::
...
3. Navigate to **Teams apps** > **Setup Policies** > **Global**.
   ...
   :::image type="content" source="~/assets/images/prepare-test-tenant/turn-on-sideload.png" alt-text="The screenshot shows the steps to turn on sideload view.":::
...
5. Select **Save**. Your test tenant can permit custom app sideloading.
    ...
    :::image type="content" source="~/assets/images/prepare-test-tenant/upload-for-contoso.png" alt-text="The screenshot shows the steps to upload app view.":::
