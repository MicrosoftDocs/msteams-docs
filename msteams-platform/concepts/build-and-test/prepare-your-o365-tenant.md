...
> [!IMPORTANT]
> You can skip the steps below if you chose the Instant Sandbox option with the Teams sample data pack which will automatically enable the **Upload custom apps** setting.
