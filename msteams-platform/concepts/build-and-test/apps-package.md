...
An app package is a file format that has the required resources to install and run your app in Teams and it must contains the following files:
...
An app manifest is a file that describes how your app is configured, including its capabilities, required resources, and other important attributes.Your app manifest file must be at the top level of the package with the name `manifest.json`.
