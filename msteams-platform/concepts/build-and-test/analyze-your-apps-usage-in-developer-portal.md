...
Your tenant admin must allow app usage for custom apps to show in the Developer Portal. Either **Global admin** or **Teams admin** is able to allow it in [Microsoft 365 admin center](/microsoft-365/admin/admin-overview/admin-center-overview.md) -> **Settings** -> **Org settings** -> **Services** -> **Developer Portal for Teams**.
