...
> [!NOTE] The scenarios where deeplink launches browser first before navigating are described below.

> **Tab**: Directly navigates to deeplink url

> **Bot**:
   Deeplink in card body - Opens in browser first
   Deeplink added to OpenURL action in Adaptive Card - Directly navigates to deeplink url
