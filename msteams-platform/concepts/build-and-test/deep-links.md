...
description: Learn how to configure Teams deep links to an app, chat, teams and channels, and workflows. Also about the types of deep links & protocol handlers.
ms.topic: overview
