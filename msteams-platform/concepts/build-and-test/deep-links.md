...
description: Learn how to configure Teams deep links to an app, chat, teams and channels, and workflows. Know about the types of deep links and protocol handlers.
ms.topic: overview
