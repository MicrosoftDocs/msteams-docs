...
* **App content**: You can configure your app with the following features:
  ...
  * **Loading indicator**: Displays an indicator to let users know your hosted app content (for example, Tabs and Dialogs (referred as task modules in TeamsJS v.1.0)) is loading.
