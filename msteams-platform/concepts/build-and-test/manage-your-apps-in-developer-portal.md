...
After you upload your app in Microsoft Teams, you can manage your app in Developer Portal. The article provides comprehensive guidance on app configuration, analytics, and validation to enhance Teams app experience.<br>
In addition, learn about Agent Identity Blueprint to create and manage agent identities for your agent.

## Overview

In the **Overview** section, see the following components to manage your app:

* **Dashboard**

  * In the **Dashboard** under **Overview** section, see the following components for your app:
...
* **Active users (Preview)**: Shows the active user count.
* **Basic information**: Shows the **App ID**, **Version**, **Manifest version**, and other basic information.
![The screenshot is an example that shows the Overview page of the app you created in Developer Portal.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/tdp/dashboard-page_1.png)

* **Analytics**
In the **Analytics** under **Overview** section, get an overview of your app's usage, engagement, and other insights. For more information, see [how to analyze your app's usage](analyze-your-apps-usage-in-developer-portal.md).

## Configure

To install and render your app in Teams, include a set of configurations that Teams recognizes. To upload your apps in Teams, you need to have app manifest, which contains all the app details to display your app in Teams. This can be achieved with the help of components and tools available in Developer Portal.

![The screenshot is an example that shows how to configure features to manage and access your app in Developer Portal.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/tdp/configure.png)

In the **Configure** section, see the following components to manage and access your app:
...
![Screenshot shows you the App package editor in Teams developer portal.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/tdp/package-editor.png)
...
![Screenshot shows you the App package editor to update the new files in Teams developer portal.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/tdp/app-package-editor-update.png)
> [!NOTE]
...
![Screenshot shows you the app package editor in Teams developer portal.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/tdp/app-package-editor-tdp.png)
1. Select the ellipses (**...**) under **Actions** of **manifest.json** file and select **Edit**.
![Screenshot shows you the app package editor to edit your app package.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/tdp/app-package-editor-edit.png)
1. Add the manifest property `copilotAgents` and the sub property `declarativeAgents`, and define required details. Select **Save**.
![Screenshot shows you how to declarative agents into your app package.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/tdp/app-package-editor-da.png)
1. Select **New file** > **JSON file** and define your agent's behavior.
![Screenshot shows you how to add a declarative agents behavior into your app package.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/tdp/package-editor-da-json.png)
1. Select **Update**.
![Screenshot shows you how to update declarative agents behavior into your app package.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/tdp/app-package-update.png)
...
* **Single sign-on**: Bot registered on Microsoft Entra ID supports single sign-on (SSO). If a bot is registered on Bot Framework portal (or within Developer Portal under **Bot management**), then a bot doesn't support SSO, and you have to register your bot on Microsoft Entra ID to support SSO. For a bot registered on Microsoft Entra ID, add the **Application ID URI**. To get **Application ID URI** from Microsoft Entra ID, see [how to use SSO authentication for bots](../../bots/how-to/authentication/auth-aad-sso-bots.md).
* **Languages**: This section allows you to set up or change the language of your app.
* **Domain**: This section allows you to add the domains to load your apps in Teams client, such as *.example.com.

## Advanced

In the **Advanced** section, see the following components to manage your app in Developer Portal:
...
1. In Developer Portal, select the **Apps** that you're working.
...
1. Enter `{{` in any field in Developer Portal. A dropdown with all variables you've created for the chosen environment along with global variables appears.  
1. Before downloading your app package (for example, when getting ready to publish to Teams Store), select the environment you want to use. Your app configurations update automatically based on the environment.

* **Plan and pricing**: Link a Software-as-a-Services (SaaS) offer that you've created in Partner center for your app.
* **Admin settings**:
  ...
  * **Block app by default**: Block your app by default for users until a Teams Administrator selects to enable it.

## Develop

In the **Develop** section, open and develop your app in Microsoft 365 Agents Toolkit (previously known as Teams Toolkit) in Visual Studio Code and Visual Studio. For more information, see [develop your app with Microsoft 365 Agents Toolkit](develop-your-apps-with-toolkit.md).

## Publish

In the **Publish** section, publish your app to your org or to Teams Store.

* **App package**: The app package describes how your app is configured, including app features, required resources, and other important attributes in manifest. The app definition refers to the configuration and settings associated with the application. The Icon tab shows the icon used for your app.
...
![Screenshot shows you the App validation with get started in Teams developer portal.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/tdp/app-validation-home-get-started.png)
If your app fails any test case, review the guidelines and make necessary updates to your app package based on Microsoft test case results. You can also download your app package and validation report. For more information on Microsoft test cases, see [Teams Store validation guidelines](../deploy-and-publish/appsource/prepare/teams-store-validation-guidelines.md) and [Commercial marketplace certification policies](/legal/marketplace/certification-policies).
<br>
<details>
...
![Screenshot shows you the App validation in Teams developer portal.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/tdp/app-validation-home.png)
1. Select all the checkboxes under **Validation Acknowledgment** and select **Start Validation**.
![Screenshot shows you the App validation acknowledgment of your app package.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/tdp/app-validation.png)
> [!NOTE]
> * Before you start validation, resolve any app manifest errors.
> * Submit only one validation request for a particular app at any given time. After the current validation completes, initiate a subsequent request.
Teams Developer Portal now starts to validate your app package:
![Screenshot shows you the App validation in progress.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/tdp/app-validation-in-progress.png)
...
Select **Refresh Status** to retrieve latest validation status when the validation is **In progress** status.
![Screenshot shows the app validation status.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/tdp/app-validation-refresh.png)
...
![Screenshot shows you the app validation tool result.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/tdp/app-validation-result.png)
</details>
> [!NOTE]
>
> * App validation is supported only for apps with bot capability.
> * The app validation tool evaluates your app package based on the test cases Microsoft uses for app review prior to submission to Microsoft Teams Store. Resolve errors or warnings and read the **App submission checklist** before submitting your app.
...
1. In Developer Portal, select the **Apps** that you're working.
   ...
   1. Select **Publish**.
Download the app package by selecting the **Download app package** button from the **Publish to store** page.

## Test your app directly in Teams

Developer Portal provides options for testing and debugging your app:

* On the **Overview** page, see a snapshot whether your app is configured and is validated against Teams Store test cases.
* The **Preview in Teams** button launches your app quickly in Teams client for debugging.

## Use tools to create app features

Developer Portal also includes tools to help you build key features of Teams apps. The following are the tools:
...
![The screenshot is an example that shows the tools in developer portal, which helps you to build key features.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/tdp/tools-in-dev-portal_1.png)

1. In the Bot management page, select **+ New Bot**.
1. Enter the name and select **Add**.
![Add a new bot by using bot management option.](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/tdp/Add_new_bot.PNG)
...
> * When you create a bot using **Developer Portal**, a corresponding [servicePrincipal](/graph/api/resources/serviceprincipal?view=graph-rest-1.0&preserve-view=true) is automatically created in your **Microsoft Entra ID** tenant.
...
From Developer Portal, go to Bot Framework portal and configure your bot to update icon and other properties.
...
An Agent Identity Blueprint provides reusable configurations for agents in **Agent 365** that perform tasks and interact with users or Microsoft 365 services. Each blueprint acts as a template specifying how an agent is configured and connected to a back-end service.

Agent Identity Blueprints are created and managed in **Developer Portal**, while agent identities derived from them are managed in **Microsoft 365 Admin Center**. For complete end-to-end guidance on extending your agent to Agent 365, use [Microsoft Agent 365 SDK](/microsoft-agent-365/developer/?tabs=python).

#### View and use existing Agent Identity Blueprints

Agent Identity Blueprint tool in Developer Portal displays a list of existing blueprints available in your tenant.

![List of available agent blueprints](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/tdp/list-agent-blueprint.png)
...
1. In [Teams Developer Portal](https://dev.teams.microsoft.com/home), go to **Tools** section and select **Agent Identity Blueprint**.
![Agent Blueprint](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/tdp/agent-blueprint.png)

1. Select **+ New blueprint**.
![Create a new agent blueprint](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/tdp/new-agent-blueprint.png)

1. Enter the name and select **Create**.
![Create a new agent blueprint window](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/tdp/create-new-agent-blueprint.png)
...
![Basic information tab in Agent Blueprint](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/tdp/basic-information-agent-blueprint.png)

1. **Configuration**: In this tab, specify how the agent communicates with its service.
1. In **Configuration** tab, go to **Agent Type**.
...
![Configuration tab in Agent Blueprint](https://learn.microsoft.com/en-us/microsoftteams/platform/assets/images/tdp/configuration-agent-blueprint.png)
