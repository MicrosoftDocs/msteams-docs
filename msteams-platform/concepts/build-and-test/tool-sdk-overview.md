...
| [Teams Toolkit CLI](../../toolkit/Teams-Toolkit-CLI.md) | Microsoft 365 Agents Toolkit CLI is a text-based command line interface (CLI) that accelerates Teams application development. It aims to provide keyboard centric experience when building Teams applications. | JavaScript and .NET | Use command prompt |
...
| Teams Toolkit CLI | We recommend that you use [Teams Toolkit CLI v3](../../toolkit/Teams-Toolkit-CLI.md) to build your Teams app, as Microsoft 365 Agents Toolkit CLI v1 and Microsoft 365 Agents Toolkit CLI v2 are available only with limited functionality. |
