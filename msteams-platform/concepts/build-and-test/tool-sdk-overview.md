...
author: v-sdhakshina
description: Learn more about the tools such as Microsoft 365 Agents Toolkit, Microsoft 365 Agents Toolkit CLI, Developer Portal, and SDKs available for building your Teams app.
...
<details>
<summary><b>More information on building Teams app with Microsoft 365 Agents Toolkit.</b></summary>

| &nbsp; | Microsoft 365 Agents Toolkit |
| -------- | ------------- |
| Environment variables | Use `.env` file |
| Generate manifest | Microsoft 365 Agents Toolkit autogenerates when creating projects. |
...
| Tool | Details |
| ----------------- | -------------- |
| Microsoft 365 Agents Toolkit | We recommend using [Microsoft 365 Agents Toolkit v5](../../toolkit/teams-toolkit-fundamentals.md) to build your apps, as Microsoft 365 Agents Toolkit v4 is available only with limited functionality. |
