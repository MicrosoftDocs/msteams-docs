...
| Agents Toolkit CLI | We recommend that you use [Agents Toolkit CLI v3](../../toolkit/Teams-Toolkit-CLI.md) to build your Teams app, as Agents Toolkit CLI v1 and v2 are available only with limited functionality. |
