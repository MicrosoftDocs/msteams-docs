...
| -------- | ------------- | ----------------- | ---------------------- |
| [Teams Toolkit](../../toolkit/agents-toolkit-fundamentals.md) | Teams Toolkit makes it simple to get started with app development for Teams. You can begin with a project template for common custom app built for your org (LOB app) scenarios or start from a sample. Save time on setup through automated app registration and configuration using Visual Studio Code and Visual Studio. | **Visual Studio Code**: JavaScript and TypeScript </br> **Visual Studio**: .NET and Blazor | In Visual Studio Code and Visual Studio |
| [Teams Toolkit CLI](../../toolkit/Agents-Toolkit-CLI.md) | TeamsFx CLI is a text-based command line interface (CLI) that accelerates Teams application development. It aims to provide keyboard centric experience when building Teams applications. | JavaScript and .NET | Use command prompt |
...
| Tool | Details |
| ----------------- | -------------- |
| Teams Toolkit | We recommend using [Teams Toolkit v5](../../toolkit/agents-toolkit-fundamentals.md) to build your apps, as Teams Toolkit v4 is available only with limited functionality. |
| Teams Toolkit CLI | We recommend that you use [Teams Toolkit CLI v3](../../toolkit/Agents-Toolkit-CLI.md) to build your Teams app, as TeamsFx CLI v1 and TeamsFx CLI v2 are available only with limited functionality. |
