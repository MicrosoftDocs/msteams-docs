...
description: Learn more about the tools such as Teams Toolkit, Agents Toolkit CLI, Developer Portal, and SDKs available for building your Teams app.
...
| Agents Toolkit CLI | We recommend that you use [Agents Toolkit CLI v3](../../toolkit/Teams-Toolkit-CLI.md) to build your Teams app, as Agents Toolkit CLI v1 and Agents Toolkit CLI v2 are available only with limited functionality. |
