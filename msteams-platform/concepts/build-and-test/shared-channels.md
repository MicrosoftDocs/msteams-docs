...
> [!NOTE]
> Tab apps in shared channels are available in [Government Community Cloud (GCC), GCC High, and Department of Defense (DOD)](../cloud-overview.md#teams-apps-and-capabilities-for-government-clouds) environments.
