...
> [!NOTE]
> * The latest update of Share-in-Teams is currently available in [public developer preview for Microsoft Teams](../../resources/dev-preview/developer-preview-intro.md) only. This update will be generally available (GA).
