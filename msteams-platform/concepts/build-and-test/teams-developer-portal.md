...
:::image type="content" source="../../assets/images/tdp/tdp_home_1.png" alt-text="Screenshot shows the home page of the Developer Portal for Teams." lightbox="../../assets/images/tdp/tdp_home_1.png":::
...
1. Sign in to [Developer Portal](https://dev.teams.microsoft.com) and select **Apps** from the left pane.
   ...
   :::image type="content" source="../../assets/images/tdp/home-page.png" alt-text="Screenshot shows the home page of the Developer Portal for Teams with the Apps option highlighted in red." lightbox="../../assets/images/tdp/home-page.png":::
...
:::image type="content" source="../../assets/images/tdp/basic-information-app-tdp.png" alt-text="Screenshot shows the basic information of the app you created in the Developer Portal for Teams." lightbox="../../assets/images/tdp/basic-information-app-tdp.png":::
...
* **Removed**: Updates on a service or API that is removed and may be replaced with a new and updated service.
