...
> * You can import an existing app which you created on App Studio to the Developer Portal. To import an already published app into developer portal, the app owner would need to raise a service request to transfer the ownership over the app id.
