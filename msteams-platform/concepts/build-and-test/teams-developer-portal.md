...
1. Select **Import**.
   ...
   * You can import an existing app which you created on App Studio to Developer Portal. Global tenant admin of the Teams app will now be able to take ownership of any apps on their tenant that is missing owners.
