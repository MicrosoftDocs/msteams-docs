...
Once the ticket is resolved, the Teams Administrator or Global Administrator can [import an existing app](#import-an-existing-app). To share access of the app, the admin or existing owner can [add an owner](manage-your-apps-in-developer-portal.md) in Developer Portal.
