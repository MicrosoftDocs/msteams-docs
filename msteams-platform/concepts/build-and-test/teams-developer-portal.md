...
1. Select **Import**.
   ...
   * You can import an existing app which you created on App Studio to Developer Portal. If an app in your tenant doesn't have an owner, the Global admin can take ownership of the app.
