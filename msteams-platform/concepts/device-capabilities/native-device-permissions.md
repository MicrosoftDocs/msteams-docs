...
description: Learn how to update your app manifest and request access to native features involving user consent, location, QE code and barcode, image, audio, and video capabilities
