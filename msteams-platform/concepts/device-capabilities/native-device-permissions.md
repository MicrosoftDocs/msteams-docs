...
description: Learn how to update your app manifest and request access to native features that require user consent, scan qr, barcode, image, audio, and video capabilities
