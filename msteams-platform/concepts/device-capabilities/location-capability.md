...
author: surbhigupta
description: Learn how to use Teams JavaScript client library and location APIs to utilize location capabilities, and error handling by using code snippets and samples.
ms.topic: conceptual
