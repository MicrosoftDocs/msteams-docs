...
For more information on `getLocation` and `showLocation`, see [LocationProps](/javascript/api/@microsoft/teams-js/microsoftteams.location?view=msteams-client-js-latest&preserve-view=true#getLocation_LocationProps___error__SdkError__location__Location_____void_).
