...
author: surbhigupta
description: Learn how to use Teams JavaScript client library and location APIs to utilize location capabilities & understand error handling by code snippets and samples.
ms.topic: conceptual
