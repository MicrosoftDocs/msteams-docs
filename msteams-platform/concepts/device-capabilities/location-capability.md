...
author: surbhigupta
description: Learn how to add location capabilities, it's advantages, about location APIs, error handling scenarios, and about relevant code snippets and samples.
ms.topic: conceptual
