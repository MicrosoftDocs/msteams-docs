...
> [!IMPORTANT]
>
> * The `selectMedia`, `getMedia`, and `viewImages` APIs can be invoked from multiple Teams surfaces, such as dialogs, tabs, and personal apps. For more information, see [Entry points for Teams apps](../extensibility-points.md).</br>
