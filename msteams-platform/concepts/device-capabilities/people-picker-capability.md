...
People Picker is a native capability and control in Teams that allows user to search and select people. Teams app developers can integrate People Picker input control in their web apps, which allows end users to perform different functions like searching and selecting people within a chat, a channel, or across the organization. The People Picker control is available across all Teams clients - web, desktop, and mobile.
