...
1. Select the name of the required person from the list.
   ...
   :::image type="content" source="../../assets/images/tabs/people-picker-control-capability-mobile-updated.png" alt-text="The screenshot is an example that shows People picker control capability for mobile.":::
...
1. Select the name of the required person from the list.
   ...
   :::image type="content" source="../../assets/images/tabs/select-people-picker-byname.png" alt-text="The screenshot is an example that shows People picker by name for desktop.":::
