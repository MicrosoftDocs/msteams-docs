...
1. Select the name of the required person from the list.
   ...
   :::image type="content" source="../../assets/images/tabs/people-picker-control-capability-mobile-updated.png" alt-text="The screenshot shows the People Picker control capability for mobile.":::
...
1. Select the name of the required person from the list.
   ...
   :::image type="content" source="../../assets/images/tabs/select-people-picker-byname.png" alt-text="The screenshot shows the People Picker for desktop.":::
