...
> * The Request Permissions prompt is automatically displayed for mobile when a relevant Teams API is initiated. For more information, see [Request device permissions](native-device-permissions.md).
