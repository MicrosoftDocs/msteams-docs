...
Device permissions are different in the browser. Previously browser used to handle how these permissions were granted, but now these permissions will be handled in Microsoft Teams. For more information, see [browser device permissions](browser-device-permissions.md).
