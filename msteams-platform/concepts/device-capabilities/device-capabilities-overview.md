...
After getting access to device capabilities, use Teams media capability APIs to [integrate media capabilities](mobile-camera-image-permissions.md) and `scanBarCode` API to integrate the [QR or barcode scanner capability](qr-barcode-scanner-capability.md) with Teams platform to enhance the user experience. These integrated capabilities allow your app to:
