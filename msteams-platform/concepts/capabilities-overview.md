...
> [!NOTE]
> LOB apps were updated by selecting the ellipses on the tile, in the updated Teams store experience, you can now update the LOB apps by logging in to the [Teams Admin Centre](http://admin.teams.microsoft.com)
