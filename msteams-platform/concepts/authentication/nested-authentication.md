...
| Revise Teams manifest | ✔️ | It is recommended to help IT admins for providing consent through Admin Portal. |
...
The following code snippet shows you an example to access a token:
