...
| Tab + Bot + Messaging Extension SSO | This sample shows SSO for Tab, Bot, ME - search, action, linkunfurl. |  | [View](https://github.com/OfficeDev/Microsoft-Teams-Samples/tree/main/samples/app-sso/nodejs) |  |
